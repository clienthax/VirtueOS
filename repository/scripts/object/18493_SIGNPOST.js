...
var ObjectListener = Java.extend(Java.type('com.oldscape.shared.script.listeners.ObjectListener'), {
    ...
    handle: function(player, actionSlot, object, type, x, y) {
        ...
        if (actionSlot == 0) {
            ...
            player.sendWidgetText(135, 12, "West to the Lumbridge Castle and Draynor Village. Beware the goblins!")
            player.sendWidgetText(135, 9, "South to the swamps of Lumbridge.")
            player.sendWidgetText(135, 3, "Head north towards Fred's farm and the windmill.")
            player.sendWidgetText(135, 8, "Cross the bridge and head east to Al Kharid or north to Varrock.")
