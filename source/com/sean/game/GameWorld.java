...
import com.sean.game.network.login.PlayerLoginContextPair;
...
public final class GameWorld {
	 ...
	 * {@link com.sean.game.model.player.Player}s in the server.
	 */
	private final MobList<Player> players = new MobList<>(MAXIMUM_PLAYERS);

	/**
	 * The {@link java.util.Collection} of {@link com.sean.game.model.npc.Npc}s
	 * in the server.
	 */
	private final MobList<Npc> npcs = new MobList<>(MAXIMUM_NPCS);

	/**
	 * A {@link java.util.Queue} of {@link com.sean.game.model.player.Player}s
	 * to remove.
	 */
	...
	/**
	 * Adds a {@link com.sean.game.model.player.Player} to the players
	 *
	 * @param player
	 ...
	 * {@link com.sean.game.model.player.Player}.
	 *
	 * @param player
	 */
	...
	/**
	 * Removes a {@link com.sean.game.model.player.Player} from the
	 * {@link java.util.Collection} of {@link com.sean.game.model.player.Player}
	 * .
	 *
	 * @param player
	 *            The {@link com.sean.game.model.player.Player} to remove.
	 */
	...
	/**
	 * Gets the {@link java.util.Collection} of
	 * {@link com.sean.game.model.npc.Npc}s.
	 *
	 * @return The {@code players}.
	 */
	 ...
	 * {@link com.sean.game.model.player.Player}s to remove from the server.
	 *
	...
	/**
	 * Gets the {@link java.util.Queue} of
	 * {@link com.sean.game.network.login.PlayerLoginContextPair}.
	 *
