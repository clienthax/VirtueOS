...
import com.sean.game.model.sync.reference.Graphic;
import com.sean.shared.model.Node;
...
public abstract class MobileEntity extends Node {
	 ...
	 * 
	 * @param teleporting
	 *            {@code true} if the mob is teleporting, {@code false} if not.
	 */
