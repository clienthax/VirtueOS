...
import com.sean.game.model.player.inv.AppearanceContainerListener;
import com.sean.game.model.player.inv.ContainerConstants;
import com.sean.game.model.player.inv.FullContainerListener;
import com.sean.game.model.player.inv.Item;
import com.sean.game.model.player.inv.ItemContainer;
import com.sean.game.model.player.inv.ItemContainer.StackMode;
import com.sean.game.model.player.inv.SlottedItem;
import com.sean.game.model.player.inv.SynchronizationContainerListener;
...
import com.sean.shared.model.player.AccountCredentials;
import com.sean.shared.model.player.DisplayMode;
import com.sean.shared.network.game.GameFrameBuilder;
import com.sean.shared.network.game.GameFrameDecoder;
import com.sean.shared.network.game.GameFrameEncoder;
import com.sean.shared.network.game.event.GameEventDecoder;
import com.sean.shared.network.game.event.GameEventEncoder;
import com.sean.shared.utility.IsaacRandom;
...
public class Player extends MobileEntity {
	...
	/**
	 * Gets the {@link com.sean.game.network.game.GameSessionContext}.
	 */
	protected GameSessionContext sessionContext;

	/**
	 * The {@link com.sean.shared.model.player.AccountCredentials}.
	 */
	protected final AccountCredentials credentials;

	/**
	 * The {@link com.sean.shared.model.player.DisplayMode}.
	 */
	protected DisplayMode display;

	/**
	 * The {@link com.sean.shared.utility.IsaacRandom} for the server and
	 * client.
	 */
	...
	/**
	 * Creates a new {@link com.sean.game.model.player.Player}.
	 *
	 * @param id
	...
	// but if its not
	/**
	 * Initializes the {@link com.sean.shared.model.Node}.
	 */
	@Override
	...
	/**
	 * Handles the login of a {@link com.sean.game.model.player.Player}
	 */
	public void onLogin() {
	...
	/**
	 * Writes a {@link com.sean.shared.event.Event} to the client.
	 *
	 * @param event
	 *            The {@link com.sean.shared.event.Event} to write.
	 */
	...
	/**
	 * Sets the {@link com.sean.game.network.game.GameSessionContext}.
	 *
	 * @param sessionContext
	 *            The {@link com.sean.game.network.game.GameSessionContext} to
	 *            set.
	 */
	...
	/**
	 * Gets the {@link com.sean.shared.model.player.AccountCredentials}.
	 *
	...
	/**
	 * Gets the {@link com.sean.shared.utility.IsaacRandom} for the server.
	 *
	...
	/**
	 * Gets the {@link com.sean.shared.utility.IsaacRandom}.
	 *
