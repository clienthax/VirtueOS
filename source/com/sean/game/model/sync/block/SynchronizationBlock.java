...
import com.sean.game.model.sync.reference.ChatMessage;
...
public abstract class SynchronizationBlock {
	 ...
	 * @param direction
	 *            The {@link Direction} the player should move.
	 ...
	 * @param secondary
	 *            If the block is a secondary hit or not.
	 ...
	 * 
	 * @param index
	 *            The index of the mob being interacted with.
