...
public class PlayerLoginContextPair {
	...
	/**
	 * The {@link com.sean.game.model.player.Player} of the succesfull login.
	 */
	private final Player player;

	/**
	 * The {@link com.sean.game.network.login.LoginSessionContext}.
	 */
	private final LoginSessionContext context;

	/**
	 * Creates a new {@link com.sean.game.network.login.PlayerLoginContextPair}
	 * 
	 * @param composition
	...
	/**
	 * Gets the {@link com.sean.game.network.login.LoginSessionContext}.
	 * 
