...
import com.sean.shared.network.ondemand.FileResponseEvent;
...
public final class OnDemandSessionContext extends SessionEventContext {
	 ...
	 * {@link com.sean.shared.network.ondemand.FileRequestEvent}s.
	 */
	...
	/**
	 * @see com.sean.game.network.SessionEventContext
	 */
	...
	/**
	 * Adds this {@link com.sean.game.network.ondemand.OnDemandSessionContext}
	 * to the {@link com.sean.game.services.OnDemandService}.
	 */
