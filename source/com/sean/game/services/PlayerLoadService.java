...
import com.sean.game.network.login.LoginSessionContext;
import com.sean.game.network.login.LoginTransaction;
...
import com.sean.shared.model.player.Permission;
import com.sean.shared.model.player.SubscriptionType;
import com.sean.shared.network.login.LoginEvent;
import com.sean.shared.utility.FNVHash;
import com.sean.shared.utility.NameUtils;
...
public class PlayerLoadService extends AbstractService implements Runnable {
	 ...
	 * {@link com.sean.game.network.login.LoginSessionContext}s.
	 */
			...
			try {
				...
				if (character.exists()) {
					...
					try (BufferedReader reader = new BufferedReader(
						...
						/**
						 * Creates a new {@link com.sean.rs3.game.ServerContext}
	...
	/**
	 * Adds a {@link com.sean.game.network.login.LoginSessionContext} to the
	 * {@code pendingContexts}.
	 * 
	 * @param transaction
	 *            The {@link com.sean.game.network.login.LoginSessionContext} to
	 *            registerLobbyPlayer.
	 */
