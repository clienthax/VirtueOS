package com.sean.shared.event.hubs;
...
import com.sean.shared.event.ContextualEvent;
import com.sean.shared.event.Event;
import com.sean.shared.event.EventContext;
import com.sean.shared.event.EventException;
...
public final class DefaultEventHub<C extends EventContext> extends EventHub<C> {
	 ...
	 * 
	 * @param eventMap
	 *            The type of {@link Map} for the event hub.
	 */
