...
import com.sean.shared.utility.BufferUtils;
...
public final class GameFrameBuilder {
	 ...
	 *             if this reader is not in byte access mode.
	 */
	 ...
	 *            The byte array.
	 * @throws IllegalStateException
	 *             if the builder is not in byte access mode.
	 */
	 ...
	 * 
	 * @param buffer
	 *            The source {@link io.netty.buffer.ByteBuf}.
	 * @throws IllegalStateException
	 *             if the builder is not in byte access mode.
	 */
