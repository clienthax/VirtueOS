...
import com.sean.shared.network.game.event.decoders.*;
import com.sean.shared.network.game.event.decoders.chat.CommandDecoder;
import com.sean.shared.network.game.event.decoders.chat.PublicChatDecoder;
import com.sean.shared.network.game.event.decoders.client.ClientFocusDecoder;
import com.sean.shared.network.game.event.decoders.interfaces.ButtonClickDecoder;
import com.sean.shared.network.game.event.decoders.npcs.*;
import com.sean.shared.network.game.event.decoders.objects.*;
import com.sean.shared.network.game.event.decoders.walking.MiniMapWalkDecoder;
import com.sean.shared.network.game.event.decoders.walking.WalkDecoder;
import com.sean.shared.network.game.event.encoders.*;
...
public final class GameEventRepository {
	 ...
	 * {@link com.sean.shared.network.game.event.GameMessageEncoder}s.
	 */
	...
	/**
	 * Creates a new
	 * {@link com.sean.shared.network.game.event.GameEventRepository}.
	 */
...
//		addMessageDecoder(232, new ItemOptionDecoder()); //
	...
	/**
	 * Gets a {@link com.sean.shared.network.game.event.GameMessageDecoder} from
	 * the {@code opcodeTable}.
	 * 
	 * @param opcode
	 *            The opcode of the {@link com.sean.shared.network.game.event.GameMessageDecoder}.
	 * @return The {@link com.sean.shared.network.game.event.GameMessageDecoder}
	...
	public GameMessageDecoder<?> getMessageDecoder(int opcode) {
		...
		/**
		 * The {@link com.sean.rs3.shared.net.game.event.GameMessageDecoder}
	...
	/**
	 * Gets a {@link com.sean.shared.network.game.event.GameMessageEncoder} from
	 * the {@code classTable}.
	 * 
	 * @param event
	 *            The {@link java.lang.Class} of the
	 *            {@link com.sean.shared.event.Event}.
	 * @return The {@link com.sean.shared.network.game.event.GameMessageEncoder}
	 *         .
	 */
	public GameMessageEncoder<?> getMessageEncoder(Class<? extends Event> event) {
		
		/**
		 * Gets a {@link com.sean.rs3.shared.net.game.event.GameMessageEncoder}
		 * based on the
		 * 
		 * @param event
		 *            .
	...
	/**
	 * Adds a {@link com.sean.shared.network.game.event.GameMessageEncoder} to
	 * the {@code classTable}.
	 * 
	 * @param event
	 *            The {@link java.lang.Class} of the
	 ...
	 * @param encoder
	 *            THe
	 *            {@link com.sean.shared.network.game.event.GameMessageEncoder}
	 *            .
	 */
	...
	/**
	 * Adds a {@link com.sean.shared.network.game.event.GameMessageDecoder}.
	 * 
	 * @param opcode
	 *            The opcode of the
	 *            {@link com.sean.shared.network.game.event.GameMessageDecoder}
	 *            to be set.
	 * @param decoder
	 *            The
	 *            {@link com.sean.shared.network.game.event.GameMessageDecoder}
	...
	public void addMessageDecoder(int opcode, GameMessageDecoder<? extends Event> decoder) {
		...
		/**
		 * Adds the
		 * {@link com.sean.rs3.shared.net.game.event.GameMessageDecoder}.
		 */
	 ...
	 * 
	 * @param opcode
	 *            The opcode of the {@link com.sean.shared.network.game.event.GameMessageDecoder} to be set.
	 * @param decoder
	 *            The {@link com.sean.shared.network.game.event.GameMessageDecoder} to add.
	 */
