...
public class ObjectFirstActionClickDecoder implements GameMessageDecoder<ObjectClickEvent> {
	...
	public ObjectClickEvent decode(GameFrameReader frame) {
		...
		System.out.println("X: "+x+", Y:"+y+", type:"+type+" obj:"+object);
		return new ObjectClickEvent(0, object, x, y);
	}
