...
public abstract class Actor extends Renderable {
	...
	final void setCombatInfo(int var1, int var2, int var3, int var4, int var5, int var6) {
		...
		for (var13 = (CombatInfoListHolder) this.combatInfoList
				.last(); var13 != null; var13 = (CombatInfoListHolder) this.combatInfoList.previous()) {
			++var12;
	...
	final void method1659(int var1) {
		...
		for (CombatInfoListHolder var5 = (CombatInfoListHolder) this.combatInfoList
				.last(); var5 != null; var5 = (CombatInfoListHolder) this.combatInfoList.previous()) {
