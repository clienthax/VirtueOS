		...
		if (var2 < 10) {
			...
			for (var11 = 0; var11 < 5; ++var11) {
				if (this.oscillatorVolume[var11] != 0) {
					...
					pitchSteps[var11] = (int) ((this.pitch.end - this.pitch.start) * 32.768D
							* Math.pow(1.0057929410678534D, this.oscillatorPitch[var11]) / var3);
			...
			for (var11 = 0; var11 < var1; ++var11) {
				...
				for (var14 = 0; var14 < 5; ++var14) {
					if (this.oscillatorVolume[var14] != 0) {
						...
						if (var15 < var1) {
							samples[var15] += this.evaluateWave(phases[var14], var13 * volumeSteps[var14] >> 15,
									this.pitch.form);
