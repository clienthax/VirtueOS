...
public abstract class BoundingBox extends Node {
	...
	static final void method44(Actor var0) {
		...
		if (var0.graphic != -1 && Client.gameCycle >= var0.graphicsDelay) {
			...
			if (var3 != -1) {
				...
				if (var2 != null && var2.frameIDs != null) {
					...
					if (var0.spotAnimFrame < var2.frameIDs.length
							&& var0.spotAnimFrameCycle > var2.frameLengths[var0.spotAnimFrame]) {
					...
					if (var0.spotAnimFrame >= var2.frameIDs.length
							&& (var0.spotAnimFrame < 0 || var0.spotAnimFrame >= var2.frameIDs.length)) {
						var0.graphic = -1;
					}
				} else {
					var0.graphic = -1;
		...
		if (var0.animation != -1 && var0.actionAnimationDisable <= 1) {
			...
			if (var1.precedenceAnimating == 1 && var0.field1216 > 0 && var0.field1166 <= Client.gameCycle
					&& var0.field1204 < Client.gameCycle) {
		...
		if (var0.animation != -1 && var0.actionAnimationDisable == 0) {
			...
			if (var1 != null && var1.frameIDs != null) {
				...
				if (var0.actionFrame < var1.frameIDs.length
						&& var0.actionFrameCycle > var1.frameLengths[var0.actionFrame]) {
