...
public final class BoundingBox2D extends BoundingBox {
	...
	public final void vmethod46() {
		Rasterizer2D.drawRectangle(this.xMin + Rasterizer2D.draw_region_x, this.yMin + Rasterizer2D.drawingAreaTop,
				this.xMax - this.xMin, this.yMax - this.yMin, this.color);
	}

	static LoginPacket[] method37() {
		return new LoginPacket[] { LoginPacket.field2485, LoginPacket.field2486, LoginPacket.field2483,
				LoginPacket.field2488 };
	}
