...
public class CacheFile {
	...
	public void read(byte[] var1, int var2, int var3) throws IOException {
		try {
			...
			if (this.field1697 != -1L && this.position >= this.field1697
					&& var3 + this.position <= this.field1697 + this.field1698) {
			...
			if (-1L != this.field1697) {
				...
				if (var13 > -1L && var10 > var13) {
					...
					System.arraycopy(this.writePayload, (int) (var13 - this.field1697), var1,
	...
	public void write(byte[] var1, int var2, int var3) throws IOException {
		try {
			...
			if (-1L != this.field1697
					&& (this.position < this.field1697 || this.position > this.field1698 + this.field1697)) {
				this.flush();
			}

			if (-1L != this.field1697 && this.position + var3 > this.field1697 + this.writePayload.length) {
				int var4 = (int) (this.writePayload.length - (this.position - this.field1697));
			...
			if (var3 <= this.writePayload.length) {
				...
				} else if (this.field1693 + this.field1694 > this.position
						&& this.field1693 + this.field1694 <= var3 + this.position) {
					var6 = this.field1694 + this.field1693;
				}

				if (var9 > -1L && var6 > var9) {
					int var8 = (int) (var6 - var9);
					System.arraycopy(var1, (int) (var9 + var2 - this.position), this.readPayload,
							(int) (var9 - this.field1694), var8);
				}
	...
	void flush() throws IOException {
		if (-1L != this.field1697) {
			...
			if (this.field1697 + this.field1698 > this.field1694
					&& this.field1697 + this.field1698 <= this.field1693 + this.field1694) {
				var3 = this.field1697 + this.field1698;
			} else if (this.field1693 + this.field1694 > this.field1697
					&& this.field1694 + this.field1693 <= this.field1697 + this.field1698) {
				var3 = this.field1694 + this.field1693;
			}

			if (var1 > -1L && var3 > var1) {
				int var5 = (int) (var3 - var1);
				System.arraycopy(this.writePayload, (int) (var1 - this.field1697), this.readPayload,
						(int) (var1 - this.field1694), var5);
			}
