...
public class ClanMember extends ChatPlayer {
	...
	void method5243() {
		this.field3827 = WorldMapRectangle.friendManager.field1256.isMember(super.name) ? class303.field3850
				: class303.field3849;
	}
	...
	void method5246() {
		this.field3826 = WorldMapRectangle.friendManager.field1254.isMember(super.name) ? class303.field3850
				: class303.field3849;
	}
