...
public class CombatInfo2 extends CacheableNode {
	...
	public SpritePixels method4862() {
		if (this.field3533 < 0) {
			...
			SpritePixels var1 = (SpritePixels) field3531.get(this.field3533);
			if (var1 != null) {
				return var1;
			} else {
				var1 = SoundTaskDataProvider.method817(field3528, this.field3533, 0);
				if (var1 != null) {
					field3531.put(var1, this.field3533);
				}
	...
	public static class278 method4877(int var0) {
		class278 var1 = (class278) class278.field3546.get(var0);
		if (var1 != null) {
			return var1;
		} else {
			...
			var1.method4900();
			class278.field3546.put(var1, var0);
			return var1;
		}
	}
	...
	static final void method4869(PacketBuffer var0, int var1, Player var2, int var3) {
		...
		if ((var3 & 8) != 0) {
			...
			Permission[] var17 = new Permission[] { Permission.field3345, Permission.field3344, Permission.field3346,
			...
			if (var2.name != null && var2.composition != null) {
				...
				if (!var22 && Client.myPlayerIndex == 0 && !var2.hidden) {
					...
					String var19 = FontTypeFace
							.appendTags(class303.method5406(WallObject.method3061(class93.field1432)));
					var2.overhead = var19.trim();
					var2.field1174 = var5 >> 8;
					var2.field1175 = var5 & 255;
					var2.overheadTextCyclesRemaining = 150;
					var2.field1168 = var21;
					var2.field1157 = var2 != SoundTaskDataProvider.localPlayer && var18.field3352
							&& "" != Client.field1085 && var19.toLowerCase().indexOf(Client.field1085) == -1;
					int var13;
					if (var18.field3351) {
						var13 = var21 ? 91 : 1;
					} else {
