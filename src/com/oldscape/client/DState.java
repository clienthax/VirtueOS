		...
		if (var0 != null && var0.hasConfig()) {
			...
			if (var1 < var75 && var0.field1161 == Client.gameCycle) {
				...
				if (Client.playerNameMask == 0) {
					...
					var9 = WidgetNode.method1134() || ISAACCipher.method3821() && var10.isFriend()
							|| World.method1722() && var10.isClanMember();
				}
				...
				if (var9) {
					...
					if (var1 < var75) {
						...
						byte var13 = 9;
						var12.drawTextCentered(var11.name.getName(), var2 + Client.screenX,
								var3 + Client.screenY - var13, 16777215, 0);
						var8 = 18;
					}
				}
			}
			...
			if (!var0.combatInfoList.isEmpty()) {
				...
				for (CombatInfoListHolder var88 = (CombatInfoListHolder) var0.combatInfoList
						.last(); var88 != null; var88 = (CombatInfoListHolder) var0.combatInfoList.previous()) {
					...
					if (var89 == null) {
						...
						if (var76 != null && var14 != null) {
							...
							if (Client.screenX > -1) {
								...
								Rasterizer2D.Rasterizer2D_fillRectangle(var92 + var21, var22, var15 - var92, 5,
										16711680);
							}
			...
			if (var1 < var75) {
				...
				if (var10.skullIcon != -1 || var10.overheadIcon != -1) {
					...
					if (Client.screenX > -1) {
						if (var10.skullIcon != -1) {
							var87 += 25;
							GameEngine.headIconsPk[var10.skullIcon].drawAt(var2 + Client.screenX - 12,
									var3 + Client.screenY - var87);
						}

						if (var10.overheadIcon != -1) {
							var87 += 25;
							Fonts.headIconsPrayer[var10.overheadIcon].drawAt(var2 + Client.screenX - 12,
									var3 + Client.screenY - var87);
						}
					}
				}
				...
				if (var1 >= 0 && Client.hintArrowTargetType == 10 && var7[var1] == Client.hintArrowPlayerTargetIdx) {
					...
					if (Client.screenX > -1) {
						...
						BoundingBox3DDrawMode.headIconsHint[1].drawAt(var2 + Client.screenX - 12,
								var3 + Client.screenY - var87);
					}
				}
			} else {
				...
				if (var90.headIcon >= 0 && var90.headIcon < Fonts.headIconsPrayer.length) {
					WorldMapDecoration.characterToScreen(var0, var0.logicalHeight + 15);
					if (Client.screenX > -1) {
						Fonts.headIconsPrayer[var90.headIcon].drawAt(var2 + Client.screenX - 12,
								var3 + Client.screenY - 30);
					}
				}

				if (Client.hintArrowTargetType == 1 && Client.npcIndices[var1 - var75] == Client.hintArrowNpcTargetIdx
						&& Client.gameCycle % 20 < 10) {
					WorldMapDecoration.characterToScreen(var0, var0.logicalHeight + 15);
					if (Client.screenX > -1) {
						BoundingBox3DDrawMode.headIconsHint[0].drawAt(var2 + Client.screenX - 12,
								var3 + Client.screenY - 28);
					}
				}
			}

			if (var0.overhead != null && (var1 >= var75 || !var0.field1157 && (Client.publicChatMode == 4
					|| !var0.field1168 && (Client.publicChatMode == 0 || Client.publicChatMode == 3
				...
				if (Client.screenX > -1 && Client.overheadTextCount < Client.field944) {
					Client.overheadTextsOffsetX[Client.overheadTextCount] = MessageNode.fontBold12
							.getTextWidth(var0.overhead) / 2;
