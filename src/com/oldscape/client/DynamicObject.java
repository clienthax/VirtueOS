...
public class DynamicObject extends Renderable {
	...
	DynamicObject(int var1, int var2, int var3, int var4, int var5, int var6, int var7, boolean var8, Renderable var9) {
		...
		if (var7 != -1) {
			...
			if (var8 && this.field1466.frameStep != -1) {
				this.animFrame = (int) (Math.random() * this.field1466.frameIDs.length);
				this.animCycleCount -= (int) (Math.random() * this.field1466.frameLengths[this.animFrame]);
			}
		}
	...
	protected final Model getModel() {
		...
		if (var12 == null) {
			...
			return var12.method5000(this.type, this.orientation, var8, var10, var9, var11, this.field1466,
					this.animFrame);
		}
	}

	public static int getVarbit(int var0) {
		Varbit var2 = (Varbit) Varbit.varbits.get(var0);
		Varbit var1;
		if (var2 != null) {
			var1 = var2;
		} else {
