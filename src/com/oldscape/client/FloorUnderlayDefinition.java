...
public class FloorUnderlayDefinition extends CacheableNode {
	...
	void setHSL(int var1) {
		double var2 = (var1 >> 16 & 255) / 256.0D;
		double var4 = (var1 >> 8 & 255) / 256.0D;
		double var6 = (var1 & 255) / 256.0D;
		double var8 = var2;
		if (var4 < var2) {
			var8 = var4;
		}
																																													...
																																													if (var31 != 33) {
																																														if (var31 != 34) {
																																															if (var31 != 35) {
																																																					...
																																																					if (var31 != 42) {
																																																						if (var31 != 43) {
																																																							if (var31 == 44) {
																																																								...
																																																								if (var26 < 0
																																																										|| var26 >= class81.field1282[var11]) {
																																																									throw new RuntimeException();
																																																								}

																																																								class81.intStack[++WorldComparator.intStackSize
																																																										- 1] = class81.SHAPE_VERTICES[var11][var26];
																																																							} else if (var31 == 46) {
																																																								var11 = var6[var20];
																																																								...
																																																								class81.SHAPE_VERTICES[var11][var26] = class81.intStack[WorldComparator.intStackSize
																																																										+ 1];
																																																							} else if (var31 == 47) {
																																																								var21 = SceneTilePaint.varcs
																																																										.getVarcString(
																																																												var6[var20]);
																																																								if (var21 == null) {
																																																									var21 = "null";
																																																								...
																																																								IntegerNode var34 = (IntegerNode) var39
																																																										.get(class81.intStack[--WorldComparator.intStackSize]);
																																																								if (var34 != null) {
																																																									var20 += var34.value;
																																																								}
																																																							}
																																																						...
																																																						class81.intStack[++WorldComparator.intStackSize
																																																								- 1] = SceneTilePaint.varcs
																																																										.getVarc(
																																																												var6[var20]);
																																																					}
																																																				} else {
																																																					var11 = var6[var20];
																																																					Script var33 = WorldMapDecoration
																																																							.method313(
																																																									var11);
																																																...
																																																class81.scriptStringStack[++KeyFocusListener.scriptStringStackSize
																																																		- 1] = class81.scriptLocalStrings[var6[var20]];
																																															}
																																														} else {
																																														...
																																														class81.intStack[++WorldComparator.intStackSize
																																																- 1] = class81.scriptLocalInts[var6[var20]];
																																													}
																																												} else {
																																													WorldComparator.intStackSize -= 2;
																																													if (class81.intStack[WorldComparator.intStackSize] >= class81.intStack[WorldComparator.intStackSize
																																															+ 1]) {
																																														var20 += var6[var20];
																																													}
																																												}
