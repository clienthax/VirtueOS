...
public abstract class FontTypeFace extends Rasterizer2D {
			...
			for (var13 = 0; var13 < 256; ++var13) {
				if (var13 != 32 && var13 != 160) {
					for (var8 = 0; var8 < 256; ++var8) {
						if (var8 != 32 && var8 != 160) {
							this.field3904[var8 + (var13 << 8)] = (byte) method5503(var11, var12, var4, this.field3910,
									var10, var13, var8);
						}
					}
				}
	...
	public int method5514(String var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9,
			int var10) {
		if (var1 == null) {
			return 0;
		} else {
			...
			if (var1.charAt(var6) != 0) {
				...
				if (var7 == '<') {
					...
					if (var4 == -1) {
							...
							if (field3894 == 256) {
								if (shadow != -1) {
									renderShadeRGB(this.gylphs[var7], var2 + this.horizontalOffsets[var7] + 1,
											var3 + this.verticalOffsets[var7] + 1, var14, var9, shadow);
								}

								this.renderRGB(this.gylphs[var7], var2 + this.horizontalOffsets[var7],
										var3 + this.verticalOffsets[var7], var14, var9, color);
							} else {
								if (shadow != -1) {
									renderShadeRGBA(this.gylphs[var7], var2 + this.horizontalOffsets[var7] + 1,
											var3 + this.verticalOffsets[var7] + 1, var14, var9, shadow, field3894);
								}

								this.renderRGBA(this.gylphs[var7], var2 + this.horizontalOffsets[var7],
										var3 + this.verticalOffsets[var7], var14, var9, color, field3894);
							}
						} else if (field3905 > 0) {
							field3913 += field3905;
							var2 += field3913 >> 8;
						...
						if (strikeRGB != -1) {
							Rasterizer2D.method5731(var2, var3 + (int) (this.verticalSpace * 0.7D), var15, strikeRGB);
						}
			...
			if (var1.charAt(var9) != 0) {
				...
				if (var10 == '<') {
							...
							if (!var11.equals("gt")) {
								if (var11.startsWith("img=")) {
									try {
										...
										var17.method5825(var12 + var2,
												var13 + (var3 + this.verticalSpace - var17.originalHeight));
					...
					if (var6 == -1) {
							...
							if (field3894 == 256) {
								if (shadow != -1) {
									renderShadeRGB(this.gylphs[var10], var13 + var2 + this.horizontalOffsets[var10] + 1,
											var3 + var14 + this.verticalOffsets[var10] + 1, var19, var12, shadow);
								}

								this.renderRGB(this.gylphs[var10], var13 + var2 + this.horizontalOffsets[var10],
										var3 + var14 + this.verticalOffsets[var10], var19, var12, color);
							} else {
								if (shadow != -1) {
								...
								this.renderRGBA(this.gylphs[var10], var13 + var2 + this.horizontalOffsets[var10],
										var3 + var14 + this.verticalOffsets[var10], var19, var12, color, field3894);
							}
						} else if (field3905 > 0) {
							field3913 += field3905;
							var2 += field3913 >> 8;
						...
						if (strikeRGB != -1) {
							Rasterizer2D.method5731(var2, var3 + (int) (this.verticalSpace * 0.7D), var20, strikeRGB);
						}
	...
	static void renderRGBA(int[] var0, byte[] var1, int var2, int var3, int var4, int var5, int var6, int var7,
		...
		for (int var10 = -var6; var10 < 0; ++var10) {
			for (int var11 = -var5; var11 < 0; ++var11) {
				if (var1[var3++] != 0) {
					int var12 = var0[var4];
					var0[var4++] = (((var12 & 65280) * var9 & 16711680) + ((var12 & 16711935) * var9 & -16711936) >> 8)
							+ var2;
				} else {
					++var4;
				}
