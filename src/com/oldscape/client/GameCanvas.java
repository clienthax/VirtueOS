...
public final class GameCanvas extends Canvas {
	...
	static final int method831() {
		if (Client.preferences.hideRoofs) {
			...
			return var0 - GameObject.cameraZ < 800
					&& (class62.tileSettings[BoundingBox3DDrawMode.plane][Player.cameraX >> 7][class20.cameraY >> 7]
							& 4) != 0 ? BoundingBox3DDrawMode.plane : 3;
		}
	}
			...
			if (var7 != var5) {
				...
				if (var10 == 2 && class255.region.getObjectFlags(BoundingBox3DDrawMode.plane, var8, var9, var7) >= 0) {
					...
					if (Client.itemSelectionState == 1) {
						TextureProvider.addMenuEntry("Use",
								Client.lastSelectedItemName + " " + "->" + " " + class45.getColTags(65535) + var12.name,
								1, var7, var8, var9);
					} else if (Client.spellSelected) {
						if ((class110.field1607 & 4) == 4) {
							TextureProvider.addMenuEntry(Client.field1092,
									Client.field1028 + " " + "->" + " " + class45.getColTags(65535) + var12.name, 2,
									var7, var8, var9);
						}
					} else {
						...
						if (var19 != null) {
							for (int var20 = 4; var20 >= 0; --var20) {
								if (var19[var20] != null) {
									...
									TextureProvider.addMenuEntry(var19[var20], class45.getColTags(65535) + var12.name,
											var15, var7, var8, var9);
								}
							}
						}

						TextureProvider.addMenuEntry("Examine", class45.getColTags(65535) + var12.name, 1002,
								var12.id << 14, var8, var9);
					}
				}
				...
				if (var10 == 1) {
					...
					if (var23.composition.size == 1 && (var23.x & 127) == 64 && (var23.y & 127) == 64) {
						for (var13 = 0; var13 < Client.npcIndexesCount; ++var13) {
							...
							if (var14 != null && var23 != var14 && var14.composition.size == 1 && var23.x == var14.x
									&& var14.y == var23.y) {
				...
				if (var10 == 0) {
					...
					if ((var24.x & 127) == 64 && (var24.y & 127) == 64) {
						for (var13 = 0; var13 < Client.npcIndexesCount; ++var13) {
							var14 = Client.cachedNPCs[Client.npcIndices[var13]];
							if (var14 != null && var14.composition.size == 1 && var14.x == var24.x
									&& var14.y == var24.y) {
								KeyFocusListener.method811(var14.composition, Client.npcIndices[var13], var8, var9);
							}
						}
				...
				if (var10 == 3) {
					...
					if (var25 != null) {
						for (Item var29 = (Item) var25.getTail(); var29 != null; var29 = (Item) var25.getPrevious()) {
							...
							if (Client.itemSelectionState == 1) {
								TextureProvider.addMenuEntry("Use", Client.lastSelectedItemName + " " + "->" + " "
										+ class45.getColTags(16748608) + var27.name, 16, var29.id, var8, var9);
							} else if (Client.spellSelected) {
								if ((class110.field1607 & 1) == 1) {
									TextureProvider.addMenuEntry(
											Client.field1092, Client.field1028 + " " + "->" + " "
													+ class45.getColTags(16748608) + var27.name,
											17, var29.id, var8, var9);
								}
							} else {
								...
								for (int var22 = 4; var22 >= 0; --var22) {
									if (var21 != null && var21[var22] != null) {
										...
										TextureProvider.addMenuEntry(var21[var22],
												class45.getColTags(16748608) + var27.name, var17, var29.id, var8, var9);
									} else if (var22 == 2) {
										TextureProvider.addMenuEntry("Take", class45.getColTags(16748608) + var27.name,
												20, var29.id, var8, var9);
									}
								}

								TextureProvider.addMenuEntry("Examine", class45.getColTags(16748608) + var27.name, 1004,
										var29.id, var8, var9);
							}
						}
					}
			...
			if (var10 != null && (var10.parentId == var1 || var1 == -1412584499 && var10 == Client.draggedWidget)) {
				...
				if (!var10.hasScript || var15 < var17 && var16 < var18) {
					...
					if (var10.contentType != 0) {
						if (var10.contentType == 1336) {
							if (Client.displayFps) {
								var13 += 15;
								class20.font_p12full.method5512("Fps:" + GameEngine.FPS, var39 + var10.width, var13,
										16776960, -1);
								var13 += 15;
								...
								class20.font_p12full.method5512("Mem:" + var20 + "k", var39 + var10.width, var13, var21,
										-1);
								var13 += 15;
							}
							continue;
						...
						if (var10.contentType == 1338) {
							...
							if (var42 != null) {
								Rasterizer2D.setDrawRegion(var39, var13, var39 + var42.field2773,
										var13 + var42.field2772);
								if (Client.field1099 != 2 && Client.field1099 != 5) {
									...
									BoundingBox2D.minimapSprite.method5875(var39, var13, var42.field2773,
											var42.field2772, var21, var22, var20, 256, var42.field2774,
											var42.field2771);

									for (var23 = 0; var23 < Client.field1093; ++var23) {
										var24 = Client.field1094[var23] * 4 + 2
												- SoundTaskDataProvider.localPlayer.x / 32;
										var25 = Client.field1095[var23] * 4 + 2
												- SoundTaskDataProvider.localPlayer.y / 32;
									...
									while (true) {
										if (var23 >= 104) {
											for (var23 = 0; var23 < Client.npcIndexesCount; ++var23) {
												...
												if (var50 != null && var50.hasConfig()) {
													...
													if (var55 != null && var55.isMinimapVisible && var55.field3724) {
														...
														class38.drawDot(var39, var13, var26, var27, class49.mapDots[1],
																var42);
													}
												}
											}
											...
											for (var25 = 0; var25 < var23; ++var25) {
												...
												if (var37 != null && var37.hasConfig() && !var37.hidden
														&& var37 != SoundTaskDataProvider.localPlayer) {
													var27 = var37.x / 32 - SoundTaskDataProvider.localPlayer.x / 32;
													int var38 = var37.y / 32 - SoundTaskDataProvider.localPlayer.y / 32;
													boolean var48 = false;
													if (SoundTaskDataProvider.localPlayer.team != 0 && var37.team != 0
															&& var37.team == SoundTaskDataProvider.localPlayer.team) {
														var48 = true;
													}

													if (var37.isFriend()) {
														class38.drawDot(var39, var13, var27, var38, class49.mapDots[3],
																var42);
													} else if (var48) {
														class38.drawDot(var39, var13, var27, var38, class49.mapDots[4],
																var42);
													} else if (var37.isClanMember()) {
														class38.drawDot(var39, var13, var27, var38, class49.mapDots[5],
																var42);
													} else {
														class38.drawDot(var39, var13, var27, var38, class49.mapDots[2],
																var42);
													}
												}
											}
											...
											if (Client.hintArrowTargetType != 0 && Client.gameCycle % 20 < 10) {
												if (Client.hintArrowTargetType == 1 && Client.hintArrowNpcTargetIdx >= 0
														&& Client.hintArrowNpcTargetIdx < Client.cachedNPCs.length) {
													...
													if (var57 != null) {
														...
														FrameMap.worldToMinimap(var39, var13, var26, var27,
																class19.mapMarkers[1], var42);
													}
												}

												if (Client.hintArrowTargetType == 2) {
													var25 = Client.hintArrowX * 4 - class138.baseX * 4 + 2
															- SoundTaskDataProvider.localPlayer.x / 32;
													var26 = Client.hintArrowY * 4 - class23.baseY * 4 + 2
															- SoundTaskDataProvider.localPlayer.y / 32;
													FrameMap.worldToMinimap(var39, var13, var25, var26,
															class19.mapMarkers[1], var42);
												}

												if (Client.hintArrowTargetType == 10
														&& Client.hintArrowPlayerTargetIdx >= 0
														&& Client.hintArrowPlayerTargetIdx < Client.cachedPlayers.length) {
											...
											if (Client.destinationX != 0) {
												var25 = Client.destinationX * 4 + 2
														- SoundTaskDataProvider.localPlayer.x / 32;
												var26 = Client.destinationY * 4 + 2
														- SoundTaskDataProvider.localPlayer.y / 32;
												class38.drawDot(var39, var13, var25, var26, class19.mapMarkers[0],
														var42);
											}

											if (!SoundTaskDataProvider.localPlayer.hidden) {
												Rasterizer2D.Rasterizer2D_fillRectangle(var42.field2773 / 2 + var39 - 1,
														var42.field2772 / 2 + var13 - 1, 3, 3, 16777215);
											}
											break;
										}
						...
						if (var10.contentType == 1400) {
							Preferences.renderOverview.extractWorldmap(var39, var13, var10.width, var10.height,
									Client.gameCycle);
						}
					...
					if (var10.type == 0) {
						...
						gameDraw(var0, var10.id, var15, var16, var17, var18, var39 - var10.scrollX,
								var13 - var10.scrollY, var11);
						if (var10.children != null) {
							gameDraw(var10.children, var10.id, var15, var16, var17, var18, var39 - var10.scrollX,
									var13 - var10.scrollY, var11);
						}

						WidgetNode var19 = (WidgetNode) Client.componentTable.get(var10.id);
						if (var19 != null) {
					...
					if (Client.isResized || Client.field1074[var11] || Client.gameDrawingMode > 1) {
						if (var10.type == 0 && !var10.hasScript && var10.scrollHeight > var10.height) {
							class152.method3139(var39 + var10.width, var13, var10.scrollY, var10.height,
									var10.scrollHeight);
						}
						...
						if (var10.type != 1) {
							if (var10.type == 2) {
									...
									for (var21 = 0; var21 < var10.originalWidth; ++var21) {
										...
										if (var10.itemIds[var30] <= 0) {
											...
											if (var22 + 32 > var2 && var22 < var4 && var23 + 32 > var3 && var23 < var5
													|| var10 == UrlRequest.field2137 && var30 == Client.field977) {
												SpritePixels var35;
												if (Client.itemSelectionState == 1
														&& var30 == UrlRequester.selectedItemIndex
														&& var10.id == BoundingBox.field251) {
													var35 = WorldMapDecoration.createSprite(var26,
															var10.itemQuantities[var30], 2, 0, 2, false);
												} else {
													var35 = WorldMapDecoration.createSprite(var26,
															var10.itemQuantities[var30], 1, 3153952, 2, false);
												}
												...
												if (var35 != null) {
													if (var10 == UrlRequest.field2137 && var30 == Client.field977) {
														...
														if (var1 != -1) {
															...
															if (var23 + var25 < Rasterizer2D.drawingAreaTop
																	&& var28.scrollY > 0) {
																var29 = (Rasterizer2D.drawingAreaTop - var23 - var25)
																		* Client.field930 / 3;
															...
															if (var25 + var23 + 32 > Rasterizer2D.drawingAreaRight
													...
													} else if (var10 == class2.field17
															&& var30 == Client.pressedItemIndex) {
								...
								if (var10.filled) {
									...
									case 1:
										Rasterizer2D.method5723(var39, var13, var10.width, var10.height,
												var10.textColor, var10.field2841, 256 - (var10.opacity & 255),
												256 - (var10.field2854 & 255));
										break;
									case 2:
										Rasterizer2D.method5742(var39, var13, var10.width, var10.height,
												var10.textColor, var10.field2841, 256 - (var10.opacity & 255),
												256 - (var10.field2854 & 255));
										break;
									case 3:
										Rasterizer2D.method5725(var39, var13, var10.width, var10.height,
												var10.textColor, var10.field2841, 256 - (var10.opacity & 255),
												256 - (var10.field2854 & 255));
										break;
									case 4:
										Rasterizer2D.method5726(var39, var13, var10.width, var10.height,
												var10.textColor, var10.field2841, 256 - (var10.opacity & 255),
												256 - (var10.field2854 & 255));
										break;
									default:
										if (var14 == 0) {
											Rasterizer2D.Rasterizer2D_fillRectangle(var39, var13, var10.width,
													var10.height, var30);
										} else {
											Rasterizer2D.fillRectangle(var39, var13, var10.width, var10.height, var30,
													256 - (var14 & 255));
										}
									}
								} else if (var14 == 0) {
									...
									Rasterizer2D.Rasterizer2D_drawRectangleAlpha(var39, var13, var10.width,
											var10.height, var30, 256 - (var14 & 255));
								}
							} else {
								Font var40;
								if (var10.type == 4) {
									...
									if (var40 == null) {
										...
										if (var10.hasScript && var10.itemId != -1) {
											...
											if ((var54.isStackable == 1 || var10.itemQuantity != 1)
													&& var10.itemQuantity != -1) {
												var53 = class45.getColTags(16748608) + var53 + "</col>" + " " + 'x'
														+ class169.method3290(var10.itemQuantity);
											}
										}
										...
										var40.method5514(var53, var39, var13, var10.width, var10.height, var20,
												var10.textShadowed ? 0 : -1, var10.field2885, var10.field2833,
												var10.field2884);
									}
									...
									if (!var10.hasScript) {
										...
										if (var10.itemId != -1) {
											var41 = WorldMapDecoration.createSprite(var10.itemId, var10.itemQuantity,
													var10.borderThickness, var10.sprite2, var10.field2853, false);
										} else {
										...
										if (var41 == null) {
											...
											if (!var10.spriteTiling) {
												...
												if (var10.textureId != 0) {
													var41.method5877(var10.width / 2 + var39, var10.height / 2 + var13,
															var10.textureId, var22);
												} else if (var14 != 0) {
													var41.method5866(var39, var13, var10.width, var10.height,
															256 - (var14 & 255));
												...
												Rasterizer2D.setInnerDrawRegion(var39, var13, var39 + var10.width,
														var13 + var10.height);
												...
												for (var24 = 0; var24 < var22; ++var24) {
													for (var25 = 0; var25 < var23; ++var25) {
														if (var10.textureId != 0) {
															var41.method5877(var20 / 2 + var39 + var20 * var24,
																	var21 / 2 + var13 + var25 * var21, var10.textureId,
																	4096);
														} else if (var14 != 0) {
															var41.drawAtOpacity(var39 + var20 * var24,
									...
									if (var10.type == 6) {
										...
										if (var10.itemId != -1) {
											...
											if (var10.modelId == 0) {
												var47 = Client.field1132.getModel((Sequence) null, -1, (Sequence) null,
														-1);
											} else {
												var47 = SoundTaskDataProvider.localPlayer.getModel();
											}
										} else if (var20 == -1) {
											var47 = var10.getModel((Sequence) null, -1, var46,
													SoundTaskDataProvider.localPlayer.composition);
											if (var47 == null && Widget.field2820) {
												FontName.method5490(var10);
											}
										} else {
											Sequence var56 = CombatInfo1.getAnimation(var20);
											var47 = var10.getModel(var56, var10.field2935, var46,
													SoundTaskDataProvider.localPlayer.composition);
											if (var47 == null && Widget.field2820) {
												FontName.method5490(var10);
											}
										...
										if (var47 != null) {
											if (!var10.hasScript) {
												var47.method2734(0, var10.rotationZ, 0, var10.rotationX, 0, var23,
														var24);
											} else {
												var47.calculateBoundsCylinder();
												if (var10.field2879) {
													var47.method2748(0, var10.rotationZ, var10.rotationY,
															var10.rotationX, var10.offsetX2d,
															var23 + var22 + var10.offsetY2d, var24 + var10.offsetY2d,
															var10.modelZoom);
												} else {
													var47.method2734(0, var10.rotationZ, var10.rotationY,
															var10.rotationX, var10.offsetX2d,
															var23 + var22 + var10.offsetY2d, var24 + var10.offsetY2d);
												}
											}
												...
												for (var22 = 0; var22 < var10.originalWidth; ++var22) {
													if (var10.itemIds[var20] > 0) {
														...
														if (var34.isStackable != 1
															...
															var31 = class45.getColTags(16748608) + var34.name
																	+ "</col>";
														} else {
															var31 = class45.getColTags(16748608) + var34.name + "</col>"
																	+ " " + 'x'
																	+ class169.method3290(var10.itemQuantities[var20]);
														}

														var25 = var39 + var22 * (var10.paddingX + 115);
														var26 = var13 + (var10.paddingY + 12) * var21;
														if (var10.field2885 == 0) {
															var40.method5510(var31, var25, var26, var10.textColor,
																	var10.textShadowed ? 0 : -1);
														} else if (var10.field2885 == 1) {
															var40.drawTextCentered(var31, var10.width / 2 + var25,
																	var26, var10.textColor,
																	var10.textShadowed ? 0 : -1);
														} else {
															var40.method5512(var31, var25 + var10.width - 1, var26,
										...
										if (var10.type == 8 && var10 == class7.field234
												&& Client.field1115 == Client.field1021) {
											var30 = 0;
											var20 = 0;
											...
											String var52;
											for (var33 = WidgetNode.method1135(var33, var10); var33
													.length() > 0; var20 = var20 + var32.verticalSpace + 1) {
											...
											Rasterizer2D.Rasterizer2D_fillRectangle(var24, var25, var30, var20,
													16777120);
											...
											for (var33 = WidgetNode.method1135(var33, var10); var33
													.length() > 0; var26 = var26 + var32.verticalSpace + 1) {
										...
										if (var10.type == 9) {
											...
											if (var10.lineWidth == 1) {
												...
												class2.method2(var30, var20, var21, var22, var10.textColor,
														var10.lineWidth);
											}
										}
									}
