...
public abstract class GameEngine extends Applet implements Runnable, FocusListener, WindowListener {
	...
	final void method901() {
		...
		if (var1 != null) {
			...
			MapCacheArchiveNames.rasterProvider = new MainBufferProvider(MapLabel.canvasWidth,
					FloorUnderlayDefinition.canvasHeight, this.canvas);
			if (var1 == this.frame) {
	...
	final synchronized void replaceCanvas() {
		...
		this.field700 = true;
		if (MapCacheArchiveNames.rasterProvider != null
				&& MapLabel.canvasWidth == MapCacheArchiveNames.rasterProvider.width
				&& FloorUnderlayDefinition.canvasHeight == MapCacheArchiveNames.rasterProvider.height) {
	...
	protected final void drawLoadingScreen(int var1, String var2, boolean var3) {
		try {
			...
			try {
				...
				var4.drawImage(TotalQuantityComparator.field304, MapLabel.canvasWidth / 2 - 152,
	...
	public final synchronized void paint(Graphics var1) {
		if (this == shell && !field690) {
			...
			if (class64.method1118() - this.field704 > 1000L) {
				...
				if (var2 == null
						|| var2.width >= MapLabel.canvasWidth && var2.height >= FloorUnderlayDefinition.canvasHeight) {
					this.field703 = true;
				}
			}
	...
	public static boolean method984() {
		...
		if (class264.NetCache_pendingResponsesCount == 0 && class264.NetCache_pendingPriorityResponsesCount == 0
				&& class264.NetCache_pendingWritesCount == 0 && class264.NetCache_pendingPriorityWritesCount == 0) {
			return true;
			...
			try {
				if (class264.field3416 > 30000) {
					...
					FileRequest var3;
					Buffer var4;
					while (class264.NetCache_pendingPriorityResponsesCount < 200
							&& class264.NetCache_pendingPriorityWritesCount > 0) {
					...
					for (int var15 = 0; var15 < 100; ++var15) {
						...
						if (var5 > 0) {
							...
							class264.NetCache_socket.vmethod3348(class264.NetCache_responseHeaderBuffer.payload,
									class264.NetCache_responseHeaderBuffer.offset, var6);
							if (class264.field3429 != 0) {
								for (var7 = 0; var7 < var6; ++var7) {
									class264.NetCache_responseHeaderBuffer.payload[var7
											+ class264.NetCache_responseHeaderBuffer.offset] ^= class264.field3429;
								}
							}
							...
							if (class49.currentRequest == null) {
								...
								class47.NetCache_responseArchiveBuffer = new Buffer(
										var10 + var14 + class49.currentRequest.padding);
							...
							var6 = class47.NetCache_responseArchiveBuffer.payload.length
									- class49.currentRequest.padding;
							...
							class264.NetCache_socket.vmethod3348(class47.NetCache_responseArchiveBuffer.payload,
									class47.NetCache_responseArchiveBuffer.offset, var7);
							if (class264.field3429 != 0) {
								for (var8 = 0; var8 < var7; ++var8) {
									class47.NetCache_responseArchiveBuffer.payload[class47.NetCache_responseArchiveBuffer.offset
											+ var8] ^= class264.field3429;
								}
							}
							...
							if (var6 == class47.NetCache_responseArchiveBuffer.offset) {
								if (class49.currentRequest.hash == 16711935L) {
									...
									class264.NetCache_crc.update(class47.NetCache_responseArchiveBuffer.payload, 0,
											var6);
									...
									class49.currentRequest.index.write((int) (class49.currentRequest.hash & 65535L),
											class47.NetCache_responseArchiveBuffer.payload,
											16711680L == (class49.currentRequest.hash & 16711680L), class264.field3419);
								}
