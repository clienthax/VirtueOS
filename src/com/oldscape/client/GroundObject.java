...
public final class GroundObject {
	...
	static void method2670() {
		if (SoundTaskDataProvider.localPlayer.x >> 7 == Client.destinationX
				&& SoundTaskDataProvider.localPlayer.y >> 7 == Client.destinationY) {
	...
	static int getWidgetClickMask(Widget var0) {
		IntegerNode var1 = (IntegerNode) Client.widgetFlags.get(((long) var0.id << 32) + var0.index);
