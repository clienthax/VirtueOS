		...
		for (int var1 = 0; var1 < Client.npcIndexesCount; ++var1) {
			...
			if (var2 != null && var2.hasConfig() && var2.composition.isVisible == var0
				...
				if (var4 >= 0 && var4 < 104 && var5 >= 0 && var5 < 104) {
					...
					class255.region.method2863(BoundingBox3DDrawMode.plane, var2.x, var2.y,
							class265.getTileHeight(var2.field1172 * 64 - 64 + var2.x, var2.field1172 * 64 - 64 + var2.y,
									BoundingBox3DDrawMode.plane),
							var2.field1172 * 64 - 64 + 60, var2, var2.angle, var3, var2.field1159);
				}
			}
		}
