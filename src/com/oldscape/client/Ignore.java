...
public class Ignore extends Nameable {
	...
	static VerticalAlignment[] method5387() {
		return new VerticalAlignment[] { VerticalAlignment.field3442, VerticalAlignment.field3440,
				VerticalAlignment.field3439 };
	}
	...
	static final void method5385() {
		...
		if (Client.field960 == 0) {
			...
			if (class169.field2228 - var0 < -500 || class169.field2228 - var0 > 500 || class46.field578 - var1 < -500
					|| class46.field578 - var1 > 500) {
			...
			ObjectComposition.field3640 = class265.getTileHeight(SoundTaskDataProvider.localPlayer.x,
					SoundTaskDataProvider.localPlayer.y, BoundingBox3DDrawMode.plane) - Client.field945;
			...
			if (Client.field1061 && SoundTaskDataProvider.localPlayer != null) {
				...
				if (var0 >= 0 && var1 >= 0 && var0 < 104 && var1 < 104) {
					...
					var2 = class265.getTileHeight(SoundTaskDataProvider.localPlayer.x,
							SoundTaskDataProvider.localPlayer.y, BoundingBox3DDrawMode.plane) - Client.field945;
		...
		if (MouseInput.mouseCurrentButton == 4 && MapIconReference.middleMouseMovesCamera) {
			...
			Client.field943 = var0 != -1 && var0 != 1 ? (Client.field943 + MouseInput.mouseLastY) / 2
					: MouseInput.mouseLastY;
			var1 = Client.field897 - MouseInput.mouseLastX;
			Client.field940 = var1 * 2;
			Client.field897 = var1 != -1 && var1 != 1 ? (MouseInput.mouseLastX + Client.field897) / 2
