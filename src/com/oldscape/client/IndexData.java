	...
	int archiveLoadPercent(int var1) {
		if (super.archives[var1] != null) {
			...
			if (class49.currentRequest != null && class49.currentRequest.hash == var4) {
				var2 = class47.NetCache_responseArchiveBuffer.offset * 99
						/ (class47.NetCache_responseArchiveBuffer.payload.length - class49.currentRequest.padding) + 1;
			} else {
				var2 = 0;
			}
	...
	public int percentage() {
		if (this.field3407) {
			...
			if (class49.currentRequest != null && var3 == class49.currentRequest.hash) {
				var1 = class47.NetCache_responseArchiveBuffer.offset * 99
						/ (class47.NetCache_responseArchiveBuffer.payload.length - class49.currentRequest.padding) + 1;
			} else {
				var1 = 0;
			}
