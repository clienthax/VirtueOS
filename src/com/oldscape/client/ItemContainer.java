...
public class ItemContainer extends Node {
	...
	static final int method1131(int var0, int var1) {
		int var2 = WallObject.getSmoothNoise(var0 + 45365, var1 + 91923, 4) - 128
				+ (WallObject.getSmoothNoise(10294 + var0, 37821 + var1, 2) - 128 >> 1)
				+ (WallObject.getSmoothNoise(var0, var1, 1) - 128 >> 2);
