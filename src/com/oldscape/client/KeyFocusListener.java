				...
				if (var0.field3724) {
					if (!var0.field3738 || Client.field1048 == var1) {
						...
						if (var0.combatLevel != 0) {
							var4 = var4
									+ PendingSpawn.method1653(var0.combatLevel,
											SoundTaskDataProvider.localPlayer.combatLevel)
									+ " " + " (" + "level-" + var0.combatLevel + ")";
						}

						if (var0.field3738 && Client.field1014) {
							TextureProvider.addMenuEntry("Examine", class45.getColTags(16776960) + var4, 1003, var1,
									var2, var3);
						}

						if (Client.itemSelectionState == 1) {
							TextureProvider.addMenuEntry("Use", Client.lastSelectedItemName + " " + "->" + " "
									+ class45.getColTags(16776960) + var4, 7, var1, var2, var3);
						} else if (Client.spellSelected) {
							if ((class110.field1607 & 2) == 2) {
								TextureProvider.addMenuEntry(Client.field1092,
										Client.field1028 + " " + "->" + " " + class45.getColTags(16776960) + var4, 8,
										var1, var2, var3);
							}
						} else {
							...
							if (var6 != null) {
								for (var7 = 4; var7 >= 0; --var7) {
									if (var6[var7] != null && !var6[var7].equalsIgnoreCase("Attack")) {
										...
										TextureProvider.addMenuEntry(var6[var7], class45.getColTags(16776960) + var4,
												var8, var1, var2, var3);
									}
								}
							}
										...
										if (Client.npcAttackOption != AttackOption.AttackOption_hidden) {
											if (Client.npcAttackOption == AttackOption.AttackOption_alwaysRightClick
													|| AttackOption.AttackOption_dependsOnCombatLevels == Client.npcAttackOption
															&& var0.combatLevel > SoundTaskDataProvider.localPlayer.combatLevel) {
												var9 = 2000;
											}
											...
											TextureProvider.addMenuEntry(var6[var7],
													class45.getColTags(16776960) + var4, var8, var1, var2, var3);
										}
									}
								}
							}
