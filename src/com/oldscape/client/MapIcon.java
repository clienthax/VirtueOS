...
public class MapIcon {
	...
	boolean method581(int var1, int var2) {
		return this.field527 == null ? false
				: (var1 >= this.screenX - this.field527.field470 / 2
						&& var1 <= this.field527.field470 / 2 + this.screenX
								? var2 >= this.screenY && var2 <= this.field527.field469 + this.screenY
								: false);
	}
