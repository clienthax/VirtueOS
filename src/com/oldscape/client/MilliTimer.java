		...
		if (Client.loadingStage == 0) {
			...
			if (Client.loadingStage != 20) {
				if (Client.loadingStage == 30) {
					...
					class2.method3(MouseRecorder.indexCache15, MapCacheArchiveNames.vorbisIndex, class55.indexCache4,
							var20);
					...
					FontName[] var19 = new FontName[] { FontName.FontName_plain11, FontName.FontName_plain12,
							FontName.FontName_bold12, FontName.field3881, FontName.field3882, FontName.field3886 };
					var1 = var19.length;
					Fonts var21 = SceneTilePaint.fonts;
					FontName[] var22 = new FontName[] { FontName.FontName_plain11, FontName.FontName_plain12,
							FontName.FontName_bold12, FontName.field3881, FontName.field3882, FontName.field3886 };
					...
					if (Client.loadingStage == 60) {
						...
						if (!Size.configsIndex.method4624()) {
							...
							Projectile.method1938(WorldMapType3.indexCache3, class18.indexModels, class151.indexSprites,
									KeyFocusListener.indexCache13);
							...
							JagexGame.method4522(Size.configsIndex, class151.indexSprites,
									KeyFocusListener.indexCache13);
						...
						if (BoundingBox3DDrawMode.headIconsHint == null) {
							BoundingBox3DDrawMode.headIconsHint = IndexDataBase.getSprites(class151.indexSprites,
									"headicons_hint", "");
						} else {
							++var0;
						}
						...
						if (class18.scrollbarSprites == null) {
							class18.scrollbarSprites = WorldMapManager.getIndexedSprites(class151.indexSprites,
									"scrollbar", "");
						} else {
							++var0;
						}
						...
						if (class3.modIconSprites == null) {
							class3.modIconSprites = WorldMapManager.getIndexedSprites(class151.indexSprites,
									"mod_icons", "");
						} else {
							++var0;
						}
						...
						if (!GameCanvas.indexTextures.method4624()) {
							...
							class243.field2961 = new TextureProvider(GameCanvas.indexTextures, class151.indexSprites,
						...
						if (!WorldMapType3.indexCache3.method4624()) {
							class90.loadingText = "Loading interfaces - "
									+ WorldMapType3.indexCache3.loadPercent() * 4 / 5 + "%";
							class90.loadingBarPercentage = 96;
						} else if (!class190.indexScripts.method4624()) {
							class90.loadingText = "Loading interfaces - "
									+ (80 + class190.indexScripts.loadPercent() / 6) + "%";
							class90.loadingBarPercentage = 96;
						} else if (!KeyFocusListener.indexCache13.method4624()) {
							class90.loadingText = "Loading interfaces - "
									+ (96 + KeyFocusListener.indexCache13.loadPercent() / 50) + "%";
							class90.loadingBarPercentage = 96;
						} else {
						...
						if (!class95.indexWorldMap.tryLoadArchiveByName(MapCacheArchiveNames.DETAILS.name)) {
							class90.loadingText = "Loading world map - "
									+ class95.indexWorldMap.archiveLoadPercentByName(MapCacheArchiveNames.DETAILS.name)
											/ 10
									+ "%";
						} else {
							if (Preferences.renderOverview == null) {
								Preferences.renderOverview = new RenderOverview();
								Preferences.renderOverview.method6006(class95.indexWorldMap, MessageNode.fontBold12,
										Client.fontsMap, GroundObject.mapscene);
							}
