	...
	public void calculateBoundsCylinder() {
		if (this.boundsType != 1) {
			...
			this.diameter = this.radius
					+ (int) (Math.sqrt(this.XYZMag * this.XYZMag + this.bottomY * this.bottomY) + 0.99D);
		}
	}
		...
		if (this.vertexGroups != null) {
			if (var2 != -1) {
				...
				for (int var5 = 0; var5 < var3.transformCount; ++var5) {
					...
					this.animate(var4.types[var6], var4.list[var6], var3.translator_x[var5], var3.translator_y[var5],
			...
			if (var5 != null && var4 != -1) {
				...
				for (var11 = 0; var11 < var6.transformCount; ++var11) {
					...
					if (var12 != var10 || var8.types[var12] == 0) {
						this.animate(var8.types[var12], var8.list[var12], var6.translator_x[var11],
				...
				for (var11 = 0; var11 < var7.transformCount; ++var11) {
					...
					if (var12 == var10 || var8.types[var12] == 0) {
						this.animate(var8.types[var12], var8.list[var12], var7.translator_x[var11],
			...
			for (var6 = 0; var6 < this.indicesCount; ++var6) {
				if (this.field1862[var6] != -2) {
					...
					if (var1 && (var10 == -5000 || var11 == -5000 || var12 == -5000)) {
						...
						if ((var10 - var11) * (modelViewportXs[var9] - modelViewportXs[var8])
								- (var12 - var11) * (modelViewportXs[var7] - modelViewportXs[var8]) > 0) {
		...
		if (field1848[var1]) {
			...
			if (this.field1851 != null && this.field1851[var1] != -1) {
				...
				if (this.field1862[var1] == -1) {
					Graphics3D.rasterTextureAffine(modelViewportXs[var2], modelViewportXs[var3], modelViewportXs[var4],
							modelViewportYs[var2], modelViewportYs[var3], modelViewportYs[var4], this.field1852[var1],
							this.field1852[var1], this.field1852[var1], yViewportBuffer[var5], yViewportBuffer[var6],
							yViewportBuffer[var7], field1893[var5], field1893[var6], field1893[var7], field1894[var5],
							field1894[var6], field1894[var7], this.field1851[var1]);
				} else {
					Graphics3D.rasterTextureAffine(modelViewportXs[var2], modelViewportXs[var3], modelViewportXs[var4],
							modelViewportYs[var2], modelViewportYs[var3], modelViewportYs[var4], this.field1852[var1],
							this.field1861[var1], this.field1862[var1], yViewportBuffer[var5], yViewportBuffer[var6],
							yViewportBuffer[var7], field1893[var5], field1893[var6], field1893[var7], field1894[var5],
							field1894[var6], field1894[var7], this.field1851[var1]);
				}
			} else if (this.field1862[var1] == -1) {
				Graphics3D.rasterFlat(modelViewportXs[var2], modelViewportXs[var3], modelViewportXs[var4],
						modelViewportYs[var2], modelViewportYs[var3], modelViewportYs[var4],
						field1914[this.field1852[var1]]);
			} else {
				Graphics3D.rasterGouraud(modelViewportXs[var2], modelViewportXs[var3], modelViewportXs[var4],
						modelViewportYs[var2], modelViewportYs[var3], modelViewportYs[var4], this.field1852[var1],
						this.field1861[var1], this.field1862[var1]);
			}
	...
	final void method2709(int var1) {
		...
		if (var8 >= 50) {
			...
			if (var10 >= 50) {
				...
				field1903[var4] = var2
						+ Graphics3D.Rasterizer3D_zoom * (var11 + ((yViewportBuffer[var7] - var11) * var14 >> 16)) / 50;
				field1875[var4] = var3
						+ Graphics3D.Rasterizer3D_zoom * (var12 + ((field1893[var7] - var12) * var14 >> 16)) / 50;
			...
			if (var9 >= 50) {
				...
				field1903[var4] = var2
						+ Graphics3D.Rasterizer3D_zoom * (var11 + ((yViewportBuffer[var6] - var11) * var14 >> 16)) / 50;
				field1875[var4] = var3
						+ Graphics3D.Rasterizer3D_zoom * (var12 + ((field1893[var6] - var12) * var14 >> 16)) / 50;
		...
		if (var9 >= 50) {
			...
			if (var8 >= 50) {
				...
				field1903[var4] = var2
						+ Graphics3D.Rasterizer3D_zoom * (var11 + ((yViewportBuffer[var5] - var11) * var14 >> 16)) / 50;
				field1875[var4] = var3
						+ Graphics3D.Rasterizer3D_zoom * (var12 + ((field1893[var5] - var12) * var14 >> 16)) / 50;
		...
		if (var4 == 3) {
			...
			if (this.field1851 != null && this.field1851[var1] != -1) {
				...
				if (this.field1862[var1] == -1) {
					Graphics3D.rasterTextureAffine(var14, var15, var16, var11, var12, var13, this.field1852[var1],
							this.field1852[var1], this.field1852[var1], yViewportBuffer[var17], yViewportBuffer[var18],
							yViewportBuffer[var19], field1893[var17], field1893[var18], field1893[var19],
							field1894[var17], field1894[var18], field1894[var19], this.field1851[var1]);
				} else {
		...
		if (var4 == 4) {
			if (var11 < 0 || var12 < 0 || var13 < 0 || var11 > Graphics3D.rasterClipX || var12 > Graphics3D.rasterClipX
					|| var13 > Graphics3D.rasterClipX || field1903[3] < 0 || field1903[3] > Graphics3D.rasterClipX) {
				Graphics3D.rasterClipEnable = true;
			}
			...
			if (this.field1851 != null && this.field1851[var1] != -1) {
				...
				if (this.field1862[var1] == -1) {
					Graphics3D.rasterTextureAffine(var14, var15, var16, var11, var12, var13, this.field1852[var1],
							this.field1852[var1], this.field1852[var1], yViewportBuffer[var17], yViewportBuffer[var18],
							yViewportBuffer[var19], field1893[var17], field1893[var18], field1893[var19],
							field1894[var17], field1894[var18], field1894[var19], var21);
					Graphics3D.rasterTextureAffine(var14, var16, field1875[3], var11, var13, field1903[3],
							this.field1852[var1], this.field1852[var1], this.field1852[var1], yViewportBuffer[var17],
							yViewportBuffer[var18], yViewportBuffer[var19], field1893[var17], field1893[var18],
							field1893[var19], field1894[var17], field1894[var18], field1894[var19], var21);
				} else {
					Graphics3D.rasterTextureAffine(var14, var15, var16, var11, var12, var13, xViewportBuffer[0],
							xViewportBuffer[1], xViewportBuffer[2], yViewportBuffer[var17], yViewportBuffer[var18],
							yViewportBuffer[var19], field1893[var17], field1893[var18], field1893[var19],
				...
				Graphics3D.rasterGouraud(var14, var15, var16, var11, var12, var13, xViewportBuffer[0],
						xViewportBuffer[1], xViewportBuffer[2]);
				Graphics3D.rasterGouraud(var14, var16, field1875[3], var11, var13, field1903[3], xViewportBuffer[0],
					...
					if (var19 / var13 > Graphics3D.Rasterizer3D_clipNegativeMidY) {
						...
						if (var21 / var13 < Graphics3D.Rasterizer3D_clipMidY2) {
							...
							if (class7.drawBoundingBoxes2D && var9 > 0) {
								...
								class149.method3104(var31 + Graphics3D.centerX, var33 + Graphics3D.centerY,
										var32 + Graphics3D.centerX, var34 + Graphics3D.centerY, var35);
							}
							...
							if (var9 > 0 && var29) {
								...
								if (var43) {
									if (this.field1874) {
										class132.Viewport_entityIdsAtMouse[++class132.Viewport_entityCountAtMouse
												- 1] = var9;
									} else {
										var42 = true;
									}
