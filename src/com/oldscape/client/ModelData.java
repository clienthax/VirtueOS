				...
				for (var11 = 0; var11 < var10.triangleFaceCount; ++var11) {
					...
					if (var8) {
						if (var10.textureCoords != null && var10.textureCoords[var11] != -1) {
							this.textureCoords[this.triangleFaceCount] = (byte) (this.field1738
	...
	static void method2608(ModelData var0, ModelData var1, int var2, int var3, int var4, boolean var5) {
		...
		if (var6 >= 3 && var5) {
			for (var9 = 0; var9 < var0.triangleFaceCount; ++var9) {
				if (field1765[var0.trianglePointsX[var9]] == field1724
						&& field1765[var0.trianglePointsY[var9]] == field1724
						&& field1765[var0.trianglePointsZ[var9]] == field1724) {
			...
			for (var9 = 0; var9 < var1.triangleFaceCount; ++var9) {
				if (field1724 == field1753[var1.trianglePointsX[var9]]
						&& field1724 == field1753[var1.trianglePointsY[var9]]
						&& field1724 == field1753[var1.trianglePointsZ[var9]]) {
