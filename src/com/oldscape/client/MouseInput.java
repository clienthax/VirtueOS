...
public class MouseInput implements MouseListener, MouseMotionListener, FocusListener {
	...
	static void method1051(int var0) {
		if (var0 == -3) {
			...
			BoundingBox3DDrawMode.method53("Your account has been disabled.",
					"Please check your message-centre for details.", "");
		} else if (var0 == 5) {
			BoundingBox3DDrawMode.method53("Your account has not logged out from its last",
			...
			BoundingBox3DDrawMode.method53("We suspect someone knows your password.",
					"Press \'change your password\' on front page.", "");
		} else if (var0 == 12) {
			BoundingBox3DDrawMode.method53("You need a members account to login to this world.",
			...
			BoundingBox3DDrawMode.method53("You are standing in a members-only area.",
					"To play on this world move to a free area first", "");
		} else if (var0 == 18) {
			BoundingBox3DDrawMode.method53("Account locked as we suspect it has been stolen.",
					"Press \'recover a locked account\' on front page.", "");
		} else if (var0 == 19) {
			BoundingBox3DDrawMode.method53("This world is running a closed Beta.", "Sorry invited players only.",
			...
			BoundingBox3DDrawMode.method53("This computers address has been blocked",
					"as it was used to break our rules.", "");
		} else if (var0 == 27) {
			BoundingBox3DDrawMode.method53("", "Service unavailable.", "");
		} else if (var0 == 31) {
			BoundingBox3DDrawMode.method53("Your account must have a displayname set",
					"in order to play the game.  Please set it", "via the website, or the main game.");
		} else if (var0 == 32) {
			BoundingBox3DDrawMode.method53("Your attempt to log into your account was",
					"unsuccessful.  Don\'t worry, you can sort", "this out by visiting the billing system.");
		} else if (var0 == 37) {
			BoundingBox3DDrawMode.method53("Your account is currently inaccessible.",
					"Please try again in a few minutes.", "");
		} else if (var0 == 38) {
			BoundingBox3DDrawMode.method53("You need to vote to play!", "Visit runescape.com and vote,",
					"and then come back here!");
		} else if (var0 == 55) {
			BoundingBox3DDrawMode.method53("Sorry, but your account is not eligible to",
