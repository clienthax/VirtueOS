...
public final class NPC extends Actor {
	...
	protected final Model getModel() {
		if (this.composition == null) {
			...
			Sequence var1 = super.animation != -1 && super.actionAnimationDisable == 0
					...
					: null;
			Sequence var2 = super.poseAnimation == -1 || super.idlePoseAnimation == super.poseAnimation && var1 != null
					? null
	...
	static final boolean method1878(int var0, int var1, class178 var2, CollisionData var3) {
		...
		while (var18 != var11) {
			...
			if (var16 > 0 && var17 > 0 && class177.field2285[var16 - 1][var17 - 1] == 0
			...
			if (var16 < 127 && var17 > 0 && class177.field2285[var16 + 1][var17 - 1] == 0
			...
			if (var16 > 0 && var17 < 127 && class177.field2285[var16 - 1][var17 + 1] == 0
			...
			if (var16 < 127 && var17 < 127 && class177.field2285[var16 + 1][var17 + 1] == 0
