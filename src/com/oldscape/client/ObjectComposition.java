...
public class ObjectComposition extends CacheableNode {
	...
	public final Model method5000(int var1, int var2, int[][] var3, int var4, int var5, int var6, Sequence var7,
			int var8) {
		long var9;
		if (this.objectTypes == null) {
	...
	static final void method5018(Actor var0) {
		if (var0.field1204 == Client.gameCycle || var0.animation == -1 || var0.actionAnimationDisable != 0
				|| var0.actionFrameCycle
						+ 1 > CombatInfo1.getAnimation(var0.animation).frameLengths[var0.actionFrame]) {
