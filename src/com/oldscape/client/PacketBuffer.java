...
public final class PacketBuffer extends Buffer {
	...
	static {
		field2602 = new int[] { 0, 1, 3, 7, 15, 31, 63, 127, 255, 511, 1023, 2047, 4095, 8191, 16383, 32767, 65535,
	...
	public int method3783() {
		...
		return var1 < 128 ? var1
				: (var1 - 128 << 8) + (super.payload[++super.offset - 1] - this.cipher.nextInt() & 255);
	}
	...
	static int method3806(int var0, Script var1, boolean var2) {
		...
		if (var0 == 1100) {
			...
			if (var0 == 1110) {
				...
				var9 = class81.intStack[--WorldComparator.intStackSize];
				class329[] var6 = new class329[] { class329.field3966, class329.field3965, class329.field3968,
						class329.field3969, class329.field3967 };
				...
				if (var2 == 14) {
					...
					if (var2 == 24) {
						...
						if (var2 == 25) {
							...
							if (var22 != null) {
								class154.method3156();
								class55.method834(var1, var0,
										class250.method4502(GroundObject.getWidgetClickMask(var22)), var22.itemId);
								...
								if (var22.hasScript) {
									...
									Client.field1028 = class45.getColTags(65280) + var22.spellName
											+ class45.getColTags(16777215);
								}
							}
						...
						if (var2 == 26) {
							...
							for (WidgetNode var17 = (WidgetNode) Client.componentTable
									.first(); var17 != null; var17 = (WidgetNode) Client.componentTable.next()) {
							...
							if (var2 == 28) {
								...
								if (var2 == 38) {
									...
									Client.lastSelectedItemName = class45.getColTags(16748608)
											+ class47.getItemDefinition(var3).name + class45.getColTags(16777215);
								...
								if (var2 == 39) {
									var8 = WorldMapRectangle.method280(ClientPacket.field2463,
									...
									var8 = WorldMapRectangle.method280(ClientPacket.field2446,
											Client.field957.field1484);
									var8.packetBuffer.method3559(var1);
									var8.packetBuffer.method3551(var3);
									var8.packetBuffer.method3528(var0);
									...
									var8 = WorldMapRectangle.method280(ClientPacket.field2439,
											Client.field957.field1484);
									var8.packetBuffer.method3550(var3);
									var8.packetBuffer.method3559(var1);
									var8.packetBuffer.method3528(var0);
									...
									var8 = WorldMapRectangle.method280(ClientPacket.field2426,
											Client.field957.field1484);
									var8.packetBuffer.method3528(var3);
									var8.packetBuffer.method3528(var0);
									var8.packetBuffer.putInt(var1);
									...
									var8 = WorldMapRectangle.method280(ClientPacket.field2449,
											Client.field957.field1484);
									var8.packetBuffer.method3561(var1);
									var8.packetBuffer.method3551(var3);
									var8.packetBuffer.method3528(var0);
									...
									if (var18 != null) {
										...
										Client.destinationX = var0;
										Client.destinationY = var1;
										var9 = WorldMapRectangle.method280(ClientPacket.field2401,
												Client.field957.field1484);
										var9.packetBuffer.method3542(KeyFocusListener.keyPressed[82] ? 1 : 0);
										var9.packetBuffer.method3551(var3);
										Client.field957.method2052(var9);
									...
									if (var18 != null) {
										...
										Client.destinationX = var0;
										Client.destinationY = var1;
										var9 = WorldMapRectangle.method280(ClientPacket.field2424,
												Client.field957.field1484);
										var9.packetBuffer.putShort(var3);
										var9.packetBuffer.putByte(KeyFocusListener.keyPressed[82] ? 1 : 0);
										Client.field957.method2052(var9);
									...
									if (var18 != null) {
										...
										Client.destinationX = var0;
										Client.destinationY = var1;
										var9 = WorldMapRectangle.method280(ClientPacket.field2407,
												Client.field957.field1484);
										var9.packetBuffer.method3541(KeyFocusListener.keyPressed[82] ? 1 : 0);
										var9.packetBuffer.method3528(var3);
										Client.field957.method2052(var9);
									...
									if (var18 != null) {
										...
										Client.destinationX = var0;
										Client.destinationY = var1;
										var9 = WorldMapRectangle.method280(ClientPacket.field2431,
												Client.field957.field1484);
										var9.packetBuffer.putByte(KeyFocusListener.keyPressed[82] ? 1 : 0);
										var9.packetBuffer.putShort(var3);
										Client.field957.method2052(var9);
									...
									if (var18 != null) {
										...
										Client.destinationX = var0;
										Client.destinationY = var1;
										var9 = WorldMapRectangle.method280(ClientPacket.field2425,
												Client.field957.field1484);
										var9.packetBuffer.putByte(KeyFocusListener.keyPressed[82] ? 1 : 0);
										var9.packetBuffer.method3551(var3);
										Client.field957.method2052(var9);
									...
									if (var18 != null) {
										...
										Client.destinationX = var0;
										Client.destinationY = var1;
										var9 = WorldMapRectangle.method280(ClientPacket.field2472,
												Client.field957.field1484);
										var9.packetBuffer.putByte(KeyFocusListener.keyPressed[82] ? 1 : 0);
										var9.packetBuffer.method3551(var3);
										Client.field957.method2052(var9);
									...
									if (var18 != null) {
										...
										Client.destinationX = var0;
										Client.destinationY = var1;
										var9 = WorldMapRectangle.method280(ClientPacket.field2391,
												Client.field957.field1484);
										var9.packetBuffer.putShort(var3);
										var9.packetBuffer.method3542(KeyFocusListener.keyPressed[82] ? 1 : 0);
										Client.field957.method2052(var9);
									...
									if (var18 != null) {
										...
										Client.destinationX = var0;
										Client.destinationY = var1;
										var9 = WorldMapRectangle.method280(ClientPacket.field2387,
												Client.field957.field1484);
										var9.packetBuffer.method3551(var3);
										var9.packetBuffer.method3541(KeyFocusListener.keyPressed[82] ? 1 : 0);
										Client.field957.method2052(var9);
									...
									label925: {
										if (var2 != 57) {
											if (var2 == 58) {
												var22 = FontName.getWidgetChild(var1, var0);
												if (var22 != null) {
													var9 = WorldMapRectangle.method280(ClientPacket.field2400,
															Client.field957.field1484);
											...
											if (var2 == 1001) {
												...
												Client.destinationX = var0;
												Client.destinationY = var1;
												var8 = WorldMapRectangle.method280(ClientPacket.field2443,
														Client.field957.field1484);
												var8.packetBuffer.method3528(class23.baseY + var1);
												var8.packetBuffer.method3528(var3 >> 14 & 32767);
												var8.packetBuffer.method3543(KeyFocusListener.keyPressed[82] ? 1 : 0);
											...
											if (var2 == 1002) {
												...
												Client.cursorState = 2;
												Client.field972 = 0;
												var8 = WorldMapRectangle.method280(ClientPacket.field2412,
														Client.field957.field1484);
											...
											if (var2 == 1003) {
												...
												if (var16 != null) {
													...
													if (var23 != null) {
														var14 = WorldMapRectangle.method280(ClientPacket.field2455,
																Client.field957.field1484);
											...
											if (var2 == 1004) {
												...
												Client.cursorState = 2;
												Client.field972 = 0;
												var8 = WorldMapRectangle.method280(ClientPacket.field2438,
														Client.field957.field1484);
												var8.packetBuffer.method3528(var3);
												Client.field957.method2052(var8);
												break label925;
											...
											if (var2 == 1005) {
												...
												if (var22 != null && var22.itemQuantities[var0] >= 100000) {
													class57.sendGameMessage(27, "", var22.itemQuantities[var0] + " x "
															+ class47.getItemDefinition(var3).name);
												} else {
													var9 = WorldMapRectangle.method280(ClientPacket.field2438,
															Client.field957.field1484);
													var9.packetBuffer.method3528(var3);
													Client.field957.method2052(var9);
												}
											...
											if (var2 != 1007) {
												if (var2 == 1011 || var2 == 1009 || var2 == 1008 || var2 == 1010
														|| var2 == 1012) {
													Preferences.renderOverview.onMapClicked(var2, var3,
										...
										if (var22 != null) {
											...
											if (var21 != null) {
												...
												if (var15 && DynamicObject
														.method2021(GroundObject.getWidgetClickMask(var21), var3 - 1)) {
													PacketNode var12;
													if (var3 == 1) {
														var12 = WorldMapRectangle.method280(ClientPacket.field2468,
																Client.field957.field1484);
													...
													if (var3 == 2) {
														var12 = WorldMapRectangle.method280(ClientPacket.field2421,
																Client.field957.field1484);
														var12.packetBuffer.putInt(var1);
														var12.packetBuffer.putShort(var0);
														var12.packetBuffer.putShort(var20);
													...
													if (var3 == 3) {
														var12 = WorldMapRectangle.method280(ClientPacket.field2417,
																Client.field957.field1484);
														var12.packetBuffer.putInt(var1);
														var12.packetBuffer.putShort(var0);
														var12.packetBuffer.putShort(var20);
													...
													if (var3 == 4) {
														var12 = WorldMapRectangle.method280(ClientPacket.field2445,
																Client.field957.field1484);
														var12.packetBuffer.putInt(var1);
														var12.packetBuffer.putShort(var0);
														var12.packetBuffer.putShort(var20);
													...
													if (var3 == 5) {
														var12 = WorldMapRectangle.method280(ClientPacket.field2422,
																Client.field957.field1484);
														var12.packetBuffer.putInt(var1);
														var12.packetBuffer.putShort(var0);
														var12.packetBuffer.putShort(var20);
													...
													if (var3 == 6) {
														var12 = WorldMapRectangle.method280(ClientPacket.field2478,
																Client.field957.field1484);
														var12.packetBuffer.putInt(var1);
														var12.packetBuffer.putShort(var0);
														var12.packetBuffer.putShort(var20);
													...
													if (var3 == 7) {
														var12 = WorldMapRectangle.method280(ClientPacket.field2430,
																Client.field957.field1484);
														var12.packetBuffer.putInt(var1);
														var12.packetBuffer.putShort(var0);
														var12.packetBuffer.putShort(var20);
													...
													if (var3 == 8) {
														var12 = WorldMapRectangle.method280(ClientPacket.field2479,
																Client.field957.field1484);
														var12.packetBuffer.putInt(var1);
														var12.packetBuffer.putShort(var0);
														var12.packetBuffer.putShort(var20);
													...
													if (var3 == 9) {
														var12 = WorldMapRectangle.method280(ClientPacket.field2403,
																Client.field957.field1484);
														var12.packetBuffer.putInt(var1);
														var12.packetBuffer.putShort(var0);
														var12.packetBuffer.putShort(var20);
													...
													if (var3 == 10) {
														var12 = WorldMapRectangle.method280(ClientPacket.field2429,
																Client.field957.field1484);
														var12.packetBuffer.putInt(var1);
														var12.packetBuffer.putShort(var0);
														var12.packetBuffer.putShort(var20);
