				...
				for (var16 = -var2; var16 < 0; ++var16) {
					...
					if (var11 == 0) {
						...
						graphicsPixels[var14++] = ((var21 & 16711935) * var10 >> 8 & 16711935)
								+ ((var17 & 16711935) * var11 >> 8 & 16711935) + (var10 * (var21 & 65280) >> 8 & 65280)
								+ (var11 * (var17 & 65280) >> 8 & 65280);
					}
				}
				...
				if (var9 > 0) {
					...
					if (var5 != var4) {
						var12 = (var17 * (var5 & 16711935) + var16 * (var4 & 16711935) & -16711936)
								+ (var17 * (var5 & 65280) + var16 * (var4 & 65280) & 16711680) >>> 8;
					}
				}
			...
			for (int var20 = 0; var20 < var3; ++var20) {
				...
				for (var21 = -var2; var21 < 0; ++var21) {
					...
					if (var11 == 0) {
						...
						var16 = var24 < 127 ? var24 * var11 + (var13 * var24 * var10 >> 7) >> 8
				...
				if (var9 > 0) {
					...
					if (var5 != var4) {
						var23 = (var22 * (var5 & 16711935) + var21 * (var4 & 16711935) & -16711936)
								+ (var22 * (var5 & 65280) + var21 * (var4 & 65280) & 16711680) >>> 8;
						var12 = var23 >> 16;
						var13 = (var23 & 65280) >> 8;
						var14 = var23 & 255;
					}
		...
		if (var2 > 0 && var3 > 0) {
			...
			for (int var10 = -var3; var10 < 0; ++var10) {
				...
				int var13 = (var12 * (var5 & 16711935) + var11 * (var4 & 16711935) & -16711936)
						+ (var12 * (var5 & 65280) + var11 * (var4 & 65280) & 16711680) >>> 8;
