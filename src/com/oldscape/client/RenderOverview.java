...
public class RenderOverview {
	...
	public int method6057() {
		return this.field4055.tryLoadRecordByNames(this.field4018.getIdentifier(), MapCacheArchiveNames.AREA.name) ? 100
				: this.field4055.archiveLoadPercentByName(this.field4018.getIdentifier());
	}
	...
	public void method6009(int var1, int var2, boolean var3, int var4, int var5, int var6, int var7) {
		if (this.field4043.method5997()) {
			...
			this.method6013();
			if (var3) {
				int var8 = (int) Math.ceil(var6 / this.worldMapZoom);
				int var9 = (int) Math.ceil(var7 / this.worldMapZoom);
				List var10 = this.worldMapManager.method596(this.worldMapX - var8 / 2 - 1,
						this.worldMapY - var9 / 2 - 1, var8 / 2 + this.worldMapX + 1, var9 / 2 + this.worldMapY + 1,
						var4, var5, var6, var7, var1, var2);
	...
	public void method6010(int var1, int var2, boolean var3, boolean var4) {
		...
		if (!this.method6017() && (var4 || var3)) {
			...
			if (this.field4010 != -1) {
				...
				this.method6014(this.field4010 - (int) (var7 / this.worldMapZoomTarget),
						(int) (var8 / this.worldMapZoomTarget) + this.field4022, false);
			}
		} else {
			this.method6070();
		}
	...
	void method6011(int var1, int var2, boolean var3, long var4) {
		if (this.worldMapData != null) {
			int var6 = (int) (this.worldMapX
					+ (var1 - this.field4031 - this.method6044() * this.worldMapZoom / 2.0F) / this.worldMapZoom);
			int var7 = (int) (this.worldMapY
					- (var2 - this.field4058 - this.method6045() * this.worldMapZoom / 2.0F) / this.worldMapZoom);
			this.field4057 = this.worldMapData.method322(var6 + this.worldMapData.getMinX() * 64,
					var7 + this.worldMapData.getMinY() * 64);
			if (this.field4057 != null && var3) {
				...
				if (var8 && KeyFocusListener.keyPressed[82] && KeyFocusListener.keyPressed[81]) {
					...
					if (var9) {
						PacketNode var12 = WorldMapRectangle.method280(ClientPacket.field2409,
	...
	void method6173(int var1, int var2, int var3) {
		if (this.worldMapData != null) {
			...
			if (var4 == null) {
				var4 = this.worldMapData.method321(this.worldMapData.method386(), this.worldMapData.method334(),
						this.worldMapData.method336());
			}

			this.method6014(var4[0] - this.worldMapData.getMinX() * 64, var4[1] - this.worldMapData.getMinY() * 64,
					true);
			this.field4025 = -1;
			this.field4026 = -1;
	...
	public void extractWorldmap(int var1, int var2, int var3, int var4, int var5) {
		...
		if (var7 < 100) {
			...
			int var8 = (int) Math.ceil(var3 / this.worldMapZoom);
			int var9 = (int) Math.ceil(var4 / this.worldMapZoom);
			this.worldMapManager.drawMapRegion(this.worldMapX - var8 / 2, this.worldMapY - var9 / 2,
					var8 / 2 + this.worldMapX, var9 / 2 + this.worldMapY, var1, var2, var3 + var1, var2 + var4);
			boolean var10;
			if (!this.field4051) {
				var10 = false;
				...
				this.worldMapManager.drawMapIcons(this.worldMapX - var8 / 2, this.worldMapY - var9 / 2,
						var8 / 2 + this.worldMapX, var9 / 2 + this.worldMapY, var1, var2, var3 + var1, var2 + var4,
						this.field4050, this.field4036, this.field4038, this.field4034, var10);
			}

			this.method6028(var1, var2, var3, var4, var8, var9);
			var10 = Client.rights >= 2;
			if (var10 && this.field4016 && this.field4057 != null) {
				this.field4008.method5510("Coord: " + this.field4057, Rasterizer2D.draw_region_x + 10,
	...
	boolean method6027(int var1, int var2, int var3, int var4, int var5, int var6) {
		return this.field4047 == null ? true
				: (this.field4047.width == var1 && this.field4047.height == var2
						? (this.worldMapManager.field548 != this.field4060 ? true
								: (this.field4029 != Client.field1135 ? true
										: (var3 <= 0 && var4 <= 0 ? var3 + var1 < var5 || var2 + var4 < var6 : true)))
						: true);
	}
	...
	public int method6033() {
		return 1.0D == this.worldMapZoomTarget ? 25
				: (1.5D == this.worldMapZoomTarget ? 37
						: (this.worldMapZoomTarget == 2.0D ? 50
								: (3.0D == this.worldMapZoomTarget ? 75
										: (this.worldMapZoomTarget == 4.0D ? 100 : 200))));
	}
	...
	public void method6077(int var1, int var2, int var3, int var4, int var5, int var6) {
		if (this.field4043.method5997()) {
			int var7 = (int) Math.ceil(var3 / this.worldMapZoom);
			int var8 = (int) Math.ceil(var4 / this.worldMapZoom);
			List var9 = this.worldMapManager.method596(this.worldMapX - var7 / 2 - 1, this.worldMapY - var8 / 2 - 1,
					var7 / 2 + this.worldMapX + 1, var8 / 2 + this.worldMapY + 1, var1, var2, var3, var4, var5, var6);
			if (!var9.isEmpty()) {
				...
				do {
					...
					for (int var14 = this.field4061.length - 1; var14 >= 0; --var14) {
						if (var12.field3462[var14] != null) {
							TextureProvider.addMenuEntry(var12.field3462[var14], var12.field3470, this.field4061[var14],
									var11.areaId, var11.field524.bitpack(), var11.field532.bitpack());
							var13 = true;
						}
					}
				} while (!var13);
