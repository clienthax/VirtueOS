		...
		if (var2 == 1) {
			...
			return var2 == 2 ? var0.location - var1.location
					: (var2 == 3
							...
							: (var2 == 4
									? (var0.method1686() ? (var1.method1686() ? 0 : 1) : (var1.method1686() ? -1 : 0))
									: (var2 == 5
											? (var0.method1684() ? (var1.method1684() ? 0 : 1)
													: (var1.method1684() ? -1 : 0))
											: (var2 == 6
													? (var0.method1685() ? (var1.method1685() ? 0 : 1)
															: (var1.method1685() ? -1 : 0))
													: (var2 == 7
															? (var0.method1683() ? (var1.method1683() ? 0 : 1)
																	: (var1.method1683() ? -1 : 0))
															: var0.id - var1.id)))));
		}
	}
