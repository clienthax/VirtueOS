		...
		if (SoundTaskDataProvider.localPlayer != var0) {
			if (Client.menuOptionCount < 400) {
				...
				if (var0.totalLevel == 0) {
					var4 = var0.actions[0] + var0.name + var0.actions[1]
							+ PendingSpawn.method1653(var0.combatLevel, SoundTaskDataProvider.localPlayer.combatLevel)
				...
				if (Client.itemSelectionState == 1) {
					TextureProvider.addMenuEntry("Use",
							Client.lastSelectedItemName + " " + "->" + " " + class45.getColTags(16777215) + var4, 14,
							var1, var2, var3);
				} else if (Client.spellSelected) {
					if ((class110.field1607 & 8) == 8) {
						TextureProvider.addMenuEntry(Client.field1092,
								Client.field1028 + " " + "->" + " " + class45.getColTags(16777215) + var4, 15, var1,
								var2, var3);
					}
				} else {
					for (var5 = 7; var5 >= 0; --var5) {
						if (Client.playerOptions[var5] != null) {
							...
							TextureProvider.addMenuEntry(Client.playerOptions[var5],
									class45.getColTags(16777215) + var4, var8, var1, var2, var3);
						}
					}
				}
