...
public class SoundTask implements Runnable {
	...
	public static final boolean boundingBox3DContainsMouse(Model var0, int var1, int var2, int var3) {
		if (!IndexStoreActionHandler.method4629()) {
			...
			return Math.abs(var10) > var7 + class20.field336 ? false
					: (Math.abs(var11) > var8 + class132.field1926 ? false
							: (Math.abs(var12) > var9 + IndexStoreActionHandler.field3399 ? false
									: (Math.abs(var12 * class37.field502 - var11 * Resampler.field1629) > var8
											* IndexStoreActionHandler.field3399 + var9 * class132.field1926
													? false
													: (Math.abs(var10 * Resampler.field1629
															- var12 * class132.field1925) > var7
																	* IndexStoreActionHandler.field3399
																	+ var9 * class20.field336
																			? false
																			: Math.abs(var11 * class132.field1925
																					- var10 * class37.field502) <= var7
																							* class132.field1926
																							+ var8 * class20.field336))));
		}
	}
