...
public final class SpritePixels extends Rasterizer2D {
	...
	public SpritePixels copy() {
		...
		for (int var2 = 0; var2 < this.height; ++var2) {
			for (int var3 = 0; var3 < this.width; ++var3) {
				var1.pixels[var3 + (var2 + this.offsetY) * this.maxWidth + this.offsetX] = this.pixels[var3
						+ var2 * this.width];
			}
		}
	...
	public void method5850() {
		if (this.width != this.maxWidth || this.height != this.maxHeight) {
			...
			for (int var2 = 0; var2 < this.height; ++var2) {
				for (int var3 = 0; var3 < this.width; ++var3) {
					var1[var3 + (var2 + this.offsetY) * this.maxWidth + this.offsetX] = this.pixels[var3
							+ var2 * this.width];
				}
			}
	...
	public void method5860(int var1, int var2, int var3, int var4) {
		if (var3 > 0 && var4 > 0) {
			...
			method5929(Rasterizer2D.graphicsPixels, this.pixels, 0, var7, var8, var13, var14, var3, var4, var11, var12,
					var5);
		}
	}
	...
	public void method5862(int var1, int var2, int var3, int var4) {
		if (var3 == 256) {
			...
			if (var8 > 0 && var7 > 0) {
				method5863(Rasterizer2D.graphicsPixels, this.pixels, 0, var6, var5, var8, var7, var9, var10, var3,
						var4);
			}
		}
	}
	...
	public void method5866(int var1, int var2, int var3, int var4, int var5) {
		if (var3 > 0 && var4 > 0) {
			...
			method5867(Rasterizer2D.graphicsPixels, this.pixels, 0, var8, var9, var14, var15, var3, var4, var12, var13,
					var6, var5);
		}
	}
	...
	public void method5868(int var1, int var2, int var3) {
		...
		if (var7 > 0 && var6 > 0) {
			if (var3 == 256) {
				...
				method5870(0, 0, 0, Rasterizer2D.graphicsPixels, this.pixels, var5, 0, var4, 0, var7, var6, var8, var9,
						var3);
			}
	...
	public void method5934(int var1, int var2, int var3, int var4, int var5) {
		if (var3 > 0 && var4 > 0) {
			...
			if (var5 == 256) {
				method5872(0, 0, 0, var8, this.pixels, Rasterizer2D.graphicsPixels, 0, 0, -var4, var9, var14, var15,
						var3, var12, var13, var6);
			} else {
				method5873(0, 0, 0, var8, this.pixels, Rasterizer2D.graphicsPixels, 0, 0, -var4, var9, var14, var15,
						var3, var12, var13, var6, var5);
			}
	...
	public void method5875(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int[] var9,
			int[] var10) {
		try {
			int var11 = -var3 / 2;
			int var12 = -var4 / 2;
	...
	void method5891(int var1, int var2, int var3, int var4, int var5, int var6) {
		if (var6 != 0) {
			var1 -= this.offsetX << 4;
			var2 -= this.offsetY << 4;
			double var7 = (var5 & 65535) * 9.587379924285257E-5D;
	...
	static void method5922(int[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7,
			int var8) {
		int var9 = -(var5 >> 2);
		var5 = -(var5 & 3);
	...
	static void method5929(int[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8,
	...
	static void method5863(int[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8,
			int var9, int var10) {
		int var11 = 256 - var9;
	...
	static void method5923(int[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8,
			int var9) {
		int var10 = 256 - var9;
			...
			for (int var12 = -var5; var12 < 0; ++var12) {
				...
				if (var2 != 0) {
					...
					var0[var4++] = ((var13 & 16711935) * var10 + var9 * (var2 & 16711935) & -16711936)
							+ ((var2 & 65280) * var9 + var10 * (var13 & 65280) & 16711680) >> 8;
				} else {
					++var4;
				}
			}
	...
	static void method5867(int[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8,
	...
	static void method5869(int var0, int var1, int var2, int[] var3, int[] var4, int var5, int var6, int var7, int var8,
			int var9, int var10, int var11, int var12) {
	...
	static void method5872(int var0, int var1, int var2, int var3, int[] var4, int[] var5, int var6, int var7, int var8,
	...
	static void method5873(int var0, int var1, int var2, int var3, int[] var4, int[] var5, int var6, int var7, int var8,
