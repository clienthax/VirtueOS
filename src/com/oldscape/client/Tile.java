...
public final class Tile extends Node {
	...
	public static void method2684(String var0, String var1, int var2, int var3) throws IOException {
		...
		WorldMapData.cacheLocations = new String[] { "c:/rscache/", "/rscache/", "c:/windows/", "c:/winnt/", "c:/",
				NPC.userHome, "/tmp/", "" };
		Resampler.field1627 = new String[] { ".jagex_cache_" + BoundingBox.field253,
				".file_store_" + BoundingBox.field253 };
		int var18 = 0;

		File var5;
		label279: while (var18 < 4) {
			...
			if (class167.jagexClDat.exists()) {
				try {
					...
					for (var11 = new Buffer(
							(int) var10.length()); var11.offset < var11.payload.length; var11.offset += var12) {
			...
			if (var7 == null && var18 == 0) {
				label254: for (int var19 = 0; var19 < Resampler.field1627.length; ++var19) {
					for (int var20 = 0; var20 < WorldMapData.cacheLocations.length; ++var20) {
						File var21 = new File(WorldMapData.cacheLocations[var20] + Resampler.field1627[var19]
			...
			if (var7 == null) {
				var7 = NPC.userHome + File.separatorChar + "jagexcache" + var6 + File.separatorChar + var0
		...
		if (!class170.field2233.exists()) {
			...
			try {
				...
				if (var5.exists()) {
					...
					label205: for (int var25 = 0; var25 < Resampler.field1627.length; ++var25) {
						for (var26 = 0; var26 < WorldMapData.cacheLocations.length; ++var26) {
							File var36 = new File(WorldMapData.cacheLocations[var26] + Resampler.field1627[var25]
			...
			class167.dat2File = new CacheFile(
					new FileOnDisk(MessageNode.method1176("main_file_cache.dat2"), "rw", 1048576000L), 5200, 0);
			class167.idx255File = new CacheFile(
					new FileOnDisk(MessageNode.method1176("main_file_cache.idx255"), "rw", 1048576L), 6000, 0);
			Size.idxFiles = new CacheFile[class37.idxCount];

			for (int var27 = 0; var27 < class37.idxCount; ++var27) {
				Size.idxFiles[var27] = new CacheFile(
						new FileOnDisk(MessageNode.method1176("main_file_cache.idx" + var27), "rw", 1048576L), 6000, 0);
			}
	...
	public static FloorUnderlayDefinition getUnderlayDefinition(int var0) {
		FloorUnderlayDefinition var1 = (FloorUnderlayDefinition) FloorUnderlayDefinition.underlays.get(var0);
		if (var1 != null) {
			return var1;
		} else {
			...
			var1.post();
			FloorUnderlayDefinition.underlays.put(var1, var0);
			return var1;
		}
	}
}
