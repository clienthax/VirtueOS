...
final class WorldComparator implements Comparator {
	...
	static void method69() {
		...
		if (class90.username.length() == 0) {
			BoundingBox3DDrawMode.method53("Please enter your username.", "If you created your account after November",
			...
			if (0L == var1) {
				...
				try {
					...
					var15.write("data2=" + class297.method5290(var12) + "&dest="
							+ class297.method5290("passwordchoice.ws"));
					var15.flush();
			...
			switch (var0) {
			case 2:
				BoundingBox3DDrawMode.method53("", "Page has opened in a new window.",
			...
			case 3:
				...
				break;
			case 4:
				BoundingBox3DDrawMode.method53("The part of the website you are trying",
						"to connect to is offline at the moment.", "Please try again later.");
				break;
			case 5:
				BoundingBox3DDrawMode.method53("Sorry, there was an error trying to",
			...
			case 6:
				...
				break;
			case 7:
				BoundingBox3DDrawMode.method53("You must enter a valid login to proceed. For accounts",
	...
	static int method57(int var0, Script var1, boolean var2) {
		...
		if (var0 == 4000) {
			...
			intStackSize -= 3;
			long var9 = class81.intStack[intStackSize];
			long var11 = class81.intStack[intStackSize + 1];
			long var13 = class81.intStack[intStackSize + 2];
