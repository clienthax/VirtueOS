...
public final class WorldMapManager {
	...
	public void load(IndexDataBase var1, String var2, boolean var3) {
		if (!this.loading) {
			...
			while (var11.hasNext()) {
				...
				this.mapRegions[var15][var16] = new WorldMapRegion(var13, var14, this.field549.method352(),
						this.mapFonts);
			...
			for (int var18 = 0; var18 < var17; ++var18) {
				for (int var19 = 0; var19 < var10; ++var19) {
					if (this.mapRegions[var18][var19] == null) {
						this.mapRegions[var18][var19] = new WorldMapRegion(this.field549.getMinX() + var18,
								this.field549.getMinY() + var19, this.field549.method352(), this.mapFonts);
	...
	public final void drawMapRegion(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8) {
		...
		for (var17 = var13.worldMapRegionX; var17 < var13.worldMapRegionWidth + var13.worldMapRegionX; ++var17) {
			for (var18 = var13.worldMapRegionY; var18 < var13.worldMapRegionY + var13.worldMapRegionHeight; ++var18) {
				...
				this.mapRegions[var17][var18].method444(var15, (class47) this.field546.get(Integer.valueOf(var15)),
						var22, this.field553);
			}
		}
		...
		for (int var20 = var13.worldMapRegionX; var20 < var13.worldMapRegionWidth + var13.worldMapRegionX; ++var20) {
			for (int var21 = var13.worldMapRegionY; var21 < var13.worldMapRegionHeight
					+ var13.worldMapRegionY; ++var21) {
				this.mapRegions[var20][var21].method413(
						var5 + var17 * (this.mapRegions[var20][var21].field484 * 64 - var18) / 64,
						var8 - var17 * (this.mapRegions[var20][var21].field482 * 64 - var19 + 64) / 64, var17);
			}
		}

	}

	public final void drawMapIcons(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8,
		...
		for (var19 = var14.worldMapRegionX; var19 < var14.worldMapRegionWidth + var14.worldMapRegionX; ++var19) {
			for (var20 = var14.worldMapRegionY; var20 < var14.worldMapRegionY + var14.worldMapRegionHeight; ++var20) {
				...
				this.mapRegions[var19][var20].method419(
						var5 + var16 * (this.mapRegions[var19][var20].field484 * 64 - var17) / 64,
						var8 - var16 * (this.mapRegions[var19][var20].field482 * 64 - var18 + 64) / 64, var16, var9);
			}
		}

		if (var10 != null && var11 > 0) {
			for (var19 = var14.worldMapRegionX; var19 < var14.worldMapRegionWidth + var14.worldMapRegionX; ++var19) {
				for (var20 = var14.worldMapRegionY; var20 < var14.worldMapRegionY
						+ var14.worldMapRegionHeight; ++var20) {
	...
	public List method596(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9,
			int var10) {
		...
		if (!this.loaded) {
			...
			for (int var17 = var12.worldMapRegionX; var17 < var12.worldMapRegionX
					+ var12.worldMapRegionWidth; ++var17) {
				for (int var18 = var12.worldMapRegionY; var18 < var12.worldMapRegionHeight
						+ var12.worldMapRegionY; ++var18) {
					List var19 = this.mapRegions[var17][var18].method469(
							var5 + var14 * (this.mapRegions[var17][var18].field484 * 64 - var15) / 64,
							var8 + var6 - var14 * (this.mapRegions[var17][var18].field482 * 64 - var16 + 64) / 64,
							var14, var9, var10);
					if (!var19.isEmpty()) {
						var11.addAll(var19);
					}
	...
	float method601(int var1, int var2) {
		...
		if (var3 > 8.0F) {
			...
			return Math.abs(var4 - var3) < 0.05F ? (float) var4 : var3;
		}
	}
	...
	static int method610(int var0, Script var1, boolean var2) {
		...
		if (var0 == 3100) {
			...
			GameObject.method3083(SoundTaskDataProvider.localPlayer, class81.intStack[WorldComparator.intStackSize],
					class81.intStack[WorldComparator.intStackSize + 1]);
			return 1;
		} else if (var0 == 3103) {
			...
			for (WidgetNode var15 = (WidgetNode) Client.componentTable
					.first(); var15 != null; var15 = (WidgetNode) Client.componentTable.next()) {
				...
				if (var0 == 3105) {
					...
					if (var0 == 3107) {
						...
						if (var4.length() > 500) {
							...
							PacketNode var6 = WorldMapRectangle.method280(ClientPacket.field2385,
									Client.field957.field1484);
							var6.packetBuffer
									.putShort(1 + WorldMapRegion.getLength(var4) + WorldMapRegion.getLength(var8));
	...
	static void method627(Player var0, boolean var1) {
		if (var0 != null && var0.hasConfig() && !var0.hidden) {
			...
			if ((Client.lowMemory && class93.playerIndexesCount > 50 || class93.playerIndexesCount > 200) && var1
					&& var0.idlePoseAnimation == var0.poseAnimation) {
			...
			if (var3 >= 0 && var3 < 104 && var4 >= 0 && var4 < 104) {
				if (var0.model != null && Client.gameCycle >= var0.animationCycleStart
						&& Client.gameCycle < var0.animationCycleEnd) {
					var0.isLowDetail = false;
					var0.field842 = class265.getTileHeight(var0.x, var0.y, BoundingBox3DDrawMode.plane);
					var0.field1161 = Client.gameCycle;
					class255.region.method2871(BoundingBox3DDrawMode.plane, var0.x, var0.y, var0.field842, 60, var0,
							var0.angle, var2, var0.field849, var0.field850, var0.field851, var0.field852);
				} else {
					...
					var0.field842 = class265.getTileHeight(var0.x, var0.y, BoundingBox3DDrawMode.plane);
					var0.field1161 = Client.gameCycle;
					class255.region.method2863(BoundingBox3DDrawMode.plane, var0.x, var0.y, var0.field842, 60, var0,
							var0.angle, var2, var0.field1159);
				}
			}
		}
