...
public class WorldMapRegion {
	...
	void method416(int var1, int var2, int var3, int var4, class28 var5) {
		for (int var6 = var1; var6 < var3 + var1; ++var6) {
			label55: for (int var7 = var2; var7 < var2 + var4; ++var7) {
				...
				for (int var9 = 0; var9 < var5.field411; ++var9) {
					...
					if (var10 != null && var10.length != 0) {
						...
						for (int var12 = 0; var12 < var11.length; ++var12) {
							...
							if (var14 != null) {
								Coordinates var15 = new Coordinates(var9, this.field484 * 64 + var6,
										this.field482 * 64 + var7);
								Coordinates var16 = null;
								if (this.field483 != null) {
									var16 = new Coordinates(this.field483.field410 + var9,
											var6 + this.field483.field406 * 64, var7 + this.field483.field407 * 64);
								} else {
									class46 var17 = (class46) var5;
									var16 = new Coordinates(var9 + var17.field410,
											var6 + var17.field406 * 64 + var17.method679() * 8,
											var7 + var17.field407 * 64 + var17.method680() * 8);
								}
	...
	void method444(int var1, class47 var2, WorldMapRegion[] var3, IndexedSprite[] var4) {
		...
		if (this.field483 != null || !this.field475.isEmpty()) {
			...
			if (var5 == null) {
				...
				long var15 = var12 << 16 | var10 << 8 | var11;
	...
	void method424(int var1, int var2, class28 var3, class47 var4, class33 var5) {
		...
		if (var6 == -1 && var7 == -1) {
			Rasterizer2D.Rasterizer2D_fillRectangle(this.field474 * var1, this.field474 * (63 - var2), this.field474,
					this.field474, this.field485);
		}
		...
		if (var7 > -1 && var3.field408[0][var1][var2] == 0) {
			...
			if (var7 == -1) {
				Rasterizer2D.Rasterizer2D_fillRectangle(this.field474 * var1, this.field474 * (63 - var2),
						this.field474, this.field474, var9);
			} else {
				var4.method707(this.field474 * var1, this.field474 * (63 - var2), var9, var8, this.field474,
						this.field474, var3.field408[0][var1][var2], var3.field415[0][var1][var2]);
			}
		}
	}
		...
		for (int var5 = 1; var5 < var3.field411; ++var5) {
			...
			if (var6 > -1) {
				...
				if (var3.field408[var5][var1][var2] == 0) {
					Rasterizer2D.Rasterizer2D_fillRectangle(this.field474 * var1, this.field474 * (63 - var2),
							this.field474, this.field474, var7);
				} else {
					var4.method707(this.field474 * var1, this.field474 * (63 - var2), 0, var7, this.field474,
							this.field474, var3.field408[var5][var1][var2], var3.field415[var5][var1][var2]);
				}
			}
		}
	...
	void method500(WorldMapRegion[] var1, class44 var2) {
		class254[] var3 = new class254[] { class254.field3321, class254.field3322, class254.field3326,
				class254.field3328, class254.field3327, class254.field3324, class254.field3325, class254.field3323 };
		class254[] var5 = var3;
				...
				for (int var8 = 0; var8 < var7.length; ++var8) {
					...
					if (var12.mapSceneId != -1) {
						if (var12.mapSceneId != 46 && var12.mapSceneId != 52) {
							var4[var12.mapSceneId].method5827(this.field474 * var1, this.field474 * (63 - var2),
									this.field474 * 2, this.field474 * 2);
						} else {
							var4[var12.mapSceneId].method5827(this.field474 * var1, this.field474 * (63 - var2),
									this.field474 * 2 + 1, this.field474 * 2 + 1);
						}
					}
				}
			}
		...
		for (int var4 = 0; var4 < var3.field411; ++var4) {
			...
			if (var5 != null && var5.length != 0) {
				...
				for (int var7 = 0; var7 < var6.length; ++var7) {
					...
					boolean var9 = var10 >= WorldMapDecorationType.field2992.rsOrdinal
							&& var10 <= WorldMapDecorationType.field2989.rsOrdinal
							|| var10 == WorldMapDecorationType.field2990.rsOrdinal;
					if (var9) {
						...
						if (var8.decoration == WorldMapDecorationType.field2989.rsOrdinal) {
							...
							if (var8.rotation == 1) {
								Rasterizer2D.method5731(this.field474 + this.field474 * var1 - 1,
										this.field474 * (63 - var2), 1, var12);
							}

							if (var8.rotation == 2) {
								Rasterizer2D.method5731(this.field474 * var1 + this.field474 - 1,
										this.field474 * (63 - var2) + this.field474 - 1, 1, var12);
							}

							if (var8.rotation == 3) {
								Rasterizer2D.method5731(this.field474 * var1,
										this.field474 * (63 - var2) + this.field474 - 1, 1, var12);
							}
						}
						...
						if (var8.decoration == WorldMapDecorationType.field2990.rsOrdinal) {
							...
							if (var13 == 0) {
								for (var14 = 0; var14 < this.field474; ++var14) {
									Rasterizer2D.method5731(var14 + this.field474 * var1,
											(64 - var2) * this.field474 - 1 - var14, 1, var12);
								}
							} else {
								for (var14 = 0; var14 < this.field474; ++var14) {
									Rasterizer2D.method5731(var14 + this.field474 * var1,
											var14 + this.field474 * (63 - var2), 1, var12);
								}
							}
						}
					}
	...
	void drawNonLinkMapIcons(int var1, int var2, HashSet var3, int var4) {
		...
		while (var7.hasNext()) {
			...
			int var10 = (int) (var1 + var5 * var9.worldX - var6);
			int var11 = (int) (var2 + var4 - var5 * var9.worldY - var6);
	...
	void method439(MapIcon var1, Area var2, int var3, int var4, float var5) {
		if (var1.field527 != null) {
			if (var1.field527.fontSize.method192(var5)) {
				...
				var6.method5514(var1.field527.text, var3 - var1.field527.field470 / 2, var4, var1.field527.field470,
						var1.field527.field469, -16777216 | var2.field3460, 0, 1, 0, var6.verticalSpace / 2);
			}
		}
	}
	...
	void drawMapLinks(int var1, int var2, HashSet var3, int var4) {
		...
		while (var6.hasNext()) {
			...
			var7.screenX = (int) (var5 * var8 + var1);
			var7.screenY = (int) (var2 + var5 * (63 - var9));
					...
					if (var9 != null) {
						...
						if (var10 != null) {
							if (var9.id != var10.areaId) {
								MapIcon var16 = new MapIcon(var9.id, var10.field524, var10.field532,
										this.method447(var9));
						...
						if (this.field483 != null) {
							var12 = new Coordinates(this.field483.field410 + var4, this.field483.field406 * 64 + var1,
									var2 + this.field483.field407 * 64);
						} else {
							...
							while (var13.hasNext()) {
								...
								if (var14.method678(var1, var2)) {
									var12 = new Coordinates(var4 + var14.field410,
											var14.field406 * 64 + var1 + var14.method679() * 8,
											var14.field407 * 64 + var2 + var14.method680() * 8);
									break;
								}
							}
						}
	...
	void method466(int var1, int var2, int var3, int var4) {
		...
		if (var3 == 2) {
			Rasterizer2D.method5797(this.field474 * var1 + this.field474 - 1, this.field474 * (63 - var2),
					this.field474, var4);
		}

		if (var3 == 3) {
			Rasterizer2D.method5731(this.field474 * var1, this.field474 * (63 - var2) + this.field474 - 1,
					this.field474, var4);
		}
