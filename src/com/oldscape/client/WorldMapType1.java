...
public class WorldMapType1 implements WorldMapSectionBase {
	...
	public boolean containsCoord(int var1, int var2, int var3) {
		return var1 >= this.field435 && var1 < this.field438 + this.field435 ? var2 >> 6 >= this.field429
				&& var2 >> 6 <= this.field440 && var3 >> 6 >= this.field431 && var3 >> 6 <= this.field432 : false;
	}

	@Override
	public boolean vmethod768(int var1, int var2) {
		return var1 >> 6 >= this.field427 && var1 >> 6 <= this.field428 && var2 >> 6 >= this.field434
				&& var2 >> 6 <= this.field436;
	}
	...
	public int[] vmethod753(int var1, int var2, int var3) {
		if (!this.containsCoord(var1, var2, var3)) {
			...
			int[] var4 = new int[] { this.field427 * 64 - this.field429 * 64 + var2,
					var3 + (this.field434 * 64 - this.field431 * 64) };
			return var4;
		}
	}
