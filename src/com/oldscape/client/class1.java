					...
					if (var0 == 6611) {
						...
						if (var13 == null) {
							...
							class81.intStack[++WorldComparator.intStackSize
									- 1] = (var13.method360() - var13.getMinX() + 1) * 64;
							class81.intStack[++WorldComparator.intStackSize
									- 1] = (var13.method331() - var13.getMinY() + 1) * 64;
						}
						...
						if (var0 == 6618) {
							...
							if (var0 == 6619) {
								...
								if (var11 == null) {
									...
									class81.intStack[++WorldComparator.intStackSize - 1] = var11
											.containsCoord(var12.plane, var12.worldX, var12.worldY) ? 1 : 0;
									return 1;
								}
							} else if (var0 == 6622) {
								class81.intStack[++WorldComparator.intStackSize - 1] = class86.method1892()
										.method6044();
								class81.intStack[++WorldComparator.intStackSize - 1] = class86.method1892()
										.method6045();
								return 1;
								...
								var15 = new Coordinates(class81.intStack[--WorldComparator.intStackSize]);
								var13 = class86.method1892().getWorldMapDataContainingCoord(var15.plane, var15.worldX,
										var15.worldY);
								if (var13 == null) {
									class81.intStack[++WorldComparator.intStackSize - 1] = -1;
								} else {
									...
									if (var0 == 6633) {
										...
										if (var0 == 6639) {
											...
											if (var8 == null) {
												...
												class81.intStack[++WorldComparator.intStackSize - 1] = var8.field532
														.bitpack();
											}
											...
											if (var0 == 6693) {
												...
												class81.intStack[++WorldComparator.intStackSize
														- 1] = class20.scriptMapIconReference.areaId;
												return 1;
											} else if (var0 == 6698) {
												class81.intStack[++WorldComparator.intStackSize
														- 1] = class20.scriptMapIconReference.field590.bitpack();
												return 1;
											} else if (var0 == 6699) {
												class81.intStack[++WorldComparator.intStackSize
														- 1] = class20.scriptMapIconReference.field591.bitpack();
												return 1;
											} else {
												return 2;
											}
