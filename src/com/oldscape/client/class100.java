...
public class class100 extends TaskDataNode {
	...
	void method2075() {
		if (this.field1498 > 0) {
			for (class112 var1 = (class112) this.field1499.getFront(); var1 != null; var1 = (class112) this.field1499
					.getNext()) {
	...
	void method2089(int[] var1, int var2, int var3) {
		for (TaskDataNode var4 = (TaskDataNode) this.field1497
				.getFront(); var4 != null; var4 = (TaskDataNode) this.field1497.getNext()) {
	...
	void method2070(int var1) {
		for (TaskDataNode var2 = (TaskDataNode) this.field1497
				.getFront(); var2 != null; var2 = (TaskDataNode) this.field1497.getNext()) {
