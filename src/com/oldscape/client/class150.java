...
public class class150 extends class297 {
	...
	int method3121(ChatPlayer var1, ChatPlayer var2) {
		return Client.world == var1.world && var2.world == Client.world
				? (this.field2143 ? var1.method5271().compareCleanName(var2.method5271())
						: var2.method5271().compareCleanName(var1.method5271()))
		...
		if (var0.length == 100 && class195.field2583 < 1000) {
			...
			if (class319.field3930 != null) {
				for (int var1 = 0; var1 < class195.field2584.length; ++var1) {
					if (var0.length == class195.field2584[var1]
							&& OwnWorldComparator.field866[var1] < class319.field3930[var1].length) {
