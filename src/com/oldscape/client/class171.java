...
public class class171 extends class169 {
	...
	public static int method3325(int var0, int var1, int var2, class178 var3, CollisionData var4, boolean var5,
			int[] var6, int[] var7) {
		int var9;
		...
		if (var2 == 1) {
			...
			while (true) {
				...
				if (var30 > 0 && class177.field2285[var30 - 1][var31] == 0 && (var27[var19 - 1][var20] & 19136782) == 0
						&& (var27[var19 - 1][var20 + 1] & 19136824) == 0) {
				...
				if (var30 < 126 && class177.field2285[var30 + 1][var31] == 0
						&& (var27[var19 + 2][var20] & 19136899) == 0 && (var27[var19 + 2][var20 + 1] & 19136992) == 0) {
					class177.field2290[var33] = var10 + 1;
					class177.field2287[var33] = var11;
					var33 = var33 + 1 & 4095;
				...
				if (var31 > 0 && class177.field2285[var30][var31 - 1] == 0 && (var27[var19][var20 - 1] & 19136782) == 0
						&& (var27[var19 + 1][var20 - 1] & 19136899) == 0) {
				...
				if (var31 < 126 && class177.field2285[var30][var31 + 1] == 0
						&& (var27[var19][var20 + 2] & 19136824) == 0 && (var27[var19 + 1][var20 + 2] & 19136992) == 0) {
					class177.field2290[var33] = var10;
					class177.field2287[var33] = var11 + 1;
					var33 = var33 + 1 & 4095;
				...
				if (var30 > 0 && var31 > 0 && class177.field2285[var30 - 1][var31 - 1] == 0
						&& (var27[var19 - 1][var20] & 19136830) == 0 && (var27[var19 - 1][var20 - 1] & 19136782) == 0
						&& (var27[var19][var20 - 1] & 19136911) == 0) {
					class177.field2290[var33] = var10 - 1;
					class177.field2287[var33] = var11 - 1;
					var33 = var33 + 1 & 4095;
				...
				if (var30 < 126 && var31 > 0 && class177.field2285[var30 + 1][var31 - 1] == 0
						&& (var27[var19 + 1][var20 - 1] & 19136911) == 0
						&& (var27[var19 + 2][var20 - 1] & 19136899) == 0 && (var27[var19 + 2][var20] & 19136995) == 0) {
					class177.field2290[var33] = var10 + 1;
					class177.field2287[var33] = var11 - 1;
					var33 = var33 + 1 & 4095;
				...
				if (var30 > 0 && var31 < 126 && class177.field2285[var30 - 1][var31 + 1] == 0
						&& (var27[var19 - 1][var20 + 1] & 19136830) == 0
						&& (var27[var19 - 1][var20 + 2] & 19136824) == 0 && (var27[var19][var20 + 2] & 19137016) == 0) {
					class177.field2290[var33] = var10 - 1;
					class177.field2287[var33] = var11 + 1;
					var33 = var33 + 1 & 4095;
				...
				if (var30 < 126 && var31 < 126 && class177.field2285[var30 + 1][var31 + 1] == 0
						&& (var27[var19 + 1][var20 + 2] & 19137016) == 0
						&& (var27[var19 + 2][var20 + 2] & 19136992) == 0
						&& (var27[var19 + 2][var20 + 1] & 19136995) == 0) {
					class177.field2290[var33] = var10 + 1;
					class177.field2287[var33] = var11 + 1;
					var33 = var33 + 1 & 4095;
			...
			for (var20 = var33 - var32; var20 <= var33 + var32; ++var20) {
				for (var21 = var17 - var32; var21 <= var17 + var32; ++var21) {
					...
					if (var22 >= 0 && var23 >= 0 && var22 < 128 && var23 < 128
							&& class177.field2286[var22][var23] < 100) {
						int var24 = 0;
						if (var20 < var33) {
							var24 = var33 - var20;
		...
		if (var0 == var11 && var30 == var1) {
			...
			for (var14 = var15 = class177.field2285[var11 - var9][var30 - var10]; var0 != var11
					|| var30 != var1; var14 = class177.field2285[var11 - var9][var30 - var10]) {
				if (var15 != var14) {
					var15 = var14;
	...
	static void method3299(GameEngine var0) {
		...
		if (class90.worldSelectShown) {
			if (MouseInput.mouseLastButton == 1
				...
				if (MouseInput.mouseLastPressedX >= var1 && MouseInput.mouseLastPressedX <= var1 + 14
						&& MouseInput.mouseLastPressedY >= 4 && MouseInput.mouseLastPressedY <= 18) {
					DynamicObject.method2024(0, 0);
				} else if (MouseInput.mouseLastPressedX >= var1 + 15 && MouseInput.mouseLastPressedX <= var1 + 80
						&& MouseInput.mouseLastPressedY >= 4 && MouseInput.mouseLastPressedY <= 18) {
					DynamicObject.method2024(0, 1);
				} else {
					var2 = class90.field1359 + 390;
					if (MouseInput.mouseLastPressedX >= var2 && MouseInput.mouseLastPressedX <= var2 + 14
							&& MouseInput.mouseLastPressedY >= 4 && MouseInput.mouseLastPressedY <= 18) {
						DynamicObject.method2024(1, 0);
					} else if (MouseInput.mouseLastPressedX >= var2 + 15 && MouseInput.mouseLastPressedX <= var2 + 80
							&& MouseInput.mouseLastPressedY >= 4 && MouseInput.mouseLastPressedY <= 18) {
						DynamicObject.method2024(1, 1);
					} else {
						var3 = class90.field1359 + 500;
						if (MouseInput.mouseLastPressedX >= var3 && MouseInput.mouseLastPressedX <= var3 + 14
								&& MouseInput.mouseLastPressedY >= 4 && MouseInput.mouseLastPressedY <= 18) {
							DynamicObject.method2024(2, 0);
						} else if (MouseInput.mouseLastPressedX >= var3 + 15
								&& MouseInput.mouseLastPressedX <= var3 + 80 && MouseInput.mouseLastPressedY >= 4
								&& MouseInput.mouseLastPressedY <= 18) {
							DynamicObject.method2024(2, 1);
						} else {
							var4 = class90.field1359 + 610;
							if (MouseInput.mouseLastPressedX >= var4 && MouseInput.mouseLastPressedX <= var4 + 14
									&& MouseInput.mouseLastPressedY >= 4 && MouseInput.mouseLastPressedY <= 18) {
								DynamicObject.method2024(3, 0);
							} else if (MouseInput.mouseLastPressedX >= var4 + 15
									&& MouseInput.mouseLastPressedX <= var4 + 80 && MouseInput.mouseLastPressedY >= 4
									&& MouseInput.mouseLastPressedY <= 18) {
								DynamicObject.method2024(3, 1);
							} else if (MouseInput.mouseLastPressedX >= class90.field1359 + 708
									&& MouseInput.mouseLastPressedY >= 4
									&& MouseInput.mouseLastPressedX <= class90.field1359 + 708 + 50
								...
								class33.logoSprite.method5825(class90.field1359 + 382 - class33.logoSprite.width / 2,
										18);
			...
			if ((MouseInput.mouseLastButton == 1
					|| !MapIconReference.middleMouseMovesCamera && MouseInput.mouseLastButton == 4)
					&& MouseInput.mouseLastPressedX >= class90.field1359 + 765 - 50
				...
				if (Client.gameState == 10 || Client.gameState == 11) {
					if (Client.languageId == 0) {
						if (MouseInput.mouseLastButton == 1
							...
							byte var6 = 100;
							byte var7 = 35;
							if (MouseInput.mouseLastPressedX >= var4 && MouseInput.mouseLastPressedX <= var6 + var4
									&& MouseInput.mouseLastPressedY >= var16
									&& MouseInput.mouseLastPressedY <= var7 + var16) {
					...
					if (class90.loginIndex == 0) {
						...
						var9 = 291;
						if (var4 == 1 && var29 >= var8 - 75 && var29 <= var8 + 75 && var23 >= var9 - 20
								&& var23 <= var9 + 20) {
							label995: {
								String var10 = VerticalAlignment.method4715("secure", true)
						...
						if (class90.loginIndex != 1) {
							...
							if (class90.loginIndex == 2) {
								...
								if (var4 == 1 && var23 >= var26 - 15 && var23 < var26) {
									BoundingBox3DDrawMode.method53("Please enter your username.",
								...
								var9 = 277;
								class90.field1374 = var29 >= var8 && var29 < var8 + NPC.field1318 && var23 >= var9
										&& var23 < var9 + class203.field2616;
								...
								var9 = 277;
								class90.field1384 = var29 >= var8 && var29 < var8 + NPC.field1318 && var23 >= var9
										&& var23 < var9 + class203.field2616;
								...
								while (true) {
									while (class160.method3183()) {
										...
										for (int var18 = 0; var18 < "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789!\"£$%^&*()-_=+[{]};:\'@#~,<.>/?\\| "
												.length(); ++var18) {
											if (class38.currentTypedKey == "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789!\"£$%^&*()-_=+[{]};:\'@#~,<.>/?\\| "
													.charAt(var18)) {
												var17 = true;
												break;
											}
										...
										if (Item.currentPressedKey == 13) {
											...
											if (Item.currentPressedKey == 84) {
												class90.username = class90.username.trim();
												if (class90.username.length() == 0) {
													BoundingBox3DDrawMode.method53("",
								...
								var27 = 276;
								if (var4 == 1 && var29 >= var25 - 75 && var29 <= var25 + 75 && var23 >= var27 - 20
										&& var23 <= var27 + 20) {
									SoundTaskDataProvider.method814(false);
								}
								...
								if (class90.loginIndex == 4) {
									...
									if (var4 == 1 && var29 >= class90.loginWindowX + 180 - 9
											&& var29 <= class90.loginWindowX + 180 + 130 && var23 >= 263
											&& var23 <= 296) {
										class90.field1385 = !class90.field1385;
									}

									if (var4 == 1 && var29 >= class90.loginWindowX + 180 - 34
											&& var29 <= class90.loginWindowX + 34 + 180 && var23 >= 351
											&& var23 <= 363) {
										label1008: {
											String var19 = VerticalAlignment.method4715("secure", true)
									...
									while (class160.method3183()) {
										...
										if (Item.currentPressedKey == 13) {
											...
											if (Item.currentPressedKey == 85 && class37.field501.length() > 0) {
												class37.field501 = class37.field501.substring(0,
														class37.field501.length() - 1);
											}
									...
									while (class160.method3183()) {
										...
										for (var30 = 0; var30 < "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789!\"£$%^&*()-_=+[{]};:\'@#~,<.>/?\\| "
												.length(); ++var30) {
											if (class38.currentTypedKey == "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789!\"£$%^&*()-_=+[{]};:\'@#~,<.>/?\\| "
													.charAt(var30)) {
												var28 = true;
