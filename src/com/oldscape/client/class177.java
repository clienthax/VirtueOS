				...
				if (Client.gameCycle >= var0.startMovementCycle) {
					if (var0.interacting > 0) {
						...
						if (var1 != null && var1.x >= 0 && var1.x < 13312 && var1.y >= 0 && var1.y < 13312) {
							var0.moveProjectile(var1.x, var1.y,
									class265.getTileHeight(var1.x, var1.y, var0.floor) - var0.endHeight,
									Client.gameCycle);
						}
					}
					...
					if (var0.interacting < 0) {
						...
						if (var3 != null && var3.x >= 0 && var3.x < 13312 && var3.y >= 0 && var3.y < 13312) {
							var0.moveProjectile(var3.x, var3.y,
									class265.getTileHeight(var3.x, var3.y, var0.floor) - var0.endHeight,
									Client.gameCycle);
						}
					}

					var0.update(Client.field930);
					class255.region.method2863(BoundingBox3DDrawMode.plane, (int) var0.x, (int) var0.y, (int) var0.z,
							60, var0, var0.rotationX, -1, false);
				}
			} else {
				var0.unlink();
			}
