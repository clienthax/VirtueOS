...
final class class18 implements Comparator {
	...
	static final void groundItemSpawned(int var0, int var1) {
		...
		if (var2 == null) {
			...
			if (var5 == null) {
				...
				class255.region.addItemPile(BoundingBox3DDrawMode.plane, var0, var1,
						class265.getTileHeight(var0 * 128 + 64, var1 * 128 + 64, BoundingBox3DDrawMode.plane), var5,
						var9, var11, var10);
			}
		}
	}
	...
	static final void method142(int var0) {
		...
		for (class80 var1 = (class80) class80.field1263.getFront(); var1 != null; var1 = (class80) class80.field1263
				.getNext()) {
