	...
	static void decodeMovement(PacketBuffer var0, int var1) {
		...
		if (var3 == 0) {
			if (var2) {
				...
				class93.Players_regions[var1] = (var4.field856 << 28) + (class138.baseX + var4.pathX[0] >> 13 << 14)
						+ (class23.baseY + var4.pathY[0] >> 13);
				if (var4.field1185 != -1) {
				...
				if (var0 == 6506) {
					...
					if (var0 == 6512) {
						...
						if (var0 == 6513) {
							...
							if (var13.method4916()) {
								class81.scriptStringStack[++KeyFocusListener.scriptStringStackSize - 1] = class234
										.getNpcDefinition(var11).method5125(var12, var13.field3549);
							} else {
								class81.intStack[++WorldComparator.intStackSize - 1] = class234.getNpcDefinition(var11)
										.method5124(var12, var13.field3545);
							}
							...
							var13 = CombatInfo2.method4877(var12);
							if (var13.method4916()) {
								class81.scriptStringStack[++KeyFocusListener.scriptStringStackSize - 1] = GameCanvas
										.getObjectDefinition(var11).method5008(var12, var13.field3549);
							} else {
								class81.intStack[++WorldComparator.intStackSize - 1] = GameCanvas
										.getObjectDefinition(var11).method5003(var12, var13.field3545);
							}
							...
							if (var13.method4916()) {
								class81.scriptStringStack[++KeyFocusListener.scriptStringStackSize - 1] = class47
										.getItemDefinition(var11).method5069(var12, var13.field3549);
							} else {
								class81.intStack[++WorldComparator.intStackSize - 1] = class47.getItemDefinition(var11)
										.method5068(var12, var13.field3545);
							}
							...
							var13 = CombatInfo2.method4877(var12);
							if (var13.method4916()) {
								class81.scriptStringStack[++KeyFocusListener.scriptStringStackSize - 1] = class228
										.method4119(var11).method4932(var12, var13.field3549);
							} else {
