...
public class class230 extends TaskDataNode {
	...
	public synchronized boolean method4136(Track1 var1, IndexDataBase var2, class110 var3, int var4) {
		...
		for (ByteArrayNode var7 = (ByteArrayNode) var1.field2770
				.first(); var7 != null; var7 = (ByteArrayNode) var1.field2770.next()) {
	...
	protected synchronized void vmethod4317(int[] var1, int var2, int var3) {
		if (this.field2706.method4269()) {
			...
			do {
				...
				int var7 = (int) ((var4 + (this.field2719 - this.field2710) - 1L) / var4);
	...
	protected synchronized void vmethod4319(int var1) {
		if (this.field2706.method4269()) {
			...
			do {
				...
				int var5 = (int) ((this.field2719 - this.field2710 + var2 - 1L) / var2);
	...
	void method4144(int var1, int var2, int var3) {
		...
		if ((this.field2716[var1] & 2) != 0) {
			for (class231 var4 = (class231) this.field2714.field2765
					.getTail(); var4 != null; var4 = (class231) this.field2714.field2765.getPrevious()) {
		...
		class233 var9 = (class233) this.field2720.get(this.field2701[var1]);
		if (var9 != null) {
			...
			if (var8 != null) {
				...
				if (this.field2709[var1] == 0) {
					var6.field2739 = class115.method2318(var8, this.method4158(var6), this.method4159(var6),
							this.method4226(var6));
				} else {
	...
	void method4153(int var1, int var2, int var3) {
		...
		if (var4 != null) {
			...
			if ((this.field2716[var1] & 2) != 0) {
				for (class231 var5 = (class231) this.field2714.field2765
						.getFront(); var5 != null; var5 = (class231) this.field2714.field2765.getNext()) {
	...
	void method4187(int var1) {
		for (class231 var2 = (class231) this.field2714.field2765
				.getFront(); var2 != null; var2 = (class231) this.field2714.field2765.getNext()) {
	...
	int method4158(class231 var1) {
		...
		if (var3.field2683 > 0 && (var3.field2682 > 0 || this.field2704[var1.field2734] > 0)) {
			...
			double var6 = Math.sin(0.01227184630308513D * (var1.field2738 & 511));
			var2 += (int) (var6 * var4);
		}

		var4 = (int) (var1.field2729.sampleRate * 256 * Math.pow(2.0D, 3.255208333333333E-4D * var2)
	...
	int method4226(class231 var1) {
		...
		return var2 < 8192 ? var2 * var1.field2728 + 32 >> 6
				: 16384 - ((128 - var1.field2728) * (16384 - var2) + 32 >> 6);
	}
	...
	boolean method4146(class231 var1, int[] var2, int var3, int var4) {
		...
		if (var1.field2740 < 0 || var1.field2739 != null && !var1.field2739.method2399()) {
			...
			double var8 = 5.086263020833333E-6D
					* ((var1.field2726 - 60 << 8) + (var1.field2721 * var1.field2730 >> 12));
			if (var6.field2676 > 0) {
				if (var6.field2681 > 0) {
			...
			if (var6.field2680 != null) {
				...
				while (var1.field2735 < var6.field2680.length - 2
						&& var1.field2731 > (var6.field2680[var1.field2735 + 2] & 255) << 8) {
					var1.field2735 += 2;
				}
			...
			if (var1.field2740 >= 0 && var6.field2684 != null && (this.field2716[var1.field2734] & 1) == 0
					&& (var1.field2725 < 0 || var1 != this.field2713[var1.field2734][var1.field2725])) {
				if (var6.field2677 > 0) {
				...
				while (var1.field2736 < var6.field2684.length - 2
						&& var1.field2740 > (var6.field2684[var1.field2736 + 2] & 255) << 8) {
					var1.field2736 += 2;
				}
