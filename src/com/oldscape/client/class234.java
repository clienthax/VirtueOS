...
public class class234 extends TaskDataNode {
		...
		if ((this.field2764.field2716[var1.field2734] & 4) != 0 && var1.field2740 < 0) {
			...
			while (true) {
				...
				if (this.field2764.field2709[var1.field2734] == 0) {
					var1.field2739 = class115.method2318(var1.field2729, var10.method2374(), var10.method2392(),
							var10.method2336());
				} else {
	...
	void method4315(class231 var1, int var2) {
		if ((this.field2764.field2716[var1.field2734] & 4) != 0 && var1.field2740 < 0) {
			...
			if (var4 <= var2) {
				if (this.field2764.field2709[var1.field2734] == 0) {
					var1.field2739 = class115.method2318(var1.field2729, var1.field2739.method2374(),
							var1.field2739.method2392(), var1.field2739.method2336());
				} else {
					var1.field2739 = class115.method2318(var1.field2729, var1.field2739.method2374(), 0,
							var1.field2739.method2336());
					this.field2764.method4145(var1, var1.field2722.field2759[var1.field2726] < 0);
				}
	...
	protected void vmethod4317(int[] var1, int var2, int var3) {
		...
		for (class231 var6 = (class231) this.field2765.getFront(); var6 != null; var6 = (class231) this.field2765
				.getNext()) {
	...
	protected void vmethod4319(int var1) {
		...
		for (class231 var3 = (class231) this.field2765.getFront(); var3 != null; var3 = (class231) this.field2765
				.getNext()) {
	...
	public static NPCComposition getNpcDefinition(int var0) {
		NPCComposition var1 = (NPCComposition) NPCComposition.npcs.get(var0);
		if (var1 != null) {
			return var1;
		} else {
			...
			var1.post();
			NPCComposition.npcs.put(var1, var0);
			return var1;
		}
	}
	...
	static void drawLoginScreen(Font var0, Font var1, Font var2, boolean var3) {
		...
		if (class90.worldSelectShown) {
			...
			if (Client.gameState == 0 || Client.gameState == 5) {
				byte var4 = 20;
				var0.drawTextCentered("RuneScape is loading - please wait...", class90.loginWindowX + 180, 245 - var4,
						16777215, -1);
				var5 = 253 - var4;
				...
				Rasterizer2D.Rasterizer2D_fillRectangle(class90.loginWindowX + 180 - 150, var5 + 2,
						class90.loadingBarPercentage * 3, 30, 9179409);
				Rasterizer2D.Rasterizer2D_fillRectangle(
						class90.loginWindowX + 180 - 150 + class90.loadingBarPercentage * 3, var5 + 2,
			...
			if (Client.gameState == 20) {
				IndexStoreActionHandler.field3398.method5825(
						class90.loginWindowX + 180 - IndexStoreActionHandler.field3398.width / 2,
						271 - IndexStoreActionHandler.field3398.height / 2);
				var18 = 201;
				...
				if (class90.loginIndex != 4) {
					...
					var19 += 15;
					var0.method5510("Password: " + Enum.method4958(class90.password), class90.loginWindowX + 180 - 108,
							var19, 16777215, 0);
					var19 += 15;
				}
			}
			...
			if (Client.gameState == 10 || Client.gameState == 11) {
				...
				if (class90.loginIndex == 0) {
					...
					var0.method5510(FontTypeFace.appendTags(var7)
							+ (class90.field1386 == 0 & Client.gameCycle % 40 < 20 ? class45.getColTags(16776960) + "|"
									: ""),
							WorldComparator.field279 - 70, var19, 16777215, 0);
					var19 += 15;
					var0.method5510("Password: " + Enum.method4958(class90.password)
							+ (class90.field1386 == 1 & Client.gameCycle % 40 < 20 ? class45.getColTags(16776960) + "|"
									: ""),
							WorldComparator.field279 - 108, var19, 16777215, 0);
					var19 += 15;
					var18 = 277;
					var8 = WorldComparator.field279 + -117;
					IndexedSprite var17 = VertexNormal.method2778(class90.Login_isUsernameRemembered,
							class90.field1374);
					...
					var18 = 357;
					var1.drawTextCentered("Forgotten your password? <col=ffffff>Click here.", WorldComparator.field279,
							var18, 16776960, 0);
				} else if (class90.loginIndex == 3) {
					var18 = 201;
					var0.drawTextCentered("Invalid username or password.", class90.loginWindowX + 180, var18, 16776960,
							0);
					var19 = var18 + 20;
					var1.drawTextCentered("For accounts created after 24th November 2010, please use your",
							class90.loginWindowX + 180, var19, 16776960, 0);
					var19 += 15;
					var1.drawTextCentered("email address to login. Otherwise please login with your username.",
							class90.loginWindowX + 180, var19, 16776960, 0);
					var19 += 15;
					...
					if (class90.loginIndex == 4) {
						...
						var19 += 15;
						var0.method5510(
								"PIN: " + Enum.method4958(class37.field501)
										+ (Client.gameCycle % 40 < 20 ? class45.getColTags(16776960) + "|" : ""),
								class90.loginWindowX + 180 - 108, var19, 16777215, 0);
						var19 -= 8;
						...
						var1.drawTextCentered("<u=ff>Can\'t Log In?</u>", class90.loginWindowX + 180, var9 + 36, 255,
								0);
						...
						var0.method5510(
								FontTypeFace.appendTags(var7)
										+ (Client.gameCycle % 40 < 20 ? class45.getColTags(16776960) + "|" : ""),
								class90.loginWindowX + 180 - 34, var19, 16777215, 0);
						var19 += 15;
						var8 = class90.loginWindowX + 180 - 80;
						var9 = 321;
						class90.field1388.method5825(var8 - 73, var9 - 20);
			...
			if (class90.field1367 > 0) {
				for (var5 = 0; var5 < 256; ++var5) {
					if (class90.field1367 > 768) {
						class21.field344[var5] = class37.method543(class21.field347[var5], ScriptState.field762[var5],
								1024 - class90.field1367);
					} else if (class90.field1367 > 256) {
						class21.field344[var5] = ScriptState.field762[var5];
					} else {
						class21.field344[var5] = class37.method543(ScriptState.field762[var5], class21.field347[var5],
								256 - class90.field1367);
					}
				}
			} else if (class90.field1358 > 0) {
				for (var5 = 0; var5 < 256; ++var5) {
					if (class90.field1358 > 768) {
						class21.field344[var5] = class37.method543(class21.field347[var5],
								GrandExchangeEvent.field298[var5], 1024 - class90.field1358);
					} else if (class90.field1358 > 256) {
						class21.field344[var5] = GrandExchangeEvent.field298[var5];
					} else {
						class21.field344[var5] = class37.method543(GrandExchangeEvent.field298[var5],
								class21.field347[var5], 256 - class90.field1358);
					}
				}
			} else {
				for (var5 = 0; var5 < 256; ++var5) {
			...
			for (var16 = 1; var16 < var18 - 1; ++var16) {
				...
				for (var10 = var22; var10 < 128; ++var10) {
					...
					if (var23 != 0) {
						...
						MapCacheArchiveNames.rasterProvider.pixels[var24++] = (var12 * (var23 & 65280)
								+ var13 * (var14 & 65280) & 16711680)
								+ ((var23 & 16711935) * var12 + (var14 & 16711935) * var13 & -16711936) >> 8;
					} else {
						++var24;
					}
				}
			...
			for (var16 = 1; var16 < var18 - 1; ++var16) {
				...
				for (var10 = 0; var10 < var22; ++var10) {
					...
					if (var23 != 0) {
						...
						var23 = class21.field344[var23];
						var14 = MapCacheArchiveNames.rasterProvider.pixels[var24];
						MapCacheArchiveNames.rasterProvider.pixels[var24++] = ((var14 & 16711935) * var13
								+ (var23 & 16711935) * var12 & -16711936)
								+ (var12 * (var23 & 65280) + var13 * (var14 & 65280) & 16711680) >> 8;
					} else {
						++var24;
					}
				}
			...
			if (Client.gameState > 5 && Client.languageId == 0) {
				if (class167.field2223 != null) {
					...
					var0.drawTextCentered("World" + " " + Client.world, var26 / 2 + var19, var25 / 2 + var20 - 2,
							16777215, 0);
					if (FaceNormal.listFetcher != null) {
						var1.drawTextCentered("Loading...", var26 / 2 + var19, var25 / 2 + var20 + 12, 16777215, 0);
					} else {
						var1.drawTextCentered("Click to switch", var26 / 2 + var19, var25 / 2 + var20 + 12, 16777215,
								0);
					}
				} else {
