...
public class class265 {
	...
	public final void method4689(int var1, int var2, SpritePixels var3, float var4) {
		...
		for (var10 = 0; var10 < this.field3436; ++var10) {
			...
			int var14 = (int) (var3.height - var4 * (var12 - var2)) - var5;
	...
	static final int getTileHeight(int var0, int var1, int var2) {
		...
		if (var3 >= 0 && var4 >= 0 && var3 <= 103 && var4 <= 103) {
			...
			int var6 = var0 & 127;
			int var7 = var1 & 127;
			int var8 = (128 - var6) * class62.tileHeights[var5][var3][var4]
					+ class62.tileHeights[var5][var3 + 1][var4] * var6 >> 7;
			int var9 = class62.tileHeights[var5][var3][var4 + 1] * (128 - var6)
					+ class62.tileHeights[var5][var3 + 1][var4 + 1] * var6 >> 7;
