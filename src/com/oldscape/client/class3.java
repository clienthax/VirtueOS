		...
		if (!Client.isDynamicRegion) {
			...
			for (var6 = (var3 - 6) / 8; var6 <= (var3 + 6) / 8; ++var6) {
				for (var7 = (var2 - 6) / 8; var7 <= (var2 + 6) / 8; ++var7) {
					var8 = var7 + (var6 << 8);
					if (!var16
							|| var7 != 49 && var7 != 149 && var7 != 147 && var6 != 50 && (var6 != 49 || var7 != 47)) {
					...
					for (var8 = 0; var8 < 13; ++var8) {
						...
						if (var9 != -1) {
							...
							if (var12 != -1) {
								...
								var13 = var12 >> 8 & 255;
								int var14 = var12 & 255;
								ItemContainer.landMapFileIds[var5] = MouseRecorder.indexMaps
										.getFile("m" + var13 + "_" + var14);
								FontName.landRegionFileIds[var5] = MouseRecorder.indexMaps
										.getFile("l" + var13 + "_" + var14);
								++var5;
							}
						}
					}
