...
public class class319 {
	...
	static final void method5651(Widget[] var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7) {
		for (int var8 = 0; var8 < var0.length; ++var8) {
			...
			if (var9 != null && (!var9.hasScript || var9.type == 0 || var9.hasListener
					|| GroundObject.getWidgetClickMask(var9) != 0 || var9 == Client.field937
					|| var9.contentType == 1338) && var9.parentId == var1) {
				if (var9.hasScript) {
				...
				if (!var9.hasScript || var12 < var14 && var13 < var15) {
					...
					if (var9.contentType == 1337) {
						...
						if (var9.contentType == 1400) {
							Preferences.renderOverview.method6009(MouseInput.mouseLastX, MouseInput.mouseLastY, var44,
									var43, var11, var9.width, var9.height);
						}
						...
						if (!Client.isMenuOpen && var44) {
							if (var9.contentType == 1400) {
								Preferences.renderOverview.method6077(var43, var11, var9.width, var9.height, var16,
										var17);
							} else {
								var19 = var16 - var43;
								...
								if (var9.field2932 == 2 && !Client.spellSelected) {
									...
									if (var21 != null) {
										TextureProvider.addMenuEntry(var21, class45.getColTags(65280) + var9.spellName,
												25, 0, -1, var9.id);
									}
								}
								...
								if (var9.type == 2) {
									...
									for (var38 = 0; var38 < var9.height; ++var38) {
										for (var23 = 0; var23 < var9.width; ++var23) {
											...
											if (var19 >= var24 && var20 >= var25 && var19 < var24 + 32
													&& var20 < var25 + 32) {
												Client.field980 = var37;
												class36.field492 = var9;
												if (var9.itemIds[var37] > 0) {
													label1333: {
														ItemComposition var26 = class47
																.getItemDefinition(var9.itemIds[var37] - 1);
														boolean var27;
														int var28;
														if (Client.itemSelectionState == 1) {
															...
															var27 = (var28 >> 30 & 1) != 0;
															if (var27) {
																if (var9.id != BoundingBox.field251
																		|| var37 != UrlRequester.selectedItemIndex) {
																	TextureProvider.addMenuEntry("Use",
																			Client.lastSelectedItemName + " " + "->"
																					+ " " + class45.getColTags(16748608)
																					+ var26.name,
																			31, var26.id, var37, var9.id);
																}
																break label1333;
															}
														}
														...
														if (var29) {
															for (int var31 = 4; var31 >= 3; --var31) {
																if (var28 != var31) {
																	class110.method2272(var9, var26, var37, var31,
																			false);
																}
															}
														}
														...
														if (class304
																.method5423(GroundObject.getWidgetClickMask(var9))) {
															TextureProvider.addMenuEntry("Use",
																	class45.getColTags(16748608) + var26.name, 38,
																	var26.id, var37, var9.id);
														}
														...
														if (var50) {
															for (var33 = 2; var33 >= 0; --var33) {
																if (var33 != var28) {
																	class110.method2272(var9, var26, var37, var33,
																			false);
																}
															}
														...
														if (var40 != null) {
															for (var33 = 4; var33 >= 0; --var33) {
																if (var40[var33] != null) {
																	...
																	TextureProvider.addMenuEntry(var40[var33],
																			class45.getColTags(16748608) + var26.name,
																			var34, var26.id, var37, var9.id);
																}
															}
														}

														TextureProvider.addMenuEntry("Examine",
																class45.getColTags(16748608) + var26.name, 1005,
																var26.id, var37, var9.id);
													}
												}
											}
								...
								if (var9.hasScript) {
									if (Client.spellSelected) {
										if (GroundObject.method2669(GroundObject.getWidgetClickMask(var9))
												&& (class110.field1607 & 32) == 32) {
											TextureProvider.addMenuEntry(Client.field1092,
													Client.field1028 + " " + "->" + " " + var9.opBase, 58, 0,
													var9.index, var9.id);
										}
									} else {
										for (var37 = 9; var37 >= 5; --var37) {
											String var22;
											if (!DynamicObject.method2021(GroundObject.getWidgetClickMask(var9), var37)
													&& var9.onOpListener == null) {
												var22 = null;
											} else if (var9.actions != null && var9.actions.length > var37
													&& var9.actions[var37] != null
													&& var9.actions[var37].trim().length() != 0) {
											...
											if (var22 != null) {
												TextureProvider.addMenuEntry(var22, var9.opBase, 1007, var37 + 1,
														var9.index, var9.id);
											}
										}
										...
										if (var21 != null) {
											TextureProvider.addMenuEntry(var21, var9.opBase, 25, 0, var9.index,
													var9.id);
										}

										for (var23 = 4; var23 >= 0; --var23) {
											String var41;
											if (!DynamicObject.method2021(GroundObject.getWidgetClickMask(var9), var23)
													&& var9.onOpListener == null) {
												var41 = null;
											} else if (var9.actions != null && var9.actions.length > var23
													&& var9.actions[var23] != null
													&& var9.actions[var23].trim().length() != 0) {
											...
											if (var41 != null) {
												TextureProvider.addMenuEntry(var41, var9.opBase, 57, var23 + 1,
														var9.index, var9.id);
											}
										}
						...
						if (var9.type == 0) {
							...
							method5651(var0, var9.id, var12, var13, var14, var15, var43 - var9.scrollX,
									var11 - var9.scrollY);
							if (var9.children != null) {
								method5651(var9.children, var9.id, var12, var13, var14, var15, var43 - var9.scrollX,
										var11 - var9.scrollY);
							}

							WidgetNode var35 = (WidgetNode) Client.componentTable.get(var9.id);
							if (var35 != null) {
								if (var35.owner == 0 && MouseInput.mouseLastX >= var12 && MouseInput.mouseLastY >= var13
										&& MouseInput.mouseLastX < var14 && MouseInput.mouseLastY < var15
										&& !Client.isMenuOpen) {
									for (ScriptEvent var36 = (ScriptEvent) Client.field1066
											.getFront(); var36 != null; var36 = (ScriptEvent) Client.field1066
													.getNext()) {
										if (var36.boolean1) {
											var36.unlink();
						...
						if (var9.hasScript) {
							...
							if (!var9.noClickThrough) {
								if (var9.noScrollThrough && MouseInput.mouseLastX >= var12
										&& MouseInput.mouseLastY >= var13 && MouseInput.mouseLastX < var14
										&& MouseInput.mouseLastY < var15) {
									for (var51 = (ScriptEvent) Client.field1066
											.getFront(); var51 != null; var51 = (ScriptEvent) Client.field1066
													.getNext()) {
							...
							} else if (MouseInput.mouseLastX >= var12 && MouseInput.mouseLastY >= var13
									&& MouseInput.mouseLastX < var14 && MouseInput.mouseLastY < var15) {
								for (var51 = (ScriptEvent) Client.field1066
										.getFront(); var51 != null; var51 = (ScriptEvent) Client.field1066.getNext()) {
									if (var51.boolean1) {
										var51.unlink();
							...
							if (MouseInput.mouseLastX >= var12 && MouseInput.mouseLastY >= var13
									&& MouseInput.mouseLastX < var14 && MouseInput.mouseLastY < var15) {
								var44 = true;
							} else {
								var44 = false;
							...
							if ((MouseInput.mouseLastButton == 1
									...
									&& MouseInput.mouseLastPressedX >= var12 && MouseInput.mouseLastPressedY >= var13
									&& MouseInput.mouseLastPressedX < var14 && MouseInput.mouseLastPressedY < var15) {
								var45 = true;
							}

							if (var45) {
								class27.method239(var9, MouseInput.mouseLastPressedX - var43,
										MouseInput.mouseLastPressedY - var11);
							}
							...
							if (var9.hasListener) {
								...
								if (var9.onVarTransmitListener != null && Client.field1054 > var9.field2950) {
									if (var9.varTransmitTriggers != null && Client.field1054 - var9.field2950 <= 32) {
										label999: for (var37 = var9.field2950; var37 < Client.field1054; ++var37) {
								...
								if (var9.onInvTransmitListener != null && Client.field1056 > var9.field2951) {
									if (var9.invTransmitTriggers != null && Client.field1056 - var9.field2951 <= 32) {
										label975: for (var37 = var9.field2951; var37 < Client.field1056; ++var37) {
								...
								if (var9.onStatTransmitListener != null && Client.field1052 > var9.field2856) {
									if (var9.statTransmitTriggers != null && Client.field1052 - var9.field2856 <= 32) {
										label951: for (var37 = var9.field2856; var37 < Client.field1052; ++var37) {
						...
						if (!var9.hasScript && Client.draggedWidget == null && UrlRequest.field2137 == null
								&& !Client.isMenuOpen) {
							if ((var9.field2937 >= 0 || var9.field2849 != 0) && MouseInput.mouseLastX >= var12
									&& MouseInput.mouseLastY >= var13 && MouseInput.mouseLastX < var14
									&& MouseInput.mouseLastY < var15) {
								if (var9.field2937 >= 0) {
							...
							if (var9.type == 8 && MouseInput.mouseLastX >= var12 && MouseInput.mouseLastY >= var13
									&& MouseInput.mouseLastX < var14 && MouseInput.mouseLastY < var15) {
								class7.field234 = var9;
							}

							if (var9.scrollHeight > var9.height) {
								GrandExchangeEvent.method90(var9, var43 + var9.width, var11, var9.height,
										var9.scrollHeight, MouseInput.mouseLastX, MouseInput.mouseLastY);
							}
						}
					}
				}
