...
public class class333 {
	...
	int method5996() {
		...
		if (this.field4004 == 50) {
			if (this.field4003.method4599(MapCacheArchiveNames.COMPOSITE_TEXTURE.name, this.field4000)
					&& !this.field4003.tryLoadRecordByNames(MapCacheArchiveNames.COMPOSITE_TEXTURE.name,
							this.field4000)) {
				return 50;
			}
