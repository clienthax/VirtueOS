	...
	static int method539(int var0, Script var1, boolean var2) {
		...
		if (var0 < 1000) {
			...
			if (var0 == 2700) {
				...
				var4 = class81.intStack[--WorldComparator.intStackSize];
				WidgetNode var42 = (WidgetNode) Client.componentTable.get(var4);
				if (var42 != null) {
					class81.intStack[++WorldComparator.intStackSize - 1] = 1;
				} else {
					class81.intStack[++WorldComparator.intStackSize - 1] = 0;
			...
			if (var0 == 2800) {
				class81.intStack[++WorldComparator.intStackSize - 1] = class250
						.method4502(GroundObject.getWidgetClickMask(var51));
				var3 = 1;
			} else if (var0 == 2801) {
			...
			if (var0 < 3400) {
				...
				if (var0 == 3400) {
					...
					for (var49 = 0; var49 < var20.size; ++var49) {
						if (var5 == var20.keys[var49]) {
							class81.scriptStringStack[++KeyFocusListener.scriptStringStackSize
									- 1] = var20.stringVals[var49];
							var20 = null;
							break;
						}
					}
				...
				if (var0 < 3700) {
					if (var0 == 3600) {
						if (WorldMapRectangle.friendManager.field1253 == 0) {
							...
							class81.intStack[++WorldComparator.intStackSize
									- 1] = WorldMapRectangle.friendManager.field1256.getCount();
						}

						var3 = 1;
					} else if (var0 == 3601) {
						var4 = class81.intStack[--WorldComparator.intStackSize];
						if (WorldMapRectangle.friendManager.method1732() && var4 >= 0
								&& var4 < WorldMapRectangle.friendManager.field1256.getCount()) {
							Friend var34 = (Friend) WorldMapRectangle.friendManager.field1256.get(var4);
							class81.scriptStringStack[++KeyFocusListener.scriptStringStackSize - 1] = var34
									.method5267();
							class81.scriptStringStack[++KeyFocusListener.scriptStringStackSize - 1] = var34
									.method5263();
						} else {
						...
						if (WorldMapRectangle.friendManager.method1732() && var4 >= 0
								&& var4 < WorldMapRectangle.friendManager.field1256.getCount()) {
							class81.intStack[++WorldComparator.intStackSize
									- 1] = ((ChatPlayer) WorldMapRectangle.friendManager.field1256.get(var4)).world;
						} else {
							class81.intStack[++WorldComparator.intStackSize - 1] = 0;
						}
						...
						if (WorldMapRectangle.friendManager.method1732() && var4 >= 0
								&& var4 < WorldMapRectangle.friendManager.field1256.getCount()) {
							class81.intStack[++WorldComparator.intStackSize
									- 1] = ((ChatPlayer) WorldMapRectangle.friendManager.field1256.get(var4)).rank;
						} else {
							class81.intStack[++WorldComparator.intStackSize - 1] = 0;
						}
						...
						class81.intStack[++WorldComparator.intStackSize - 1] = WorldMapRectangle.friendManager
								.isFriended(new Name(var31, GZipDecompressor.loginType), false) ? 1 : 0;
						var3 = 1;
					} else if (var0 == 3611) {
						if (GameEngine.clanMemberManager != null) {
							class81.scriptStringStack[++KeyFocusListener.scriptStringStackSize
									- 1] = GameEngine.clanMemberManager.field3870;
						} else {
							class81.scriptStringStack[++KeyFocusListener.scriptStringStackSize - 1] = "";
						}
						...
						if (GameEngine.clanMemberManager != null) {
							class81.intStack[++WorldComparator.intStackSize - 1] = GameEngine.clanMemberManager
									.getCount();
						} else {
							class81.intStack[++WorldComparator.intStackSize - 1] = 0;
						}
						...
						if (GameEngine.clanMemberManager != null && var4 < GameEngine.clanMemberManager.getCount()) {
							class81.scriptStringStack[++KeyFocusListener.scriptStringStackSize
									- 1] = GameEngine.clanMemberManager.get(var4).method5271().getName();
						} else {
							class81.scriptStringStack[++KeyFocusListener.scriptStringStackSize - 1] = "";
						}
						...
						if (GameEngine.clanMemberManager != null && var4 < GameEngine.clanMemberManager.getCount()) {
							class81.intStack[++WorldComparator.intStackSize
									- 1] = ((ChatPlayer) GameEngine.clanMemberManager.get(var4)).method5390();
						} else {
							class81.intStack[++WorldComparator.intStackSize - 1] = 0;
						}
						...
						if (GameEngine.clanMemberManager != null && var4 < GameEngine.clanMemberManager.getCount()) {
							class81.intStack[++WorldComparator.intStackSize
									- 1] = ((ChatPlayer) GameEngine.clanMemberManager.get(var4)).rank;
						} else {
							class81.intStack[++WorldComparator.intStackSize - 1] = 0;
						}
						...
						class81.intStack[++WorldComparator.intStackSize - 1] = GameEngine.clanMemberManager != null
								? GameEngine.clanMemberManager.field3865
								: 0;
						var3 = 1;
					} else if (var0 == 3617) {
						var31 = class81.scriptStringStack[--KeyFocusListener.scriptStringStackSize];
						...
						class81.intStack[++WorldComparator.intStackSize - 1] = GameEngine.clanMemberManager != null
								? GameEngine.clanMemberManager.field3871
								: 0;
						var3 = 1;
					} else if (var0 == 3619) {
						var31 = class81.scriptStringStack[--KeyFocusListener.scriptStringStackSize];
						if (!var31.equals("")) {
							PacketNode var37 = WorldMapRectangle.method280(ClientPacket.field2398,
									Client.field957.field1484);
						...
						if (!WorldMapRectangle.friendManager.method1732()) {
							...
							class81.intStack[++WorldComparator.intStackSize
									- 1] = WorldMapRectangle.friendManager.field1254.getCount();
						}
						...
						var4 = class81.intStack[--WorldComparator.intStackSize];
						if (WorldMapRectangle.friendManager.method1732() && var4 >= 0
								&& var4 < WorldMapRectangle.friendManager.field1254.getCount()) {
							Ignore var39 = (Ignore) WorldMapRectangle.friendManager.field1254.get(var4);
							class81.scriptStringStack[++KeyFocusListener.scriptStringStackSize - 1] = var39
									.method5267();
							class81.scriptStringStack[++KeyFocusListener.scriptStringStackSize - 1] = var39
									.method5263();
						} else {
						...
						var31 = FontName.method5489(var31);
						class81.intStack[++WorldComparator.intStackSize - 1] = WorldMapRectangle.friendManager
								.isIgnored(new Name(var31, GZipDecompressor.loginType)) ? 1 : 0;
						var3 = 1;
					} else if (var0 == 3624) {
						var4 = class81.intStack[--WorldComparator.intStackSize];
						if (GameEngine.clanMemberManager != null && var4 < GameEngine.clanMemberManager.getCount()
								&& GameEngine.clanMemberManager.get(var4).method5271()
										.equals(SoundTaskDataProvider.localPlayer.name)) {
							class81.intStack[++WorldComparator.intStackSize - 1] = 1;
						} else {
							class81.intStack[++WorldComparator.intStackSize - 1] = 0;
						}
						...
						if (GameEngine.clanMemberManager != null && GameEngine.clanMemberManager.field3869 != null) {
							class81.scriptStringStack[++KeyFocusListener.scriptStringStackSize
									- 1] = GameEngine.clanMemberManager.field3869;
						} else {
							class81.scriptStringStack[++KeyFocusListener.scriptStringStackSize - 1] = "";
						}
						...
						var4 = class81.intStack[--WorldComparator.intStackSize];
						if (GameEngine.clanMemberManager != null && var4 < GameEngine.clanMemberManager.getCount()
								&& ((ClanMember) GameEngine.clanMemberManager.get(var4)).method5242()) {
							class81.intStack[++WorldComparator.intStackSize - 1] = 1;
						} else {
							class81.intStack[++WorldComparator.intStackSize - 1] = 0;
						}
						...
						var4 = class81.intStack[--WorldComparator.intStackSize];
						if (GameEngine.clanMemberManager != null && var4 < GameEngine.clanMemberManager.getCount()
								&& ((ClanMember) GameEngine.clanMemberManager.get(var4)).method5260()) {
							class81.intStack[++WorldComparator.intStackSize - 1] = 1;
						} else {
							class81.intStack[++WorldComparator.intStackSize - 1] = 0;
						}
					...
					if (var0 < 5400) {
						...
						return var0 < 6600 ? class22.method173(var0, var1, var2)
								: (var0 < 6700 ? class1.method0(var0, var1, var2) : 2);
					}
				} else {
					if (var0 == 5000) {
						...
						PacketNode var7 = WorldMapRectangle.method280(ClientPacket.field2459,
								Client.field957.field1484);
						...
						if (var36 != null) {
							...
							class81.scriptStringStack[++KeyFocusListener.scriptStringStackSize - 1] = var36.name != null
									? var36.name
									: "";
							class81.scriptStringStack[++KeyFocusListener.scriptStringStackSize
									- 1] = var36.sender != null ? var36.sender : "";
							class81.scriptStringStack[++KeyFocusListener.scriptStringStackSize
									- 1] = var36.value != null ? var36.value : "";
							class81.intStack[++WorldComparator.intStackSize - 1] = var36.method1149() ? 1
									: (var36.method1152() ? 2 : 0);
						} else {
							class81.intStack[++WorldComparator.intStackSize - 1] = -1;
							class81.intStack[++WorldComparator.intStackSize - 1] = 0;
							class81.scriptStringStack[++KeyFocusListener.scriptStringStackSize - 1] = "";
						...
						var4 = class81.intStack[--WorldComparator.intStackSize];
						MessageNode var13 = (MessageNode) class95.messages.get(var4);
						if (var13 != null) {
							class81.intStack[++WorldComparator.intStackSize - 1] = var13.type;
							class81.intStack[++WorldComparator.intStackSize - 1] = var13.tick;
							class81.scriptStringStack[++KeyFocusListener.scriptStringStackSize - 1] = var13.name != null
									? var13.name
									: "";
							class81.scriptStringStack[++KeyFocusListener.scriptStringStackSize
									- 1] = var13.sender != null ? var13.sender : "";
							class81.scriptStringStack[++KeyFocusListener.scriptStringStackSize
									- 1] = var13.value != null ? var13.value : "";
							class81.intStack[++WorldComparator.intStackSize - 1] = var13.method1149() ? 1
									: (var13.method1152() ? 2 : 0);
						} else {
							class81.intStack[++WorldComparator.intStackSize - 1] = -1;
							class81.intStack[++WorldComparator.intStackSize - 1] = 0;
							class81.scriptStringStack[++KeyFocusListener.scriptStringStackSize - 1] = "";
						...
						PacketNode var17 = WorldMapRectangle.method280(ClientPacket.field2413,
								Client.field957.field1484);
						...
						if (SoundTaskDataProvider.localPlayer != null
								&& SoundTaskDataProvider.localPlayer.name != null) {
						...
						if (var0 == 5018) {
							...
							Client.field1085 = class81.scriptStringStack[--KeyFocusListener.scriptStringStackSize]
									.toLowerCase().trim();
							var3 = 1;
						} else if (var0 == 5022) {
