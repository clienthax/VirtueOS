...
public class class37 {
	...
	static final int method543(int var0, int var1, int var2) {
		int var3 = 256 - var2;
		return ((var0 & 65280) * var3 + (var1 & 65280) * var2 & 16711680)
	...
	static void method542(Font var0, Font var1) {
		...
		if (class5.field40 != null) {
			...
			for (var14 = 0; var14 < World.worldCount; ++var14) {
				...
				if (MouseInput.mouseLastX >= var11 && MouseInput.mouseLastY >= var10
						&& MouseInput.mouseLastX < var21 + var11 && MouseInput.mouseLastY < var10 + var22 && var16) {
				...
				if (BoundingBox3DDrawMode.slFlagSprites != null) {
					BoundingBox3DDrawMode.slFlagSprites[(var15.method1683() ? 8 : 0) + var15.location]
							.method5825(var11 + 29, var10);
				}
			...
			if (var13) {
				...
				Rasterizer2D.Rasterizer2D_fillRectangle(MouseInput.mouseLastX - var14 / 2,
						MouseInput.mouseLastY + 20 + 5, var14, var20, 16777120);
				Rasterizer2D.drawRectangle(MouseInput.mouseLastX - var14 / 2, MouseInput.mouseLastY + 20 + 5, var14,
						var20, 0);
				var1.drawTextCentered(World.worldList[class90.field1390].activity, MouseInput.mouseLastX,
						MouseInput.mouseLastY + var1.verticalSpace + 20 + 5 + 4, 0, -1);
			}
		}
