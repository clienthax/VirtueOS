...
public class class38 {
	...
	static final void method546(int var0, int var1) {
		if (Client.hintArrowTargetType == 2) {
			SoundTask.worldToScreen((Client.hintArrowX - class138.baseX << 7) + Client.hintArrowOffsetX,
					(Client.hintArrowY - class23.baseY << 7) + Client.hintArrowOffsetY, Client.hintArrowOffsetZ * 2);
	...
	static final void drawDot(int var0, int var1, int var2, int var3, SpritePixels var4, class236 var5) {
		if (var4 != null) {
			...
			if (var7 <= 6400) {
				...
				if (var7 > 2500) {
					var4.method5874(var10 + var5.field2773 / 2 - var4.maxWidth / 2,
							var5.field2772 / 2 - var11 - var4.maxHeight / 2, var0, var1, var5.field2773, var5.field2772,
							var5.field2774, var5.field2771);
				} else {
					var4.drawAt(var0 + var10 + var5.field2773 / 2 - var4.maxWidth / 2,
							var5.field2772 / 2 + var1 - var11 - var4.maxHeight / 2);
				}
