...
public class class44 {
	...
	static final void addObject(int var0, int var1, int var2, int var3, int var4, int var5, Region var6,
			CollisionData var7) {
		if (!Client.lowMemory || (class62.tileSettings[0][var1][var2] & 2) != 0
				|| (class62.tileSettings[var0][var1][var2] & 16) == 0) {
			...
			if (var5 == 22) {
				...
				if (var5 >= 12) {
					...
					var6.addBoundary(var0, var1, var2, var16, (Renderable) var30, (Renderable) null,
							class62.field749[var4], 0, var19, var20);
					if (var4 == 0) {
						if (var8.clipped) {
					...
					var6.addBoundary(var0, var1, var2, var16, (Renderable) var30, (Renderable) null,
							class62.field746[var4], 0, var19, var20);
					if (var8.clipped) {
						if (var4 == 0) {
							class297.field3831[var0][var1][var2 + 1] = 50;
						} else if (var4 == 1) {
					...
					if (var5 == 2) {
						...
						var6.addBoundary(var0, var1, var2, var16, (Renderable) var27, (Renderable) var28,
								class62.field749[var4], class62.field749[var26], var19, var20);
						if (var8.modelClipped) {
							if (var4 == 0) {
								GZipDecompressor.field2520[var0][var1][var2] |= 585;
						...
						var6.addBoundaryDecoration(var0, var1, var2, var16, (Renderable) var30, (Renderable) null,
								class62.field749[var4], 0, 0, 0, var19, var20);
					} else if (var5 == 5) {
						var26 = 16;
						...
						var6.addBoundaryDecoration(var0, var1, var2, var16, (Renderable) var28, (Renderable) null,
								class62.field749[var4], 0, var26 * class62.field738[var4],
								var26 * class62.field740[var4], var19, var20);
					} else if (var5 == 6) {
						var26 = 8;
						var22 = var6.getWallObjectHash(var0, var1, var2);
						if (var22 != 0) {
						...
						var6.addBoundaryDecoration(var0, var1, var2, var16, (Renderable) var28, (Renderable) null, 256,
								var4, var26 * class62.field752[var4], var26 * class62.field750[var4], var19, var20);
					} else if (var5 == 7) {
						var22 = var4 + 2 & 3;
						if (var8.animationId == -1 && var8.impostorIds == null) {
				...
				if (var30 != null && var6.method2862(var0, var1, var2, var16, var9, var10, (Renderable) var30,
		...
		for (var2 = 0; var2 < 20; ++var2) {
			for (var3 = 1; var3 < var1 - 1; ++var3) {
				for (var4 = 1; var4 < 127; ++var4) {
					var5 = var4 + (var3 << 7);
					GrandExchangeEvents.field287[var5] = (MouseRecorder.field819[var5 - 128]
							+ MouseRecorder.field819[var5 + 1] + MouseRecorder.field819[var5 + 128]
							+ MouseRecorder.field819[var5 - 1]) / 4;
				}
			}
