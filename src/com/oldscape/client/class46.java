...
public class class46 extends class28 {
	...
	void method677(Buffer var1, Buffer var2) {
		...
		if (var3 != class37.field498.field500) {
			...
			if (var3 != class36.field493.field496) {
				...
				if (var4 == super.field420 && var5 == super.field409 && var6 == this.field576
						&& var7 == this.field577) {
	...
	boolean method678(int var1, int var2) {
		return var1 < this.field576 * 8 ? false
				: (var2 < this.field577 * 8 ? false
						: (var1 >= this.field576 * 8 + 8 ? false : var2 < this.field577 * 8 + 8));
	}
	...
	public boolean equals(Object var1) {
		if (!(var1 instanceof class46)) {
			...
			return var2.field420 == super.field420 && super.field409 == var2.field409
					? this.field576 == var2.field576 && this.field577 == var2.field577
					: false;
		}
	}
					...
					do {
						do {
							label281: do {
								...
								if (var18 > 0 && class177.field2285[var18 - 1][var19] == 0
								...
								if (var18 < 128 - var2 && class177.field2285[var18 + 1][var19] == 0
								...
								if (var19 > 0 && class177.field2285[var18][var19 - 1] == 0
								...
								if (var19 < 128 - var2 && class177.field2285[var18][var19 + 1] == 0
								...
								if (var18 > 0 && var19 > 0 && class177.field2285[var18 - 1][var19 - 1] == 0
								...
								if (var18 < 128 - var2 && var19 > 0 && class177.field2285[var18 + 1][var19 - 1] == 0
								...
								if (var18 > 0 && var19 < 128 - var2 && class177.field2285[var18 - 1][var19 + 1] == 0
