...
public class class47 {
	...
	public static ItemComposition getItemDefinition(int var0) {
		ItemComposition var1 = (ItemComposition) ItemComposition.items.get(var0);
		if (var1 != null) {
			return var1;
		} else {
			...
			ItemComposition.items.put(var1, var0);
			return var1;
		}
	}
		...
		if (var0 == 4100) {
			...
			if (var0 == 4101) {
				...
				class81.scriptStringStack[++KeyFocusListener.scriptStringStackSize - 1] = var3
						+ ScriptVarType.method19(var4, true);
				return 1;
			} else if (var0 == 4103) {
				var3 = class81.scriptStringStack[--KeyFocusListener.scriptStringStackSize];
				...
				if (var0 == 4104) {
					...
					long var22 = 86400000L * (var21 + 11745L);
					...
					class81.scriptStringStack[++KeyFocusListener.scriptStringStackSize - 1] = var28 + "-"
							+ class81.field1291[var29] + "-" + var8;
					return 1;
				} else if (var0 == 4105) {
					KeyFocusListener.scriptStringStackSize -= 2;
					var3 = class81.scriptStringStack[KeyFocusListener.scriptStringStackSize];
					var37 = class81.scriptStringStack[KeyFocusListener.scriptStringStackSize + 1];
					if (SoundTaskDataProvider.localPlayer.composition != null
							&& SoundTaskDataProvider.localPlayer.composition.isFemale) {
					...
					if (var0 == 4107) {
						...
						label318: while (true) {
							if (var11 - var13 >= var9 && var12 - var14 >= var10) {
								...
								for (var33 = 0; var33 < var32; ++var33) {
									...
									if (var34 != var36
											&& Character.toUpperCase(var34) != Character.toUpperCase(var36)) {
										var34 = Character.toLowerCase(var34);
										var36 = Character.toLowerCase(var36);
										if (var36 != var34) {
											var5 = GrandExchangeEvent.method83(var34, var8)
													- GrandExchangeEvent.method83(var36, var8);
											break label318;
										}
									}
								}
								...
								if (var33 != 0) {
									...
									for (int var35 = 0; var35 < var32; ++var35) {
										...
										if (var19 != var36) {
											var5 = GrandExchangeEvent.method83(var36, var8)
													- GrandExchangeEvent.method83(var19, var8);
											break label318;
										}
									}
							...
							if (var15 != var16 && Character.toUpperCase(var15) != Character.toUpperCase(var16)) {
								...
								if (var15 != var16) {
									var5 = GrandExchangeEvent.method83(var15, var8)
											- GrandExchangeEvent.method83(var16, var8);
									break;
								}
							}
						}
						...
						if (var0 == 4108) {
							...
							var3 = class81.scriptStringStack[--KeyFocusListener.scriptStringStackSize];
							class81.scriptStringStack[++KeyFocusListener.scriptStringStackSize - 1] = FontTypeFace
									.appendTags(var3);
							return 1;
						} else if (var0 == 4112) {
							var3 = class81.scriptStringStack[--KeyFocusListener.scriptStringStackSize];
							...
							if (var0 == 4113) {
								...
								var5 = ++WorldComparator.intStackSize - 1;
								var7 = (char) var21;
								var6 = var7 >= '0' && var7 <= '9' || var7 >= 'A' && var7 <= 'Z'
										|| var7 >= 'a' && var7 <= 'z';
								var20[var5] = var6 ? 1 : 0;
								return 1;
							} else if (var0 != 4115) {
								if (var0 == 4116) {
									var21 = class81.intStack[--WorldComparator.intStackSize];
									class81.intStack[++WorldComparator.intStackSize - 1] = class64
											.method1111((char) var21) ? 1 : 0;
									return 1;
								} else if (var0 == 4117) {
									var3 = class81.scriptStringStack[--KeyFocusListener.scriptStringStackSize];
									if (var3 != null) {
									...
									class81.scriptStringStack[++KeyFocusListener.scriptStringStackSize - 1] = var38
											.toString();
									return 1;
								} else if (var0 == 4120) {
									var3 = class81.scriptStringStack[--KeyFocusListener.scriptStringStackSize];
		...
		for (int var2 = 0; var2 < var0.length; ++var2) {
			...
			if (var3 != null && var3.parentId == var1) {
				...
				if (var3.type == 0) {
					...
					WidgetNode var7 = (WidgetNode) Client.componentTable.get(var3.id);
					if (var7 != null) {
						var5 = var7.id;
				...
				if (var3.type == 6) {
					if (var3.field2869 != -1 || var3.field2855 != -1) {
						...
						if (var5 != -1) {
							...
							for (var3.field2945 += Client.field930; var3.field2945 > var6.frameLengths[var3.field2935]; FontName
									.method5490(var3)) {
