...
public class class57 {
				...
				if (var4 <= var6) {
					...
					for (int var14 = var2; var14 < var3; ++var14) {
						...
						if (Character.isISOControl(var7)) {
							...
							boolean var9 = var7 >= '0' && var7 <= '9' || var7 >= 'A' && var7 <= 'Z'
									|| var7 >= 'a' && var7 <= 'z';
							if (var9) {
								var8 = true;
							} else {
	...
	static Font method868(byte[] var0) {
		if (var0 == null) {
			...
			Font var1 = new Font(var0, class332.indexedSpriteOffsetXs, FileSystem.indexedSpriteOffsetYs,
					WorldMapDecoration.indexSpriteWidths, class332.indexedSpriteHeights, class332.indexedSpritePalette,
					class332.spritePixels);
			class36.method541();
			return var1;
		}
	}
	...
	static final void method869(class183 var0) {
		...
		if (class183.field2492 == var0) {
			...
			if (var3 >= 0 && var37 >= 0 && var3 < 103 && var37 < 103) {
				if (var8 == 0) {
					...
					if (var10 != null) {
						...
						if (var6 == 2) {
							var10.renderable1 = new DynamicObject(var43, 2, var7 + 4, BoundingBox3DDrawMode.plane, var3,
									var37, var39, false, var10.renderable1);
							var10.renderable2 = new DynamicObject(var43, 2, var7 + 1 & 3, BoundingBox3DDrawMode.plane,
									var3, var37, var39, false, var10.renderable2);
						} else {
							var10.renderable1 = new DynamicObject(var43, var6, var7, BoundingBox3DDrawMode.plane, var3,
									var37, var39, false, var10.renderable1);
						}
					}
				}
				...
				if (var8 == 1) {
					...
					if (var40 != null) {
						...
						if (var6 != 4 && var6 != 5) {
							if (var6 == 6) {
								var40.renderable1 = new DynamicObject(var43, 4, var7 + 4, BoundingBox3DDrawMode.plane,
										var3, var37, var39, false, var40.renderable1);
							} else if (var6 == 7) {
								var40.renderable1 = new DynamicObject(var43, 4, (var7 + 2 & 3) + 4,
										BoundingBox3DDrawMode.plane, var3, var37, var39, false, var40.renderable1);
							} else if (var6 == 8) {
								var40.renderable1 = new DynamicObject(var43, 4, var7 + 4, BoundingBox3DDrawMode.plane,
										var3, var37, var39, false, var40.renderable1);
								var40.renderable2 = new DynamicObject(var43, 4, (var7 + 2 & 3) + 4,
										BoundingBox3DDrawMode.plane, var3, var37, var39, false, var40.renderable2);
							}
						} else {
							var40.renderable1 = new DynamicObject(var43, 4, var7, BoundingBox3DDrawMode.plane, var3,
									var37, var39, false, var40.renderable1);
						}
					}
				}
				...
				if (var8 == 2) {
					...
					if (var41 != null) {
						var41.renderable = new DynamicObject(var41.hash >> 14 & 32767, var6, var7,
								BoundingBox3DDrawMode.plane, var3, var37, var39, false, var41.renderable);
					}
				}
				...
				if (var8 == 3) {
					...
					if (var42 != null) {
						var42.renderable = new DynamicObject(var42.hash >> 14 & 32767, 22, var7,
								BoundingBox3DDrawMode.plane, var3, var37, var39, false, var42.renderable);
					}
				}
			}
			...
			if (class183.field2491 == var0) {
				...
				var3 = var38 + var13;
				var43 = var11 + var14;
				if (var13 >= 0 && var14 >= 0 && var13 < 104 && var14 < 104 && var3 >= 0 && var43 >= 0 && var3 < 104
						&& var43 < 104 && var6 != 65535) {
					var13 = var13 * 128 + 64;
					var14 = var14 * 128 + 64;
					var3 = var3 * 128 + 64;
					var43 = var43 * 128 + 64;
					Projectile var15 = new Projectile(var6, BoundingBox3DDrawMode.plane, var13, var14,
							class265.getTileHeight(var13, var14, BoundingBox3DDrawMode.plane) - var2,
							var7 + Client.gameCycle, var37 + Client.gameCycle, var5, var39, var8, var44);
					var15.moveProjectile(var3, var43,
							class265.getTileHeight(var3, var43, BoundingBox3DDrawMode.plane) - var44,
							var7 + Client.gameCycle);
				...
				if (class183.field2501 == var0) {
					...
					if (var17 != null) {
						...
						int var26 = var25[var22][var23] + var25[var21][var23] + var25[var21][var24]
								+ var25[var22][var24] >> 2;
						int var27 = (var6 << 7) + (var19 << 6);
						int var28 = (var7 << 7) + (var20 << 6);
						Model var29 = var18.method4999(var14, var32, var25, var27, var26, var28);
						if (var29 != null) {
							class264.method4683(BoundingBox3DDrawMode.plane, var6, var7, var16, -1, 0, 0, var3 + 1,
									var2 + 1);
				...
				if (class183.field2489 == var0) {
					...
					if (var3 >= 0 && var37 >= 0 && var3 < 104 && var37 < 104) {
						var3 = var3 * 128 + 64;
						var37 = var37 * 128 + 64;
						GraphicsObject var33 = new GraphicsObject(var7, BoundingBox3DDrawMode.plane, var3, var37,
								class265.getTileHeight(var3, var37, BoundingBox3DDrawMode.plane) - var6, var5,
								Client.gameCycle);
					...
					if (class183.field2495 == var0) {
						...
						if (var3 >= 0 && var37 >= 0 && var3 < 104 && var37 < 104) {
							var44 = var6 + 1;
							if (SoundTaskDataProvider.localPlayer.pathX[0] >= var3 - var44
									&& SoundTaskDataProvider.localPlayer.pathX[0] <= var3 + var44
									&& SoundTaskDataProvider.localPlayer.pathY[0] >= var37 - var44
									&& SoundTaskDataProvider.localPlayer.pathY[0] <= var37 + var44
									&& Client.field951 != 0 && var7 > 0 && Client.queuedSoundEffectCount < 50) {
								...
								Client.soundLocations[Client.queuedSoundEffectCount] = var6 + (var37 << 8)
										+ (var3 << 16);
					...
					if (class183.field2494 == var0) {
						...
						if (var3 >= 0 && var37 >= 0 && var3 < 104 && var37 < 104) {
							class264.method4683(BoundingBox3DDrawMode.plane, var3, var37, var39, var5, var7, var8, 0,
									-1);
						}
