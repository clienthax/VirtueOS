...
public class class71 extends class178 {
	...
	static final void method1184(int var0) {
		...
		for (var5 = 0; var5 < var4; ++var5) {
			var6 = Huffman.field2513[var2 + var3]
					- var0 * MouseRecorder.field819[var2 + class90.field1369 & MouseRecorder.field819.length - 1] / 6;
			if (var6 < 0) {
				var6 = 0;
			}
		...
		for (var5 = var1 - var0; var5 < var1; ++var5) {
			class90.field1366[var5] = (int) (Math.sin(class90.field1368 / 14.0D) * 16.0D
					+ Math.sin(class90.field1368 / 15.0D) * 14.0D + Math.sin(class90.field1368 / 16.0D) * 12.0D);
			++class90.field1368;
		}
		...
		if (Client.field1099 == 0 || Client.field1099 == 3) {
			if (MouseInput.mouseLastButton == 1
				...
				if (var3.method4346(var4, var5)) {
					...
					var13.packetBuffer.method3542(
							KeyFocusListener.keyPressed[82] ? (KeyFocusListener.keyPressed[81] ? 2 : 1) : 0);
