...
public class class88 {
	...
	static {
		...
		field1346 = new BigInteger(
				"",
				16);
	}
	...
	static final void method1893(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7) {
		if (class189.loadWidget(var0)) {
			...
			if (class66.field785 != null) {
				GameCanvas.gameDraw(class66.field785, -1412584499, var1, var2, var3, var4,
						CombatInfoListHolder.field1310, GrandExchangeEvent.field300, var7);
				class66.field785 = null;
			}
	...
	static final void method1894(Widget var0) {
		...
		if (var1 == 324) {
			...
			var0.rotationX = 150;
			var0.rotationZ = (int) (Math.sin(Client.gameCycle / 40.0D) * 256.0D) & 2047;
			var0.modelType = 5;
			var0.modelId = 0;
		} else if (var1 == 328) {
			var0.rotationX = 150;
