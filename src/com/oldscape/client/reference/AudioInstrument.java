...
class AudioInstrument {
        ...
        if (var2 >= 10) {
            ...
            if (this.filter.pairs[0] > 0 || this.filter.pairs[1] > 0) {
                ...
                if (var1 >= var12 + var13) {
                    ...
                    int var17;
                    while (var14 < var15) {
                        var16 = (int) ((long) samples[var14 + var12] * SoundEffect3.fowardMultiplier >> 16);

                        for (var17 = 0; var17 < var12; ++var17) {
                            var16 += (int) ((long) samples[var14 + var12 - 1 - var17] * SoundEffect3.coefficients[0][var17] >> 16);
                        }

                        for (var17 = 0; var17 < var14; ++var17) {
                            var16 -= (int) ((long) samples[var14 - 1 - var17] * SoundEffect3.coefficients[1][var17] >> 16);
                        }
                    ...
                    while (true) {
                        ...
                        int var18;
                        while (var14 < var15) {
                            var17 = (int) ((long) samples[var14 + var12] * SoundEffect3.fowardMultiplier >> 16);

                            for (var18 = 0; var18 < var12; ++var18) {
                                var17 += (int) ((long) samples[var14 + var12 - 1 - var18] * SoundEffect3.coefficients[0][var18] >> 16);
                            }

                            for (var18 = 0; var18 < var13; ++var18) {
                                var17 -= (int) ((long) samples[var14 - 1 - var18] * SoundEffect3.coefficients[1][var18] >> 16);
                            }
    ...
    final void decode(final Buffer var1) {
