...
public final class IndexedSprite extends Rasterizer2D {
    ...
    void method5825(int x, int y) {
        x += this.offsetX;
        y += this.offsetY;
        int var3 = x + y * graphicsPixelsWidth;
        int var4 = 0;
        ...
        if (var5 + y > drawingAreaRight) {
            var5 -= var5 + y - drawingAreaRight;
        }

        if (x < draw_region_x) {
            var9 = draw_region_x - x;
            var6 -= var9;
            x = draw_region_x;
            var4 += var9;
            var3 += var9;
        ...
        if (var6 + x > drawingAreaBottom) {
            var9 = var6 + x - drawingAreaBottom;
            var6 -= var9;
            var8 += var9;
            var7 += var9;
        }
        ...
        if (var6 > 0 && var5 > 0) {
            method5826(graphicsPixels, this.pixels, this.palette, var4, var3, var6, var5, var7, var8);
        }
    }
    ...
    public void method5827(int var1, int var2, int var3, int var4) {
        ...
        method5837(graphicsPixels, this.pixels, this.palette, var7, var8, var13, var14, var3, var4, var11, var12, var5);
    }
}
