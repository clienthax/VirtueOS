...
public abstract class CombatAction {
	...
	/**
	 * This method is called after {@link #attack(Entity, Entity)} and the combat
	 * ticks pass the delay from {@link #getHitDelay(boolean)}.
	 * 
	 * @param defender
	 *            the defending entity
	 * @param attacker
	 *            the attacking entity
	 * @param successful
	 *            false is the defender blocked the hit; false otherwise
	 */
