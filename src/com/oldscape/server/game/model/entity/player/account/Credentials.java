...
public final class Credentials {
    ...
    /**
     * The {@link com.oldscape.server.game.model.entity.player.account.Permission} of the account.
     */
    ...
    /**
     * Creates a new {@link Credentials}.
     *
     * @param accountCreation      The {@link java.util.Date} the account was created.
     * @param lastLoggedIn         The last time the account is logged in.
     * @param username             The username.
     * @param displayName          The display name.
     * @param emailAddress         The email address.
     * @param password             The password.
     * @param unreadMessage        The amount of unread messages.
     * @param lastKnownIpAddress   The last known ip address.
     * @param membershipExpiryDate The date the membership will expire.
     ...
     */
    public Credentials(Date accountCreation, Date lastLoggedIn, String username, String displayName,
                       String emailAddress, String password, int unreadMessage, String lastKnownIpAddress,
                       Date membershipExpiryDate, Subscription subscription, Permission permission, boolean emailVerified,
                       boolean auth) {
    ...
    /**
     * Gets the {@link com.oldscape.server.game.model.entity.player.account.Permission}.
     *
