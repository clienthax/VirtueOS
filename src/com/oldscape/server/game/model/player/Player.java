...
import com.oldscape.server.game.model.player.inv.AppearanceContainerListener;
import com.oldscape.server.game.model.player.inv.ContainerConstants;
import com.oldscape.server.game.model.player.inv.FullContainerListener;
...
import com.oldscape.server.game.model.player.inv.SynchronizationContainerListener;
...
public class Player extends MobileEntity {
	 ...
	 */
	protected final ItemContainer equipment = new ItemContainer(ContainerConstants.EQUIPMENT_CAPACITY,
	 ...
	 */
	protected final ItemContainer inventory = new ItemContainer(ContainerConstants.INVENTORY_CAPACITY,
			StackMode.STACK_ALWAYS);
	 ...
	 *
	 * @param id
	 *            The slot the player is in the database.
	 * @param credentials
	 *            The {@link com.oldscape.shared.model.player.AccountCredentials}.
	 * @param display
	 *            The {@link com.oldscape.shared.model.player.DisplayMode}.
	...
	public void initialize() {
		...
		equipment.addListener(new SynchronizationContainerListener(this, ContainerConstants.EQUIPMENT_ID,
				ContainerConstants.EQUIPMENT_CHANNEL));
		equipment.addListener(new AppearanceContainerListener(this));
		inventory.addListener(new SynchronizationContainerListener(this, ContainerConstants.INVENTORY_ID,
				ContainerConstants.INVENTORY_CHANNEL));
		inventory.addListener(new FullContainerListener(this, ContainerConstants.FULL_INVENTORY_MESSAGE));
		bank.addListener(new SynchronizationContainerListener(this, ContainerConstants.BANK_ID,
				ContainerConstants.BANK_CHANNEL));// TODO
	...
	public void onLogin() {
		...
		/*
		 * sendSetInterfaceText(378, 14,
		 * "Never tell anyone your password, even if they claim to work for Jagex!");
		 * sendSetInterfaceText(378, 15,
		 * "You have 0 unread messages in your message centre.");
		 * sendSetInterfaceText(378, 18,
		 * "You are not a member. Subscribe to access extra skills, areas and quests, and much<br>more besides."
		 * ); sendSetInterfaceText(378, 20,
		 * "A membership subscription grants access to the members-only features of both versions of RuneScape."
		 * ); sendSetInterfaceText(378, 21, "Keep your account secure.");
		 * sendSetInterfaceText(378, 13,
		 * "You last logged in <col=ff0000>earlier today<col=000000>.");
		 * sendSetInterfaceText(378, 16,
		 * "You do not have a Bank PIN. Please visit a bank if you would like one.");
		 * sendSetInterfaceText(50, 3,
		 * "Organise your teleport scrolls in the new <col=6f007f>Master Scroll Book</col> available from treasure trails. Also you can now recolour <col=003fbf>rock golems</col> with lovekite, elemental or daeyalt ore!"
		 * ); sendSetInterfaceText(593, 1, "Unarmed"); sendSetInterfaceText(593, 2,
		 * "Combat Lvl: 3"); sendSetInterfaceText(239, 5, "AUTO");
		 * 
		 * sendSetRootInterface(165);
		 * 
		 * sendOpenInterfaceSub(165, 1, 162, true); sendOpenInterfaceSub(165, 8, 593,
		 * true); sendOpenInterfaceSub(165, 9, 320, true); sendOpenInterfaceSub(165, 10,
		 * 76, true); sendOpenInterfaceSub(165, 11, 149, true);
		 * sendOpenInterfaceSub(165, 12, 387, true); sendOpenInterfaceSub(165, 13, 541,
		 * true); sendOpenInterfaceSub(165, 14, 218, true); sendOpenInterfaceSub(165,
		 * 15, 7, true); sendOpenInterfaceSub(165, 16, 429, true);
		 * sendOpenInterfaceSub(165, 17, 432, true); sendOpenInterfaceSub(165, 18, 182,
		 * true); sendOpenInterfaceSub(165, 19, 261, true); sendOpenInterfaceSub(165,
		 * 20, 216, true); sendOpenInterfaceSub(165, 21, 239, true);
		 * sendOpenInterfaceSub(165, 23, 163, true); sendOpenInterfaceSub(165, 24, 160,
		 * true); sendOpenInterfaceSub(165, 28, 50, false);//50 = theme
		 * sendOpenInterfaceSub(165, 29, 378, false);
		 * 
		 * sendCS2Script(233, new Object[] { 3276804, 33179, 0, 0, 468, 1897, 0, 392,
		 * -1}); sendCS2Script(233, new Object[] { 3276805, 33194, 0, 56, 54, 74, 0,
		 * 660, -1});
		 * 
		 * sendInterfaceSetClickMask(216, 1, 0, 46, 2); sendInterfaceSetClickMask(239,
		 * 1, 0, 535, 2);
		 * 
		 * sendVarp(18, 1); sendVarp(20, 131072); sendVarp(21, 67141632); sendVarp(22,
		 * 33554432); sendVarp(23, 2097216); sendVarp(43, 1); sendVarp(101, 0);
		 * sendVarp(153, -1); sendVarp(166, 2); sendVarp(167, 0); sendVarp(168, 4);
		 * sendVarp(169, 4); sendVarp(170, 0); sendVarp(171, 0); sendVarp(173, 1);
		 * sendVarp(281, 1000); sendVarp(284, 60001); sendVarp(287, 0); sendVarp(300,
		 * 1000); sendVarp(406, 20); sendVarp(447, -1); sendVarp(449, 2097152);
		 * sendVarp(486, 1073741824); sendVarp(520, 1); sendVarp(553, -2147483648);
		 * sendVarp(788, 128); sendVarp(810, 33554432); sendVarp(849, -1); sendVarp(850,
		 * -1); sendVarp(851, -1); sendVarp(852, -1); sendVarp(853, -1); sendVarp(854,
		 * -1); sendVarp(855, -1); sendVarp(856, -1); sendVarp(872, 4); sendVarp(904,
		 * 253); sendVarp(913, 4194304); sendVarp(1010, 2048); sendVarp(1017, 8192);
		 * sendVarp(1050, 4096); sendVarp(1065, -1); sendVarp(1067, -1302855680);
		 * sendVarp(1074, 0); sendVarp(1075, -1); sendVarp(1107, 0); sendVarp(1151, -1);
		 * sendVarp(1224, 172395585); sendVarp(1225, 379887846); sendVarp(1226, 12);
		 * sendVarp(1306, 0); sendVarp(1427, -1);
		 * 
		 * sendMessage("Welcome to Unnamed #155.");
		 * 
		 * // sendSetInterfaceText(12, 4, "Bank of Unnamed #149.");
		 * 
		 * // sendSkill(0, 99, 200000000); // sendSkill(1, 99, 200000000); //
		 * sendSkill(2, 99, 200000000); // sendSkill(3, 99, 200000000); // sendSkill(4,
		 * 99, 200000000); // sendSkill(5, 99, 200000000); // sendSkill(6, 99,
		 * 200000000); // sendSkill(7, 99, 200000000); // sendSkill(8, 99, 200000000);
		 * // sendSkill(9, 99, 200000000); // sendSkill(10, 99, 200000000); //
		 * sendSkill(11, 99, 200000000); // sendSkill(12, 99, 200000000); //
		 * sendSkill(13, 99, 200000000); // sendSkill(14, 99, 200000000); //
		 * sendSkill(15, 99, 200000000); // sendSkill(16, 99, 200000000); //
		 * sendSkill(17, 99, 200000000); // sendSkill(18, 99, 200000000); //
		 * sendSkill(19, 99, 200000000); // sendSkill(20, 99, 200000000); //
		 * sendSkill(21, 99, 200000000); // sendSkill(22, 99, 200000000); //
		 * sendSkill(23, 99, 200000000); // sendSkill(24, 99, 200000000); // //
		 * sendRunEnergy(100); // // sendMusic(177); //todo
		 */
		 ...
		 * sendSetInterfaceText(378, 16,
		 * "You do not have a Bank PIN Please visit a bank if you would like one");
		 * sendSetRootInterface(165); sendOpenInterfaceSub(165, 1, 162, true);
		 * sendOpenInterfaceSub(165, 23, 163, true); sendOpenInterfaceSub(165, 24, 160,
		 * true); //sendOpenInterfaceSub(165, 29, 378, false);//heh, seems to be missing
		 * on 168
		 * 
		 * int loginTheme = 50;
		 * 
		 * sendOpenInterfaceSub(165, 28, loginTheme, false); sendSetInterfaceText(50, 3,
		 * "Once you've had a <col=cfcfcf>graceful set</col> repainted <col=2f2fff>blue</col> in <col=4f2f1f>Brimhaven</col>,<br>you can get <col=003600>individual pieces</col> repainted<br>Next week, <col=9f005f>Halloween</col>!"
		 * ); sendCS2Script(233, new Object[] {3276804, 7085, 0, 0, 434, 1912, 0, 400,
		 * -1}); sendCS2Script(233, new Object[] {3276805, 32817, 0, 100, 93, 179, 0,
		 * 800, 820}); sendCS2Script(1080, new Object[] {}); sendOpenInterfaceSub(165,
		 * 9, 320, true); sendOpenInterfaceSub(165, 10, 399, true);
		 * sendOpenInterfaceSub(165, 11, 149, true); sendOpenInterfaceSub(165, 12, 387,
		 * true); sendOpenInterfaceSub(165, 13, 541, true); sendOpenInterfaceSub(165,
		 * 14, 218, true); sendOpenInterfaceSub(165, 16, 429, true);
		 * sendOpenInterfaceSub(165, 17, 432, true); sendOpenInterfaceSub(165, 18, 182,
		 * true); sendOpenInterfaceSub(165, 19, 261, true); sendOpenInterfaceSub(165,
		 * 20, 216, true); sendOpenInterfaceSub(165, 21, 239, true);
		 * sendOpenInterfaceSub(165, 15, 7, true); sendOpenInterfaceSub(165, 8, 593,
		 * true); sendSetInterfaceText(593, 1, "Unarmed"); sendSetInterfaceText(593, 2,
		 * "Combat Lvl: 126"); sendSetInterfaceText(239, 5, "AUTO"); sendCS2Script(2014,
		 * new Object[] {0, 0, 0, 0, 0, 0}); sendCS2Script(2015, new Object[] {0});
		 * sendVarp(18, 1); sendVarp(20, 131072); sendVarp(21, 67141632); sendVarp(22,
		 * 33554432); sendVarp(23, 2097216); sendVarp(43, 1); sendVarp(101, 0);
		 * sendVarp(153, -1); sendVarp(166, 2); sendVarp(167, 0); sendVarp(168, 4);
		 * sendVarp(169, 4); sendVarp(170, 0); sendVarp(171, 0); sendVarp(173, 1);
		...
		sendSetInterfaceText(378, 3,
				"Delve into the history of <col=ff0000>Shayzien House</col> and uncover a conspiracy a thousand years in the making in our new quest, <col=ffff00>Tale of the Righteous</col>.");
	...
	public void initGameFrameCodec() {
		...
		pipeline.addBefore(GameEventEncoder.class.getName(), GameFrameEncoder.class.getName(),
				new GameFrameEncoder(encodingRandom));

		pipeline.addBefore("handler", GameFrameDecoder.class.getName(), new GameFrameDecoder(decodingRandom));
		pipeline.addAfter(GameFrameDecoder.class.getName(), GameEventDecoder.class.getName(),
				new GameEventDecoder(server.getEventRepository()));
	}
	 ...
	 *
	 * @param event
	 *            The {@link com.oldscape.shared.event.Event} to write.
	 */
	 ...
	 *            The
	 *            {@link com.oldscape.server.game.network.game.GameSessionContext}
	 *            to set.
	 */
	...
	/**
	 * @param encodingRandom
	 *            the encodingRandom to set
	 */
	...
	/**
	 * @param decodingRandom
	 *            the decodingRandom to set
	 */
