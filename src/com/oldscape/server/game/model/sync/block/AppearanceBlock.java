...
public final class AppearanceBlock extends SynchronizationBlock {
	 ...
	 * 
	 * @param name
	 *            The player's username, encoded to base 37.
	 * @param appearance
	 *            The {@link Appearance}.
	 * @param combat
	 *            The player's combat.
	 * @param skill
	 *            The player's skill, or 0 if showing the combat level.
	 * @param equipment
	 *            The player's equipment.
	 * @param headIcon
	 *            The head icon id of the player.
	 * @param isSkulled
	 *            Whether or not the player is skulled.
	 */
	 ...
	 *            The player's equipment.
	 * @param headIcon
	 *            The prayer icon id of this player.
	 * @param isSkulled
	 *            Whether or not the player is skulled.
	 * @param npcId
	 *            The npc id of the player, if they are appearing as an npc,
	 *            (otherwise {@code -1}).
	 */
	AppearanceBlock(String name, Appearance appearance, int combat, int skill, ItemContainer equipment, int headIcon,
