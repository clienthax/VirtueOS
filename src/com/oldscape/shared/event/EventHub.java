...
public abstract class EventHub<C extends EventContext> {
     ...
     *
     * @param event The {@link com.oldscape.shared.event.ContextualEvent} to handle.
     */
     ...
     * @param context The type of {@link com.oldscape.shared.event.EventContext}.
     */
     ...
     *
     * @param clazz    The {@link com.oldscape.shared.event.Event} to subscribe a
     *                 {@link com.oldscape.shared.event.EventListener} to.
     * @param listener The {@link com.oldscape.shared.event.EventListener} to add.
     */
     ...
     *
     * @param clazz The {@link com.oldscape.shared.event.Event}
     *              {@link java.lang.Class}.
     * @param <E>   The {@link com.oldscape.shared.event.Event} type.
     * @throws EventException The exception thrown if ane error occurs removing an
