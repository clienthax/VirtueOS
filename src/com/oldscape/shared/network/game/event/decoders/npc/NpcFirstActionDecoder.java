...
public class NpcFirstActionDecoder implements GameMessageDecoder<NpcActionEvent> {
    ...
    public NpcActionEvent decode(GameFrameReader frame) {
        ...
        System.out.println("npcActionEvent(0): " + type + " " + index);
        return new NpcActionEvent(0, index);
    }
