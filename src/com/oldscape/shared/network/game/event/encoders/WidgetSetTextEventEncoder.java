...
import com.oldscape.shared.network.game.event.impl.WidgetSetTextEvent;
 ...
 * @since Jul 24, 2015
 */
public class WidgetSetTextEventEncoder implements GameMessageEncoder<WidgetSetTextEvent> {

    @Override
    public GameFrame encode(ByteBufAllocator alloc, WidgetSetTextEvent event) {
